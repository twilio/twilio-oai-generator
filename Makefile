...
cover:
	dotnet sonarscanner begin /k:"twilio_twilio-oai-generator-csharp" /o:"twilio" /d:sonar.host.url=https://sonarcloud.io /d:sonar.login="${SONAR_CSHARP_TOKEN}"  /d:sonar.language="cs" /d:sonar.cs.opencover.reportsPaths="test/lcov.net451.opencover.xml"
	...
	dotnet sonarscanner end /d:sonar.login="${SONAR_CSHARP_TOKEN}"
