...
def generate(openapi_spec_path: str, output_path: str, language: str, domain: str, is_file: bool = False) -> None:
    full_path, domain_name, api_version = get_domain_info(openapi_spec_path, domain, language, is_file)
...
def get_domain_info(oai_spec_location: str, domain: str, language: str, is_file: bool = False) -> Tuple[str, str, str]:
...
# fetch the domain name from servers url in spec file
