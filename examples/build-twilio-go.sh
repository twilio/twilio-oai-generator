...
for domain in <path-to>/twilio-oai/spec/yaml/twilio_*.yaml; do
  ...
  java -cp <path-to>/openapi-generator-cli.jar:target/twilio-go-openapi-generator-1.0.0.jar org.openapitools.codegen.OpenAPIGenerator generate -g twilio-go -i "$domain" -o <path-to>/twilio-go/"$domain_name"/"$version" --ignore-file-override=./.openapi-generator
done
