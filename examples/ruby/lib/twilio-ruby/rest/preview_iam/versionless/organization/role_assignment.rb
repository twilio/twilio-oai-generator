          ...
          class RoleAssignmentList < ListResource
            ...
            def create(public_api_create_role_assignment_request: nil)
              ...
              payload = @version.create('POST', @uri, headers: headers,
                                                      data: public_api_create_role_assignment_request.to_json)
            ...
            def page(identity: :unset, scope: :unset, page_token: :unset, page_number: :unset,
                     page_size: :unset)
          ...
          class RoleAssignmentInstance < InstanceResource
            ...
            def context
              unless @instance_context
                @instance_context = RoleAssignmentContext.new(@version, @params['organization_sid'],
                                                              @params['sid'])
              end
              @instance_context
            end
