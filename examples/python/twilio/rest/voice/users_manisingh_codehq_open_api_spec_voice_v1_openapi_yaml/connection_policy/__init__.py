...
from twilio.rest.voice.users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.connection_policy.connection_policy_target import ConnectionPolicyTargetList
...
class ConnectionPolicyInstance(InstanceResource):
    ...
    def update(self, friendly_name: Union[str, object]=values.unset) -> "ConnectionPolicyInstance":
        """
    ...
    async def update_async(self, friendly_name: Union[str, object]=values.unset) -> "ConnectionPolicyInstance":
        """
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Voice.Users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.ConnectionPolicyInstance {}>'.format(context)
...
class ConnectionPolicyContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Voice.Users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.ConnectionPolicyContext {}>'.format(context)
...
class ConnectionPolicyPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Voice.Users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.ConnectionPolicyPage>"
...
class ConnectionPolicyList(ListResource):
    ...
    def list(self, 
        ...
        return [ConnectionPolicyInstance(self._version, item) for item in payload["connection_policies"]]
    ...
    def create(self, friendly_name: Union[str, object]=values.unset) -> ConnectionPolicyInstance:
        """
    ...
    async def create_async(self, friendly_name: Union[str, object]=values.unset) -> ConnectionPolicyInstance:
        """
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Voice.Users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.ConnectionPolicyList>'
