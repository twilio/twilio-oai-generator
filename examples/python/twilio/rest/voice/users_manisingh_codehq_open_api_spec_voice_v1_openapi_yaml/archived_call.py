...
class ArchivedCallContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Voice.Users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.ArchivedCallContext {}>'.format(context)
...
class ArchivedCallList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Voice.Users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.ArchivedCallList>'
