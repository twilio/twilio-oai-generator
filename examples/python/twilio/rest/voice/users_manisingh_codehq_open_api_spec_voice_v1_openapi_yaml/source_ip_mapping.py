...
class SourceIpMappingInstance(InstanceResource):
    ...
    def update(self, sip_domain_sid: str) -> "SourceIpMappingInstance":
        ...
        """
        return self._proxy.update(sip_domain_sid=sip_domain_sid, )
    ...
    async def update_async(self, sip_domain_sid: str) -> "SourceIpMappingInstance":
        ...
        :returns: The updated SourceIpMappingInstance
        """
        return await self._proxy.update_async(sip_domain_sid=sip_domain_sid, )
    ...
    def update_with_http_info(self, sip_domain_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(sip_domain_sid=sip_domain_sid, )
    ...
    async def update_with_http_info_async(self, sip_domain_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(sip_domain_sid=sip_domain_sid, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Voice.Users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.SourceIpMappingInstance {}>'.format(context)
...
class SourceIpMappingContext(InstanceContext):
    ...
    def fetch_with_http_info(self) -> ApiResponse:
        ...
        instance = SourceIpMappingInstance(
            self._version,
            payload,
            sid=self._solution['sid'],
    ...
    def update(self, sip_domain_sid: str) -> SourceIpMappingInstance:
        ...
        :returns: The updated SourceIpMappingInstance
        """
        payload, _, _ = self._update(sip_domain_sid=sip_domain_sid)
        return SourceIpMappingInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    def update_with_http_info(self, sip_domain_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._update(sip_domain_sid=sip_domain_sid)
        instance = SourceIpMappingInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    async def update_async(self, sip_domain_sid: str) -> SourceIpMappingInstance:
        ...
        :returns: The updated SourceIpMappingInstance
        """
        payload, _, _ = await self._update_async(sip_domain_sid=sip_domain_sid)
        return SourceIpMappingInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    async def update_with_http_info_async(self, sip_domain_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(sip_domain_sid=sip_domain_sid)
        instance = SourceIpMappingInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Voice.Users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.SourceIpMappingContext {}>'.format(context)
...
class SourceIpMappingPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Voice.Users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.SourceIpMappingPage>"
...
class SourceIpMappingList(ListResource):
    ...
    def list(self, 
        ...
        return [SourceIpMappingInstance(self._version, item) for item in payload["source_ip_mappings"]]
    ...
    def create(self, ip_record_sid: str, sip_domain_sid: str) -> SourceIpMappingInstance:
        ...
        """
        payload, _, _ = self._create(ip_record_sid=ip_record_sid, sip_domain_sid=sip_domain_sid)
        return SourceIpMappingInstance(self._version, payload)
    ...
    def create_with_http_info(self, ip_record_sid: str, sip_domain_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(ip_record_sid=ip_record_sid, sip_domain_sid=sip_domain_sid)
        instance = SourceIpMappingInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    async def create_async(self, ip_record_sid: str, sip_domain_sid: str) -> SourceIpMappingInstance:
        ...
        :returns: The created SourceIpMappingInstance
        """
        payload, _, _ = await self._create_async(ip_record_sid=ip_record_sid, sip_domain_sid=sip_domain_sid)
        return SourceIpMappingInstance(self._version, payload)
    ...
    async def create_with_http_info_async(self, ip_record_sid: str, sip_domain_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(ip_record_sid=ip_record_sid, sip_domain_sid=sip_domain_sid)
        instance = SourceIpMappingInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Voice.Users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.SourceIpMappingList>'
