...
from twilio.rest.voice.users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.dialing_permissions.bulk_country_update import BulkCountryUpdateList
from twilio.rest.voice.users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.dialing_permissions.country import CountryList
from twilio.rest.voice.users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.dialing_permissions.settings import SettingsList
...
class DialingPermissionsList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        """
        return '<Twilio.Voice.Users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.DialingPermissionsList>'
