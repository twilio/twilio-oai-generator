...
class IpRecordInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Voice.Users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.IpRecordInstance {}>'.format(context)
...
class IpRecordContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Voice.Users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.IpRecordContext {}>'.format(context)
...
class IpRecordPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Voice.Users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.IpRecordPage>"
...
class IpRecordList(ListResource):
    ...
    def list(self, 
        ...
        return [IpRecordInstance(self._version, item) for item in payload["ip_records"]]
    ...
    def _create(self, ip_address: str, friendly_name: Union[str, object]=values.unset, cidr_prefix_length: Union[int, object]=values.unset) -> tuple:
        """
    ...
    def create(self, ip_address: str, friendly_name: Union[str, object]=values.unset, cidr_prefix_length: Union[int, object]=values.unset) -> IpRecordInstance:
        ...
        """
        payload, _, _ = self._create(ip_address=ip_address, friendly_name=friendly_name, cidr_prefix_length=cidr_prefix_length)
        return IpRecordInstance(self._version, payload)

    def create_with_http_info(self, ip_address: str, friendly_name: Union[str, object]=values.unset, cidr_prefix_length: Union[int, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(ip_address=ip_address, friendly_name=friendly_name, cidr_prefix_length=cidr_prefix_length)
        instance = IpRecordInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, ip_address: str, friendly_name: Union[str, object]=values.unset, cidr_prefix_length: Union[int, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, ip_address: str, friendly_name: Union[str, object]=values.unset, cidr_prefix_length: Union[int, object]=values.unset) -> IpRecordInstance:
        ...
        :returns: The created IpRecordInstance
        """
        payload, _, _ = await self._create_async(ip_address=ip_address, friendly_name=friendly_name, cidr_prefix_length=cidr_prefix_length)
        return IpRecordInstance(self._version, payload)

    async def create_with_http_info_async(self, ip_address: str, friendly_name: Union[str, object]=values.unset, cidr_prefix_length: Union[int, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(ip_address=ip_address, friendly_name=friendly_name, cidr_prefix_length=cidr_prefix_length)
        instance = IpRecordInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Voice.Users_manisingh_codehq_open_api_spec_voice_v1_openapi_yaml.IpRecordList>'
