...
class NewApiKeyInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Iam.Users_manisingh_codehq_open_api_spec_iam_v1_openapi_yaml.NewApiKeyInstance>'
...
class NewApiKeyList(ListResource):
    ...
    def _create(self, account_sid: str, friendly_name: Union[str, object]=values.unset, key_type: Union[str, object]=values.unset, policy: Union[object, object]=values.unset) -> tuple:
        """
    ...
    def create(self, account_sid: str, friendly_name: Union[str, object]=values.unset, key_type: Union[str, object]=values.unset, policy: Union[object, object]=values.unset) -> NewApiKeyInstance:
        """
        ...
        """
        payload, _, _ = self._create(account_sid=account_sid, friendly_name=friendly_name, key_type=key_type, policy=policy)
        return NewApiKeyInstance(self._version, payload)

    def create_with_http_info(self, account_sid: str, friendly_name: Union[str, object]=values.unset, key_type: Union[str, object]=values.unset, policy: Union[object, object]=values.unset) -> ApiResponse:
        """
        ...
        """
        payload, status_code, headers = self._create(account_sid=account_sid, friendly_name=friendly_name, key_type=key_type, policy=policy)
        instance = NewApiKeyInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, account_sid: str, friendly_name: Union[str, object]=values.unset, key_type: Union[str, object]=values.unset, policy: Union[object, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, account_sid: str, friendly_name: Union[str, object]=values.unset, key_type: Union[str, object]=values.unset, policy: Union[object, object]=values.unset) -> NewApiKeyInstance:
        """
        ...
        :returns: The created NewApiKeyInstance
        """
        payload, _, _ = await self._create_async(account_sid=account_sid, friendly_name=friendly_name, key_type=key_type, policy=policy)
        return NewApiKeyInstance(self._version, payload)

    async def create_with_http_info_async(self, account_sid: str, friendly_name: Union[str, object]=values.unset, key_type: Union[str, object]=values.unset, policy: Union[object, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(account_sid=account_sid, friendly_name=friendly_name, key_type=key_type, policy=policy)
        instance = NewApiKeyInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Iam.Users_manisingh_codehq_open_api_spec_iam_v1_openapi_yaml.NewApiKeyList>'
