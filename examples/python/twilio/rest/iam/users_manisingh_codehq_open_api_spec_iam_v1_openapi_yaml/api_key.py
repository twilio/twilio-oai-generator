...
class ApiKeyInstance(InstanceResource):
    ...
    def _proxy(self) -> "ApiKeyContext":
        ...
        if self._context is None:
            self._context = ApiKeyContext(self._version, sid=self._solution['sid'],)
    ...
    def update(self, friendly_name: Union[str, object]=values.unset, policy: Union[object, object]=values.unset) -> "ApiKeyInstance":
        """
        ...
        """
        return self._proxy.update(friendly_name=friendly_name, policy=policy, )

    async def update_async(self, friendly_name: Union[str, object]=values.unset, policy: Union[object, object]=values.unset) -> "ApiKeyInstance":
        """
        ...
        :returns: The updated ApiKeyInstance
        """
        return await self._proxy.update_async(friendly_name=friendly_name, policy=policy, )

    def update_with_http_info(self, friendly_name: Union[str, object]=values.unset, policy: Union[object, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(friendly_name=friendly_name, policy=policy, )

    async def update_with_http_info_async(self, friendly_name: Union[str, object]=values.unset, policy: Union[object, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(friendly_name=friendly_name, policy=policy, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Iam.Users_manisingh_codehq_open_api_spec_iam_v1_openapi_yaml.ApiKeyInstance {}>'.format(context)
...
class ApiKeyContext(InstanceContext):
    ...
    def _update(self, friendly_name: Union[str, object]=values.unset, policy: Union[object, object]=values.unset) -> tuple:
        """
    ...
    def update_with_http_info(self, friendly_name: Union[str, object]=values.unset, policy: Union[object, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._update(friendly_name=friendly_name, policy=policy)
        instance = ApiKeyInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    async def _update_async(self, friendly_name: Union[str, object]=values.unset, policy: Union[object, object]=values.unset) -> tuple:
        """
    ...
    async def update_async(self, friendly_name: Union[str, object]=values.unset, policy: Union[object, object]=values.unset) -> ApiKeyInstance:
        ...
        :returns: The updated ApiKeyInstance
        """
        payload, _, _ = await self._update_async(friendly_name=friendly_name, policy=policy)
        return ApiKeyInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    async def update_with_http_info_async(self, friendly_name: Union[str, object]=values.unset, policy: Union[object, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(friendly_name=friendly_name, policy=policy)
        instance = ApiKeyInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Iam.Users_manisingh_codehq_open_api_spec_iam_v1_openapi_yaml.ApiKeyContext {}>'.format(context)
...
class ApiKeyList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Iam.Users_manisingh_codehq_open_api_spec_iam_v1_openapi_yaml.ApiKeyList>'
