...
class ResourceTypeInstance(InstanceResource):
    ...
    :ivar var_schema: Primary/base schema URI
    """
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Iam.Users_manisingh_codehq_open_api_spec_iam_scim_openapi_yaml.ResourceTypeInstance>'
...
class ResourceTypePage(Page):
    ...
    def get_instance(self, payload: Dict[str, Any]) -> ResourceTypeInstance:
        ...
        return ResourceTypeInstance(self._version, payload)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Iam.Users_manisingh_codehq_open_api_spec_iam_scim_openapi_yaml.ResourceTypePage>"
...
class ResourceTypeList(ListResource):
    ...
    def stream_with_http_info(self, 
        ...
        """
        Streams ResourceTypeInstance and returns headers from first page
    ...
    async def stream_with_http_info_async(self, 
        ...
        """
        Asynchronously streams ResourceTypeInstance and returns headers from first page
    ...
    def list_with_http_info(self, 
        ...
        """
        Lists ResourceTypeInstance and returns headers from first page
    ...
    async def list_with_http_info_async(self, 
        ...
        """
        Asynchronously lists ResourceTypeInstance and returns headers from first page
    ...
    def page(self, 
        ...
        return ResourceTypePage(self._version, response)
    ...
    def page_with_http_info(self, 
        ...
        :returns: ApiResponse with ResourceTypePage, status code, and headers
        """
        data = values.of({ 
            'PageToken': page_token,
            'Page': page_number,
        ...
        page = ResourceTypePage(self._version, response)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Iam.Users_manisingh_codehq_open_api_spec_iam_scim_openapi_yaml.ResourceTypeList>'
