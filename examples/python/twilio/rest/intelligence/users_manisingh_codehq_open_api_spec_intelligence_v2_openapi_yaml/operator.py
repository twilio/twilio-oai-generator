...
class OperatorInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], sid: Optional[str] = None):
        ...
        self.availability: Optional["OperatorInstance.Availability"] = payload.get("availability")
    ...
    def _proxy(self) -> "OperatorContext":
        ...
        if self._context is None:
            self._context = OperatorContext(self._version, sid=self._solution['sid'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.OperatorInstance {}>'.format(context)
...
class OperatorContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.OperatorContext {}>'.format(context)
...
class OperatorPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.OperatorPage>"
...
class OperatorList(ListResource):
    ...
    def list(self, 
        ...
        return [OperatorInstance(self._version, item) for item in payload["operators"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.OperatorList>'
