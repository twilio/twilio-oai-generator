...
from twilio.rest.intelligence.users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.transcript.encrypted_operator_results import EncryptedOperatorResultsList
from twilio.rest.intelligence.users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.transcript.encrypted_sentences import EncryptedSentencesList
from twilio.rest.intelligence.users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.transcript.media import MediaList
from twilio.rest.intelligence.users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.transcript.operator_result import OperatorResultList
from twilio.rest.intelligence.users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.transcript.sentence import SentenceList
...
class TranscriptInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.TranscriptInstance {}>'.format(context)
...
class TranscriptContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.TranscriptContext {}>'.format(context)
...
class TranscriptPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.TranscriptPage>"
...
class TranscriptList(ListResource):
    ...
    def list(self, 
        ...
        return [TranscriptInstance(self._version, item) for item in payload["transcripts"]]
    ...
    def _create(self, service_sid: str, channel: object, customer_key: Union[str, object]=values.unset, media_start_time: Union[datetime, object]=values.unset) -> tuple:
        """
    ...
    def create(self, service_sid: str, channel: object, customer_key: Union[str, object]=values.unset, media_start_time: Union[datetime, object]=values.unset) -> TranscriptInstance:
        ...
        """
        payload, _, _ = self._create(service_sid=service_sid, channel=channel, customer_key=customer_key, media_start_time=media_start_time)
        return TranscriptInstance(self._version, payload)

    def create_with_http_info(self, service_sid: str, channel: object, customer_key: Union[str, object]=values.unset, media_start_time: Union[datetime, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(service_sid=service_sid, channel=channel, customer_key=customer_key, media_start_time=media_start_time)
        instance = TranscriptInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, service_sid: str, channel: object, customer_key: Union[str, object]=values.unset, media_start_time: Union[datetime, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, service_sid: str, channel: object, customer_key: Union[str, object]=values.unset, media_start_time: Union[datetime, object]=values.unset) -> TranscriptInstance:
        ...
        :returns: The created TranscriptInstance
        """
        payload, _, _ = await self._create_async(service_sid=service_sid, channel=channel, customer_key=customer_key, media_start_time=media_start_time)
        return TranscriptInstance(self._version, payload)

    async def create_with_http_info_async(self, service_sid: str, channel: object, customer_key: Union[str, object]=values.unset, media_start_time: Union[datetime, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(service_sid=service_sid, channel=channel, customer_key=customer_key, media_start_time=media_start_time)
        instance = TranscriptInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.TranscriptList>'
