...
class CustomOperatorInstance(InstanceResource):
    ...
    def update_with_http_info(self, friendly_name: str, config: object, if_match: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(friendly_name=friendly_name, config=config, if_match=if_match, )

    async def update_with_http_info_async(self, friendly_name: str, config: object, if_match: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(friendly_name=friendly_name, config=config, if_match=if_match, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.CustomOperatorInstance {}>'.format(context)
...
class CustomOperatorContext(InstanceContext):
    ...
    def _update(self, friendly_name: str, config: object, if_match: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def update(self, friendly_name: str, config: object, if_match: Union[str, object]=values.unset) -> CustomOperatorInstance:
        ...
        :returns: The updated CustomOperatorInstance
        """
        payload, _, _ = self._update(friendly_name=friendly_name, config=config, if_match=if_match)
        return CustomOperatorInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    def update_with_http_info(self, friendly_name: str, config: object, if_match: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._update(friendly_name=friendly_name, config=config, if_match=if_match)
        instance = CustomOperatorInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    async def _update_async(self, friendly_name: str, config: object, if_match: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def update_async(self, friendly_name: str, config: object, if_match: Union[str, object]=values.unset) -> CustomOperatorInstance:
        ...
        :returns: The updated CustomOperatorInstance
        """
        payload, _, _ = await self._update_async(friendly_name=friendly_name, config=config, if_match=if_match)
        return CustomOperatorInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    async def update_with_http_info_async(self, friendly_name: str, config: object, if_match: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(friendly_name=friendly_name, config=config, if_match=if_match)
        instance = CustomOperatorInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.CustomOperatorContext {}>'.format(context)
...
class CustomOperatorPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.CustomOperatorPage>"
...
class CustomOperatorList(ListResource):
    ...
    def list(self, 
        ...
        return [CustomOperatorInstance(self._version, item) for item in payload["operators"]]
    ...
    def create(self, friendly_name: str, operator_type: str, config: object) -> CustomOperatorInstance:
        ...
        """
        payload, _, _ = self._create(friendly_name=friendly_name, operator_type=operator_type, config=config)
        return CustomOperatorInstance(self._version, payload)
    ...
    def create_with_http_info(self, friendly_name: str, operator_type: str, config: object) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(friendly_name=friendly_name, operator_type=operator_type, config=config)
        instance = CustomOperatorInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, friendly_name: str, operator_type: str, config: object) -> tuple:
        """
    ...
    async def create_async(self, friendly_name: str, operator_type: str, config: object) -> CustomOperatorInstance:
        ...
        :returns: The created CustomOperatorInstance
        """
        payload, _, _ = await self._create_async(friendly_name=friendly_name, operator_type=operator_type, config=config)
        return CustomOperatorInstance(self._version, payload)
    ...
    async def create_with_http_info_async(self, friendly_name: str, operator_type: str, config: object) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(friendly_name=friendly_name, operator_type=operator_type, config=config)
        instance = CustomOperatorInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.CustomOperatorList>'
