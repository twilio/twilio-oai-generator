...
class OperatorTypeInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.OperatorTypeInstance {}>'.format(context)
...
class OperatorTypeContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.OperatorTypeContext {}>'.format(context)
...
class OperatorTypePage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.OperatorTypePage>"
...
class OperatorTypeList(ListResource):
    ...
    def list(self, 
        ...
        return [OperatorTypeInstance(self._version, item) for item in payload["operator_types"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.OperatorTypeList>'
