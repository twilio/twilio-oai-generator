...
class PrebuiltOperatorInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.PrebuiltOperatorInstance {}>'.format(context)
...
class PrebuiltOperatorContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.PrebuiltOperatorContext {}>'.format(context)
...
class PrebuiltOperatorPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.PrebuiltOperatorPage>"
...
class PrebuiltOperatorList(ListResource):
    ...
    def list(self, 
        ...
        return [PrebuiltOperatorInstance(self._version, item) for item in payload["operators"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.PrebuiltOperatorList>'
