...
class OperatorAttachmentInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.OperatorAttachmentInstance {}>'.format(context)
...
class OperatorAttachmentContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.OperatorAttachmentContext {}>'.format(context)
...
class OperatorAttachmentList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v2_openapi_yaml.OperatorAttachmentList>'
