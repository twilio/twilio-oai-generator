...
class ConversationInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:ResponseResource, id: Optional[str] = None):
        ...
        self.status: Optional["ConversationInstance.ConversationStatus"] = payload.get("status")
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v3_openapi_yaml.ConversationInstance {}>'.format(context)
...
class ConversationContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v3_openapi_yaml.ConversationContext {}>'.format(context)
...
class ConversationPage(TokenPagination):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v3_openapi_yaml.ConversationPage>"
...
class ConversationList(ListResource):
    ...
    def stream(self, 
        ...
        status: Union[ConversationStatus, object] = values.unset,
        channel_id: Union[str, object] = values.unset,
        channels: Union[List[Channel], object] = values.unset,
        ...
        :param ConversationStatus status: Filter by Conversation status.
        :param str channel_id: Filters Conversations by the underlying channel resource ID, such as a Call ID or Message ID.
        :param List[Channel] channels: Filters Conversations that include one or more of the specified communication channels (`OR` match).
    ...
    def page(self, 
      ...
      operator_ids: Union[List[str], object] = values.unset,
        ...
        data = values.of({ 
            ...
            'intelligenceConfigurationIds': serialize.map(intelligence_configuration_ids, lambda e: e),
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v3_openapi_yaml.ConversationList>'
