...
class MediaInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v1_openapi_yaml.MediaInstance {}>'.format(context)
...
class MediaList(ListResource):
    ...
    def fetch(self, redacted: Union[bool, object]=values.unset) -> MediaInstance:
        ...
        return MediaInstance(self._version, payload, sid=self._solution['sid'])
    ...
    def fetch_with_http_info(self, redacted: Union[bool, object]=values.unset) -> ApiResponse:
        ...
        instance = MediaInstance(self._version, payload, sid=self._solution['sid'])
    ...
    def list(self, 
        ...
        return [MediaInstance(self._version, item, sid=self._solution['sid']) for item in payload[""]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Intelligence.Users_manisingh_codehq_open_api_spec_intelligence_v1_openapi_yaml.MediaList>'
