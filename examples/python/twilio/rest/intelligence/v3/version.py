...
class VersionInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:ResponseResource, id: str, resource_version: Optional[int] = None):
        super().__init__(version)

        
        self.version: Optional[int] = deserialize.integer(payload.get("version"))
        self.status: Optional["VersionInstance.OperatorVersionStatus"] = payload.get("status")
        self.date_created: Optional[datetime] = deserialize.iso8601_datetime(payload.get("dateCreated"))
        self.date_deprecated: Optional[datetime] = deserialize.iso8601_datetime(payload.get("dateDeprecated"))
        self.retirement_date: Optional[datetime] = deserialize.iso8601_datetime(payload.get("retirementDate"))
        self.date_retired: Optional[datetime] = deserialize.iso8601_datetime(payload.get("dateRetired"))
        ...
        self.output_format: Optional["VersionInstance.str"] = payload.get("outputFormat")
    ...
    def _proxy(self) -> "VersionContext":
        ...
        if self._context is None:
            self._context = VersionContext(self._version, id=self._solution['id'], resource_version=self._solution['resource_version'],)
...
class VersionContext(InstanceContext):
    ...
    def __init__(self, version: Version, id: str, resource_version: int):
        ...
        self._uri = '/ControlPlane/Operators/{id}/Versions/{resource_version}'.format(**self._solution)
...
class VersionList(ListResource):
    ...
    def page(self, 
      ...
      page_token: Union[str, object] = values.unset,
        ...
        return VersionPage(self._version, response, uri=self._uri, params=data, solution=self._solution)
    ...
    def page_with_http_info(self, 
        ...
        page = VersionPage(self._version, response, uri=self._uri, solution=self._solution)
    ...
    def get(self, resource_version: int) -> VersionContext:
        ...
        :param resource_version: The numeric version number of the Language Operator.
        """
        return VersionContext(self._version, id=self._solution['id'], resource_version=resource_version)
