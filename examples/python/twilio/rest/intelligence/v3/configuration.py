...
class ConfigurationInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:ResponseResource, id: Optional[str] = None):
        ...
        self.rules: Optional[List[Rule]] = payload.get("rules")
...
class ConfigurationList(ListResource):
    ...
    class Rule(object):
        """
            :ivar id: The unique identifier for the Rule. Assigned by Twilio (TTID).
            :ivar operators: List of Operators to be executed by the Rule. Maximum of five (5) Operators allowed per Rule.
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.id: Optional[str] = payload.get("id")
            self.operators: Optional[List[Operator]] = payload.get("operators")
            self.triggers: Optional[List[Trigger]] = payload.get("triggers")
            self.actions: Optional[List[Action]] = payload.get("actions")
            self.context: Optional[Context] = payload.get("context")
