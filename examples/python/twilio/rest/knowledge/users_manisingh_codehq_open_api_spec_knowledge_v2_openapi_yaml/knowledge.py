...
class KnowledgeInstance(InstanceResource):
    ...
    class KnowledgeCore(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.source: Optional[KnowledgeList.KnowledgeSourceTypes] = payload.get("source")
    ...
    class KnowledgeSourceTypes(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.crawl_period: Optional["KnowledgeInstance.str"] = payload.get("crawlPeriod")
            self.file_name: Optional[str] = payload.get("fileName")
            self.file_size: Optional[int] = payload.get("fileSize")
            self.mime_type: Optional["KnowledgeInstance.SupportedFileMimeType"] = payload.get("mimeType")
    ...
    def update(self, refresh: Union[bool, object]=values.unset, knowledge_core: Union[KnowledgeCore, object]=values.unset) -> "KnowledgeInstance":
        """
    ...
    async def update_async(self, refresh: Union[bool, object]=values.unset, knowledge_core: Union[KnowledgeCore, object]=values.unset) -> "KnowledgeInstance":
        """
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Knowledge.Users_manisingh_codehq_open_api_spec_knowledge_v2_openapi_yaml.KnowledgeInstance {}>'.format(context)
...
class KnowledgeContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Knowledge.Users_manisingh_codehq_open_api_spec_knowledge_v2_openapi_yaml.KnowledgeContext {}>'.format(context)
...
class KnowledgePage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Knowledge.Users_manisingh_codehq_open_api_spec_knowledge_v2_openapi_yaml.KnowledgePage>"
...
class KnowledgeList(ListResource):
    ...
    def create_with_http_info(self, knowledge_core: KnowledgeCore) -> ApiResponse:
        ...
        instance = KnowledgeInstance(self._version, payload, kb_id=self._solution['kb_id'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Knowledge.Users_manisingh_codehq_open_api_spec_knowledge_v2_openapi_yaml.KnowledgeList>'
