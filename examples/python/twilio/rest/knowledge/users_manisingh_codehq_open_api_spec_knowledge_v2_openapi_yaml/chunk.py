...
class ChunkInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], kb_id: Optional[str] = None, knowledge_id: Optional[str] = None):
        ...
        self.document_number: Optional[int] = deserialize.integer(payload.get("documentNumber"))
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Knowledge.Users_manisingh_codehq_open_api_spec_knowledge_v2_openapi_yaml.ChunkInstance {}>'.format(context)
...
class ChunkPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Knowledge.Users_manisingh_codehq_open_api_spec_knowledge_v2_openapi_yaml.ChunkPage>"
...
class ChunkList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Knowledge.Users_manisingh_codehq_open_api_spec_knowledge_v2_openapi_yaml.ChunkList>'
