...
class InviteInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Chat.Users_manisingh_codehq_open_api_spec_chat_v2_openapi_yaml.InviteInstance {}>'.format(context)
...
class InviteContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Chat.Users_manisingh_codehq_open_api_spec_chat_v2_openapi_yaml.InviteContext {}>'.format(context)
...
class InvitePage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Chat.Users_manisingh_codehq_open_api_spec_chat_v2_openapi_yaml.InvitePage>"
...
class InviteList(ListResource):
    ...
    def list(self, 
        ...
        return [InviteInstance(self._version, item, service_sid=self._solution['service_sid'], channel_sid=self._solution['channel_sid']) for item in payload["invites"]]
    ...
    def create(self, identity: str, role_sid: Union[str, object]=values.unset) -> InviteInstance:
        """
    ...
    def create_with_http_info(self, identity: str, role_sid: Union[str, object]=values.unset) -> ApiResponse:
        ...
        instance = InviteInstance(self._version, payload, service_sid=self._solution['service_sid'], channel_sid=self._solution['channel_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    async def create_async(self, identity: str, role_sid: Union[str, object]=values.unset) -> InviteInstance:
        """
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Chat.Users_manisingh_codehq_open_api_spec_chat_v2_openapi_yaml.InviteList>'
