...
class UserBindingInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Chat.Users_manisingh_codehq_open_api_spec_chat_v2_openapi_yaml.UserBindingInstance {}>'.format(context)
...
class UserBindingContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Chat.Users_manisingh_codehq_open_api_spec_chat_v2_openapi_yaml.UserBindingContext {}>'.format(context)
...
class UserBindingPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Chat.Users_manisingh_codehq_open_api_spec_chat_v2_openapi_yaml.UserBindingPage>"
...
class UserBindingList(ListResource):
    ...
    def list(self, 
        ...
        return [UserBindingInstance(self._version, item, service_sid=self._solution['service_sid'], user_sid=self._solution['user_sid']) for item in payload["bindings"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Chat.Users_manisingh_codehq_open_api_spec_chat_v2_openapi_yaml.UserBindingList>'
