...
class RoleInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Chat.Users_manisingh_codehq_open_api_spec_chat_v1_openapi_yaml.RoleInstance {}>'.format(context)
...
class RoleContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Chat.Users_manisingh_codehq_open_api_spec_chat_v1_openapi_yaml.RoleContext {}>'.format(context)
...
class RolePage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Chat.Users_manisingh_codehq_open_api_spec_chat_v1_openapi_yaml.RolePage>"
...
class RoleList(ListResource):
    ...
    def list(self, 
        ...
        return [RoleInstance(self._version, item, service_sid=self._solution['service_sid']) for item in payload["roles"]]
    ...
    def create_with_http_info(self, friendly_name: str, type: "RoleInstance.RoleType", permission: List[str]) -> ApiResponse:
        ...
        instance = RoleInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Chat.Users_manisingh_codehq_open_api_spec_chat_v1_openapi_yaml.RoleList>'
