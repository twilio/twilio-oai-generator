...
class EventList(ListResource):
    ...
    def __init__(self, version: Version, conversation_id: str):
        ...
        self._uri = '/analytics/conversations/{conversation_id}/events'.format(**self._solution)
    ...
    def list(self, 
        ...
        return [EventInstance(self._version, item, conversation_id=self._solution['conversation_id']) for item in payload[""]]
    ...
    def __repr__(self) -> str:
        ...
        """
        return '<Twilio.WiseOwlAdminApiUs1.V2.EventList>'
