...
class CertificateInstance(InstanceResource):
    ...
    """
    :ivar certificate_sid: 
    :ivar domain_name: 
    :ivar domain_sid: 
    :ivar date_expires: 
    :ivar date_created: 
    :ivar date_updated: 
    :ivar cert_in_validation: 
    :ivar managed: 
    :ivar requesting: 
    """
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], domain_sid: Optional[str] = None):
        ...
        self.cert_in_validation: Optional[str] = payload.get("cert_in_validation")
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.MessagingAdminApiUs1.V1.CertificateInstance {}>'.format(context)
...
class CertificateList(ListResource):
    ...
    def list(self, 
        ...
        return [CertificateInstance(self._version, item, domain_sid=self._solution['domain_sid']) for item in payload[""]]
    ...
    def list_with_http_info(self, 
        ...
        """
        Lists CertificateInstance and returns headers from first page
    ...
    async def list_with_http_info_async(self, 
        ...
        """
        Asynchronously lists CertificateInstance and returns headers from first page
    ...
    def page(self, 
      account_sid: Union[str, object] = values.unset,
        ...
        return CertificatePage(self._version, response, solution=self._solution)
    ...
    def page_with_http_info(self, 
        ...
        :returns: ApiResponse with CertificatePage, status code, and headers
        """
        data = values.of({ 
            'accountSid': account_sid,
            'PageToken': page_token,
        ...
        page = CertificatePage(self._version, response, solution=self._solution)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.MessagingAdminApiUs1.V1.CertificateList>'
