...
from twilio.rest.messaging.users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.service.add_on import AddOnList
from twilio.rest.messaging.users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.service.alpha_sender import AlphaSenderList
from twilio.rest.messaging.users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.service.channel_sender import ChannelSenderList
from twilio.rest.messaging.users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.service.destination_alpha_sender import DestinationAlphaSenderList
from twilio.rest.messaging.users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.service.message import MessageList
from twilio.rest.messaging.users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.service.numbers_and_sender import NumbersAndSenderList
from twilio.rest.messaging.users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.service.phone_number import PhoneNumberList
from twilio.rest.messaging.users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.service.short_code import ShortCodeList
from twilio.rest.messaging.users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.service.us_app_to_person import UsAppToPersonList
from twilio.rest.messaging.users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.service.us_app_to_person_usecase import UsAppToPersonUsecaseList
...
class ServiceInstance(InstanceResource):
    ...
    :ivar number_sid: The SID to identify the number resource.
    """
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], sid: Optional[str] = None):
        ...
        self.sending_windows: Optional[Dict[str, object]] = payload.get("sending_windows")
        self.number_sid: Optional[str] = payload.get("number_sid")
    ...
    def update_with_http_info(self, friendly_name: Union[str, object]=values.unset, inbound_request_url: Union[str, object]=values.unset, inbound_method: Union[str, object]=values.unset, fallback_url: Union[str, object]=values.unset, fallback_method: Union[str, object]=values.unset, status_callback: Union[str, object]=values.unset, sticky_sender: Union[bool, object]=values.unset, mms_converter: Union[bool, object]=values.unset, smart_encoding: Union[bool, object]=values.unset, scan_message_content: Union["ServiceInstance.ScanMessageContent", object]=values.unset, fallback_to_long_code: Union[bool, object]=values.unset, area_code_geomatch: Union[bool, object]=values.unset, validity_period: Union[int, object]=values.unset, synchronous_validation: Union[bool, object]=values.unset, usecase: Union[str, object]=values.unset, use_inbound_webhook_on_number: Union[bool, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(friendly_name=friendly_name, inbound_request_url=inbound_request_url, inbound_method=inbound_method, fallback_url=fallback_url, fallback_method=fallback_method, status_callback=status_callback, sticky_sender=sticky_sender, mms_converter=mms_converter, smart_encoding=smart_encoding, scan_message_content=scan_message_content, fallback_to_long_code=fallback_to_long_code, area_code_geomatch=area_code_geomatch, validity_period=validity_period, synchronous_validation=synchronous_validation, usecase=usecase, use_inbound_webhook_on_number=use_inbound_webhook_on_number, )
    ...
    async def update_with_http_info_async(self, friendly_name: Union[str, object]=values.unset, inbound_request_url: Union[str, object]=values.unset, inbound_method: Union[str, object]=values.unset, fallback_url: Union[str, object]=values.unset, fallback_method: Union[str, object]=values.unset, status_callback: Union[str, object]=values.unset, sticky_sender: Union[bool, object]=values.unset, mms_converter: Union[bool, object]=values.unset, smart_encoding: Union[bool, object]=values.unset, scan_message_content: Union["ServiceInstance.ScanMessageContent", object]=values.unset, fallback_to_long_code: Union[bool, object]=values.unset, area_code_geomatch: Union[bool, object]=values.unset, validity_period: Union[int, object]=values.unset, synchronous_validation: Union[bool, object]=values.unset, usecase: Union[str, object]=values.unset, use_inbound_webhook_on_number: Union[bool, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(friendly_name=friendly_name, inbound_request_url=inbound_request_url, inbound_method=inbound_method, fallback_url=fallback_url, fallback_method=fallback_method, status_callback=status_callback, sticky_sender=sticky_sender, mms_converter=mms_converter, smart_encoding=smart_encoding, scan_message_content=scan_message_content, fallback_to_long_code=fallback_to_long_code, area_code_geomatch=area_code_geomatch, validity_period=validity_period, synchronous_validation=synchronous_validation, usecase=usecase, use_inbound_webhook_on_number=use_inbound_webhook_on_number, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.ServiceInstance {}>'.format(context)
...
class ServiceContext(InstanceContext):
    ...
    def _update(self, friendly_name: Union[str, object]=values.unset, inbound_request_url: Union[str, object]=values.unset, inbound_method: Union[str, object]=values.unset, fallback_url: Union[str, object]=values.unset, fallback_method: Union[str, object]=values.unset, status_callback: Union[str, object]=values.unset, sticky_sender: Union[bool, object]=values.unset, mms_converter: Union[bool, object]=values.unset, smart_encoding: Union[bool, object]=values.unset, scan_message_content: Union["ServiceInstance.ScanMessageContent", object]=values.unset, fallback_to_long_code: Union[bool, object]=values.unset, area_code_geomatch: Union[bool, object]=values.unset, validity_period: Union[int, object]=values.unset, synchronous_validation: Union[bool, object]=values.unset, usecase: Union[str, object]=values.unset, use_inbound_webhook_on_number: Union[bool, object]=values.unset) -> tuple:
        """
    ...
    def update(self, friendly_name: Union[str, object]=values.unset, inbound_request_url: Union[str, object]=values.unset, inbound_method: Union[str, object]=values.unset, fallback_url: Union[str, object]=values.unset, fallback_method: Union[str, object]=values.unset, status_callback: Union[str, object]=values.unset, sticky_sender: Union[bool, object]=values.unset, mms_converter: Union[bool, object]=values.unset, smart_encoding: Union[bool, object]=values.unset, scan_message_content: Union["ServiceInstance.ScanMessageContent", object]=values.unset, fallback_to_long_code: Union[bool, object]=values.unset, area_code_geomatch: Union[bool, object]=values.unset, validity_period: Union[int, object]=values.unset, synchronous_validation: Union[bool, object]=values.unset, usecase: Union[str, object]=values.unset, use_inbound_webhook_on_number: Union[bool, object]=values.unset) -> ServiceInstance:
        ...
        :returns: The updated ServiceInstance
        """
        payload, _, _ = self._update(friendly_name=friendly_name, inbound_request_url=inbound_request_url, inbound_method=inbound_method, fallback_url=fallback_url, fallback_method=fallback_method, status_callback=status_callback, sticky_sender=sticky_sender, mms_converter=mms_converter, smart_encoding=smart_encoding, scan_message_content=scan_message_content, fallback_to_long_code=fallback_to_long_code, area_code_geomatch=area_code_geomatch, validity_period=validity_period, synchronous_validation=synchronous_validation, usecase=usecase, use_inbound_webhook_on_number=use_inbound_webhook_on_number)
        return ServiceInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    def update_with_http_info(self, friendly_name: Union[str, object]=values.unset, inbound_request_url: Union[str, object]=values.unset, inbound_method: Union[str, object]=values.unset, fallback_url: Union[str, object]=values.unset, fallback_method: Union[str, object]=values.unset, status_callback: Union[str, object]=values.unset, sticky_sender: Union[bool, object]=values.unset, mms_converter: Union[bool, object]=values.unset, smart_encoding: Union[bool, object]=values.unset, scan_message_content: Union["ServiceInstance.ScanMessageContent", object]=values.unset, fallback_to_long_code: Union[bool, object]=values.unset, area_code_geomatch: Union[bool, object]=values.unset, validity_period: Union[int, object]=values.unset, synchronous_validation: Union[bool, object]=values.unset, usecase: Union[str, object]=values.unset, use_inbound_webhook_on_number: Union[bool, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._update(friendly_name=friendly_name, inbound_request_url=inbound_request_url, inbound_method=inbound_method, fallback_url=fallback_url, fallback_method=fallback_method, status_callback=status_callback, sticky_sender=sticky_sender, mms_converter=mms_converter, smart_encoding=smart_encoding, scan_message_content=scan_message_content, fallback_to_long_code=fallback_to_long_code, area_code_geomatch=area_code_geomatch, validity_period=validity_period, synchronous_validation=synchronous_validation, usecase=usecase, use_inbound_webhook_on_number=use_inbound_webhook_on_number)
        instance = ServiceInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.ServiceContext {}>'.format(context)
...
class ServicePage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.ServicePage>"
...
class ServiceList(ListResource):
    ...
    def _create(self, friendly_name: str, inbound_request_url: Union[str, object]=values.unset, inbound_method: Union[str, object]=values.unset, fallback_url: Union[str, object]=values.unset, fallback_method: Union[str, object]=values.unset, status_callback: Union[str, object]=values.unset, sticky_sender: Union[bool, object]=values.unset, mms_converter: Union[bool, object]=values.unset, smart_encoding: Union[bool, object]=values.unset, scan_message_content: Union["ServiceInstance.ScanMessageContent", object]=values.unset, fallback_to_long_code: Union[bool, object]=values.unset, area_code_geomatch: Union[bool, object]=values.unset, validity_period: Union[int, object]=values.unset, synchronous_validation: Union[bool, object]=values.unset, usecase: Union[str, object]=values.unset, use_inbound_webhook_on_number: Union[bool, object]=values.unset) -> tuple:
        """
    ...
    def create(self, friendly_name: str, inbound_request_url: Union[str, object]=values.unset, inbound_method: Union[str, object]=values.unset, fallback_url: Union[str, object]=values.unset, fallback_method: Union[str, object]=values.unset, status_callback: Union[str, object]=values.unset, sticky_sender: Union[bool, object]=values.unset, mms_converter: Union[bool, object]=values.unset, smart_encoding: Union[bool, object]=values.unset, scan_message_content: Union["ServiceInstance.ScanMessageContent", object]=values.unset, fallback_to_long_code: Union[bool, object]=values.unset, area_code_geomatch: Union[bool, object]=values.unset, validity_period: Union[int, object]=values.unset, synchronous_validation: Union[bool, object]=values.unset, usecase: Union[str, object]=values.unset, use_inbound_webhook_on_number: Union[bool, object]=values.unset) -> ServiceInstance:
        ...
        """
        payload, _, _ = self._create(friendly_name=friendly_name, inbound_request_url=inbound_request_url, inbound_method=inbound_method, fallback_url=fallback_url, fallback_method=fallback_method, status_callback=status_callback, sticky_sender=sticky_sender, mms_converter=mms_converter, smart_encoding=smart_encoding, scan_message_content=scan_message_content, fallback_to_long_code=fallback_to_long_code, area_code_geomatch=area_code_geomatch, validity_period=validity_period, synchronous_validation=synchronous_validation, usecase=usecase, use_inbound_webhook_on_number=use_inbound_webhook_on_number)
        return ServiceInstance(self._version, payload)

    def create_with_http_info(self, friendly_name: str, inbound_request_url: Union[str, object]=values.unset, inbound_method: Union[str, object]=values.unset, fallback_url: Union[str, object]=values.unset, fallback_method: Union[str, object]=values.unset, status_callback: Union[str, object]=values.unset, sticky_sender: Union[bool, object]=values.unset, mms_converter: Union[bool, object]=values.unset, smart_encoding: Union[bool, object]=values.unset, scan_message_content: Union["ServiceInstance.ScanMessageContent", object]=values.unset, fallback_to_long_code: Union[bool, object]=values.unset, area_code_geomatch: Union[bool, object]=values.unset, validity_period: Union[int, object]=values.unset, synchronous_validation: Union[bool, object]=values.unset, usecase: Union[str, object]=values.unset, use_inbound_webhook_on_number: Union[bool, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(friendly_name=friendly_name, inbound_request_url=inbound_request_url, inbound_method=inbound_method, fallback_url=fallback_url, fallback_method=fallback_method, status_callback=status_callback, sticky_sender=sticky_sender, mms_converter=mms_converter, smart_encoding=smart_encoding, scan_message_content=scan_message_content, fallback_to_long_code=fallback_to_long_code, area_code_geomatch=area_code_geomatch, validity_period=validity_period, synchronous_validation=synchronous_validation, usecase=usecase, use_inbound_webhook_on_number=use_inbound_webhook_on_number)
    ...
    async def create_with_http_info_async(self, friendly_name: str, inbound_request_url: Union[str, object]=values.unset, inbound_method: Union[str, object]=values.unset, fallback_url: Union[str, object]=values.unset, fallback_method: Union[str, object]=values.unset, status_callback: Union[str, object]=values.unset, sticky_sender: Union[bool, object]=values.unset, mms_converter: Union[bool, object]=values.unset, smart_encoding: Union[bool, object]=values.unset, scan_message_content: Union["ServiceInstance.ScanMessageContent", object]=values.unset, fallback_to_long_code: Union[bool, object]=values.unset, area_code_geomatch: Union[bool, object]=values.unset, validity_period: Union[int, object]=values.unset, synchronous_validation: Union[bool, object]=values.unset, usecase: Union[str, object]=values.unset, use_inbound_webhook_on_number: Union[bool, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(friendly_name=friendly_name, inbound_request_url=inbound_request_url, inbound_method=inbound_method, fallback_url=fallback_url, fallback_method=fallback_method, status_callback=status_callback, sticky_sender=sticky_sender, mms_converter=mms_converter, smart_encoding=smart_encoding, scan_message_content=scan_message_content, fallback_to_long_code=fallback_to_long_code, area_code_geomatch=area_code_geomatch, validity_period=validity_period, synchronous_validation=synchronous_validation, usecase=usecase, use_inbound_webhook_on_number=use_inbound_webhook_on_number)
        instance = ServiceInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def list(self, 
        number_sids: Union[List[str], object] = values.unset,
    ) -> List[ServiceInstance]:
        """
        Lists ServiceInstance records from the API as a list.
    ...
    def list_with_http_info(self, 
        ...
        :param List[str] number_sids: Sids of the numbers (phone number, short code, alpha sender) in String format.
        :param limit: Upper limit for the number of records to return. list() guarantees
                      never to return more than limit.  Default is no limit
        :param page_size: Number of records to fetch per request, when not set will use
                          the default value of 50 records.  If no page_size is defined
    ...
    def page(self, 
      number_sids: Union[List[str], object] = values.unset,
        ...
        :param number_sids: Sids of the numbers (phone number, short code, alpha sender) in String format.
        :param page_token: PageToken provided by the API
        :param page_number: Page Number, this value is simply for client state
        :param page_size: Number of records to return, defaults to 50
        ...
        """
        data = values.of({ 
            'numberSids': serialize.map(number_sids, lambda e: e),
            'PageToken': page_token,
            'Page': page_number,
            'PageSize': page_size,
        })
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.ServiceList>'
