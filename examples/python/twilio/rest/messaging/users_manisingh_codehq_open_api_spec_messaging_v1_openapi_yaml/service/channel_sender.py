...
class ChannelSenderInstance(InstanceResource):
    ...
    def _proxy(self) -> "ChannelSenderContext":
        ...
        if self._context is None:
            self._context = ChannelSenderContext(self._version, messaging_service_sid=self._solution['messaging_service_sid'], sid=self._solution['sid'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.ChannelSenderInstance {}>'.format(context)
...
class ChannelSenderContext(InstanceContext):
    ...
    def __init__(self, version: Version, messaging_service_sid: str, sid: str):
        ...
        self._uri = '/Services/{messaging_service_sid}/ChannelSenders/{sid}'.format(**self._solution)
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.ChannelSenderContext {}>'.format(context)
...
class ChannelSenderPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.ChannelSenderPage>"
...
class ChannelSenderList(ListResource):
    ...
    def __init__(self, version: Version, messaging_service_sid: str):
        ...
        self._uri = '/Services/{messaging_service_sid}/ChannelSenders'.format(**self._solution)
    ...
    def list(self, 
        ...
        return [ChannelSenderInstance(self._version, item, messaging_service_sid=self._solution['messaging_service_sid']) for item in payload["senders"]]
    ...
    def create_with_http_info(self, sid: str) -> ApiResponse:
        ...
        instance = ChannelSenderInstance(self._version, payload, messaging_service_sid=self._solution['messaging_service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def get(self, sid: str) -> ChannelSenderContext:
        ...
        :param sid: The SID of the ChannelSender resource to fetch.
        """
        return ChannelSenderContext(self._version, messaging_service_sid=self._solution['messaging_service_sid'], sid=sid)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.ChannelSenderList>'
