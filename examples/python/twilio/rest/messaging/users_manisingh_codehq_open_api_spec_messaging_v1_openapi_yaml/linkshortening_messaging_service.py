...
class LinkshorteningMessagingServiceInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], domain_sid: Optional[str] = None, messaging_service_sid: Optional[str] = None):
    ...
    def _proxy(self) -> "LinkshorteningMessagingServiceContext":
        ...
        if self._context is None:
            self._context = LinkshorteningMessagingServiceContext(self._version, domain_sid=self._solution['domain_sid'], messaging_service_sid=self._solution['messaging_service_sid'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.LinkshorteningMessagingServiceInstance {}>'.format(context)
...
class LinkshorteningMessagingServiceContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.LinkshorteningMessagingServiceContext {}>'.format(context)
...
class LinkshorteningMessagingServiceList(ListResource):
    ...
    def get(self, domain_sid: str, messaging_service_sid: str) -> LinkshorteningMessagingServiceContext:
        ...
        :param messaging_service_sid: A messaging service SID to associate with a domain. With URL shortening enabled, links in messages sent with the provided messaging service will be shortened to the associated domain
        """
        return LinkshorteningMessagingServiceContext(self._version, domain_sid=domain_sid, messaging_service_sid=messaging_service_sid)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.LinkshorteningMessagingServiceList>'
