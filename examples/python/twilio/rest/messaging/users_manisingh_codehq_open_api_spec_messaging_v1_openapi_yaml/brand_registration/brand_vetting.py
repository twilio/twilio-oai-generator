...
class BrandVettingInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.BrandVettingInstance {}>'.format(context)
...
class BrandVettingContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.BrandVettingContext {}>'.format(context)
...
class BrandVettingPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.BrandVettingPage>"
...
class BrandVettingList(ListResource):
    ...
    def list(self, 
        ...
        return [BrandVettingInstance(self._version, item, brand_sid=self._solution['brand_sid']) for item in payload["data"]]
    ...
    def _create(self, vetting_provider: "BrandVettingInstance.VettingProvider", vetting_id: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def create(self, vetting_provider: "BrandVettingInstance.VettingProvider", vetting_id: Union[str, object]=values.unset) -> BrandVettingInstance:
        ...
        """
        payload, _, _ = self._create(vetting_provider=vetting_provider, vetting_id=vetting_id)
        return BrandVettingInstance(self._version, payload, brand_sid=self._solution['brand_sid'])

    def create_with_http_info(self, vetting_provider: "BrandVettingInstance.VettingProvider", vetting_id: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(vetting_provider=vetting_provider, vetting_id=vetting_id)
        instance = BrandVettingInstance(self._version, payload, brand_sid=self._solution['brand_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, vetting_provider: "BrandVettingInstance.VettingProvider", vetting_id: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, vetting_provider: "BrandVettingInstance.VettingProvider", vetting_id: Union[str, object]=values.unset) -> BrandVettingInstance:
        ...
        :returns: The created BrandVettingInstance
        """
        payload, _, _ = await self._create_async(vetting_provider=vetting_provider, vetting_id=vetting_id)
        return BrandVettingInstance(self._version, payload, brand_sid=self._solution['brand_sid'])

    async def create_with_http_info_async(self, vetting_provider: "BrandVettingInstance.VettingProvider", vetting_id: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(vetting_provider=vetting_provider, vetting_id=vetting_id)
        instance = BrandVettingInstance(self._version, payload, brand_sid=self._solution['brand_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.BrandVettingList>'
