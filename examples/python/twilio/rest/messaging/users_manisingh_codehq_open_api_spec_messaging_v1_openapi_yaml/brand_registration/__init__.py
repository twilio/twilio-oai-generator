...
from twilio.rest.messaging.users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.brand_registration.brand_registration2_fa import BrandRegistration2FaList
from twilio.rest.messaging.users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.brand_registration.brand_registration_otp import BrandRegistrationOtpList
from twilio.rest.messaging.users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.brand_registration.brand_vetting import BrandVettingList
...
class BrandRegistrationInstance(InstanceResource):
    ...
    @property
    def brand_registration2_fa(self) -> BrandRegistration2FaList:
        """
        Access the brand_registration2_fa
        """
        return self._proxy.brand_registration2_fa
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.BrandRegistrationInstance {}>'.format(context)
...
class BrandRegistrationContext(InstanceContext):
    ...
    def __init__(self, version: Version, sid: str):
        ...
        self._brand_registration2_fa: Optional[BrandRegistration2FaList] = None
    ...
    def brand_registration2_fa(self) -> BrandRegistration2FaList:
        ...
        Access the brand_registration2_fa
        """
        if self._brand_registration2_fa is None:
            self._brand_registration2_fa = BrandRegistration2FaList(
                self._version, 
                self._solution['sid'],
            )
        return self._brand_registration2_fa
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.BrandRegistrationContext {}>'.format(context)
...
class BrandRegistrationPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.BrandRegistrationPage>"
...
class BrandRegistrationList(ListResource):
    ...
    def list(self, 
        ...
        return [BrandRegistrationInstance(self._version, item) for item in payload["data"]]
    ...
    def _create(self, customer_profile_bundle_sid: str, a2p_profile_bundle_sid: str, brand_type: Union[str, object]=values.unset, mock: Union[bool, object]=values.unset, skip_automatic_sec_vet: Union[bool, object]=values.unset) -> tuple:
        """
    ...
    def create(self, customer_profile_bundle_sid: str, a2p_profile_bundle_sid: str, brand_type: Union[str, object]=values.unset, mock: Union[bool, object]=values.unset, skip_automatic_sec_vet: Union[bool, object]=values.unset) -> BrandRegistrationInstance:
        ...
        """
        payload, _, _ = self._create(customer_profile_bundle_sid=customer_profile_bundle_sid, a2p_profile_bundle_sid=a2p_profile_bundle_sid, brand_type=brand_type, mock=mock, skip_automatic_sec_vet=skip_automatic_sec_vet)
        return BrandRegistrationInstance(self._version, payload)

    def create_with_http_info(self, customer_profile_bundle_sid: str, a2p_profile_bundle_sid: str, brand_type: Union[str, object]=values.unset, mock: Union[bool, object]=values.unset, skip_automatic_sec_vet: Union[bool, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(customer_profile_bundle_sid=customer_profile_bundle_sid, a2p_profile_bundle_sid=a2p_profile_bundle_sid, brand_type=brand_type, mock=mock, skip_automatic_sec_vet=skip_automatic_sec_vet)
        instance = BrandRegistrationInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, customer_profile_bundle_sid: str, a2p_profile_bundle_sid: str, brand_type: Union[str, object]=values.unset, mock: Union[bool, object]=values.unset, skip_automatic_sec_vet: Union[bool, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, customer_profile_bundle_sid: str, a2p_profile_bundle_sid: str, brand_type: Union[str, object]=values.unset, mock: Union[bool, object]=values.unset, skip_automatic_sec_vet: Union[bool, object]=values.unset) -> BrandRegistrationInstance:
        ...
        :returns: The created BrandRegistrationInstance
        """
        payload, _, _ = await self._create_async(customer_profile_bundle_sid=customer_profile_bundle_sid, a2p_profile_bundle_sid=a2p_profile_bundle_sid, brand_type=brand_type, mock=mock, skip_automatic_sec_vet=skip_automatic_sec_vet)
        return BrandRegistrationInstance(self._version, payload)

    async def create_with_http_info_async(self, customer_profile_bundle_sid: str, a2p_profile_bundle_sid: str, brand_type: Union[str, object]=values.unset, mock: Union[bool, object]=values.unset, skip_automatic_sec_vet: Union[bool, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(customer_profile_bundle_sid=customer_profile_bundle_sid, a2p_profile_bundle_sid=a2p_profile_bundle_sid, brand_type=brand_type, mock=mock, skip_automatic_sec_vet=skip_automatic_sec_vet)
        instance = BrandRegistrationInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Messaging.Users_manisingh_codehq_open_api_spec_messaging_v1_openapi_yaml.BrandRegistrationList>'
