...
class NetworkInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Supersim.Users_manisingh_codehq_open_api_spec_supersim_v1_openapi_yaml.NetworkInstance {}>'.format(context)
...
class NetworkContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Supersim.Users_manisingh_codehq_open_api_spec_supersim_v1_openapi_yaml.NetworkContext {}>'.format(context)
...
class NetworkPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Supersim.Users_manisingh_codehq_open_api_spec_supersim_v1_openapi_yaml.NetworkPage>"
...
class NetworkList(ListResource):
    ...
    def list(self, 
        ...
        return [NetworkInstance(self._version, item) for item in payload["networks"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Supersim.Users_manisingh_codehq_open_api_spec_supersim_v1_openapi_yaml.NetworkList>'
