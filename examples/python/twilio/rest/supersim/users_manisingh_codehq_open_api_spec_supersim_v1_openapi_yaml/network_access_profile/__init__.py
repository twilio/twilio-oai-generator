...
from twilio.rest.supersim.users_manisingh_codehq_open_api_spec_supersim_v1_openapi_yaml.network_access_profile.network_access_profile_network import NetworkAccessProfileNetworkList
...
class NetworkAccessProfileInstance(InstanceResource):
    ...
    def update_with_http_info(self, unique_name: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(unique_name=unique_name, )

    async def update_with_http_info_async(self, unique_name: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(unique_name=unique_name, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Supersim.Users_manisingh_codehq_open_api_spec_supersim_v1_openapi_yaml.NetworkAccessProfileInstance {}>'.format(context)
...
class NetworkAccessProfileContext(InstanceContext):
    ...
    async def _update_async(self, unique_name: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def update_with_http_info_async(self, unique_name: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(unique_name=unique_name)
        instance = NetworkAccessProfileInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Supersim.Users_manisingh_codehq_open_api_spec_supersim_v1_openapi_yaml.NetworkAccessProfileContext {}>'.format(context)
...
class NetworkAccessProfilePage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Supersim.Users_manisingh_codehq_open_api_spec_supersim_v1_openapi_yaml.NetworkAccessProfilePage>"
...
class NetworkAccessProfileList(ListResource):
    ...
    def list(self, 
        ...
        return [NetworkAccessProfileInstance(self._version, item) for item in payload["network_access_profiles"]]
    ...
    def _create(self, unique_name: Union[str, object]=values.unset, networks: Union[List[str], object]=values.unset) -> tuple:
        """
    ...
    def create_with_http_info(self, unique_name: Union[str, object]=values.unset, networks: Union[List[str], object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(unique_name=unique_name, networks=networks)
        instance = NetworkAccessProfileInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, unique_name: Union[str, object]=values.unset, networks: Union[List[str], object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, unique_name: Union[str, object]=values.unset, networks: Union[List[str], object]=values.unset) -> NetworkAccessProfileInstance:
        ...
        :returns: The created NetworkAccessProfileInstance
        """
        payload, _, _ = await self._create_async(unique_name=unique_name, networks=networks)
        return NetworkAccessProfileInstance(self._version, payload)

    async def create_with_http_info_async(self, unique_name: Union[str, object]=values.unset, networks: Union[List[str], object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(unique_name=unique_name, networks=networks)
        instance = NetworkAccessProfileInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Supersim.Users_manisingh_codehq_open_api_spec_supersim_v1_openapi_yaml.NetworkAccessProfileList>'
