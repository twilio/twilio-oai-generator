...
class NetworkAccessProfileNetworkInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Supersim.Users_manisingh_codehq_open_api_spec_supersim_v1_openapi_yaml.NetworkAccessProfileNetworkInstance {}>'.format(context)
...
class NetworkAccessProfileNetworkContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Supersim.Users_manisingh_codehq_open_api_spec_supersim_v1_openapi_yaml.NetworkAccessProfileNetworkContext {}>'.format(context)
...
class NetworkAccessProfileNetworkPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Supersim.Users_manisingh_codehq_open_api_spec_supersim_v1_openapi_yaml.NetworkAccessProfileNetworkPage>"
...
class NetworkAccessProfileNetworkList(ListResource):
    ...
    def list(self, 
        ...
        return [NetworkAccessProfileNetworkInstance(self._version, item, network_access_profile_sid=self._solution['network_access_profile_sid']) for item in payload["networks"]]
    ...
    def page(self, 
        ...
        return NetworkAccessProfileNetworkPage(self._version, response, solution=self._solution)
    ...
    def page_with_http_info(self, 
        ...
        page = NetworkAccessProfileNetworkPage(self._version, response, solution=self._solution)
    ...
    def create_with_http_info(self, network: str) -> ApiResponse:
        ...
        instance = NetworkAccessProfileNetworkInstance(self._version, payload, network_access_profile_sid=self._solution['network_access_profile_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Supersim.Users_manisingh_codehq_open_api_spec_supersim_v1_openapi_yaml.NetworkAccessProfileNetworkList>'
