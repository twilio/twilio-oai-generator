...
class EsimProfileInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Supersim.Users_manisingh_codehq_open_api_spec_supersim_v1_openapi_yaml.EsimProfileInstance {}>'.format(context)
...
class EsimProfileContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Supersim.Users_manisingh_codehq_open_api_spec_supersim_v1_openapi_yaml.EsimProfileContext {}>'.format(context)
...
class EsimProfilePage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Supersim.Users_manisingh_codehq_open_api_spec_supersim_v1_openapi_yaml.EsimProfilePage>"
...
class EsimProfileList(ListResource):
    ...
    def list(self, 
        ...
        return [EsimProfileInstance(self._version, item) for item in payload["esim_profiles"]]
    ...
    def _create(self, callback_url: Union[str, object]=values.unset, callback_method: Union[str, object]=values.unset, generate_matching_id: Union[bool, object]=values.unset, eid: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def create(self, callback_url: Union[str, object]=values.unset, callback_method: Union[str, object]=values.unset, generate_matching_id: Union[bool, object]=values.unset, eid: Union[str, object]=values.unset) -> EsimProfileInstance:
        ...
        """
        payload, _, _ = self._create(callback_url=callback_url, callback_method=callback_method, generate_matching_id=generate_matching_id, eid=eid)
        return EsimProfileInstance(self._version, payload)

    def create_with_http_info(self, callback_url: Union[str, object]=values.unset, callback_method: Union[str, object]=values.unset, generate_matching_id: Union[bool, object]=values.unset, eid: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(callback_url=callback_url, callback_method=callback_method, generate_matching_id=generate_matching_id, eid=eid)
        instance = EsimProfileInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, callback_url: Union[str, object]=values.unset, callback_method: Union[str, object]=values.unset, generate_matching_id: Union[bool, object]=values.unset, eid: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, callback_url: Union[str, object]=values.unset, callback_method: Union[str, object]=values.unset, generate_matching_id: Union[bool, object]=values.unset, eid: Union[str, object]=values.unset) -> EsimProfileInstance:
        ...
        :returns: The created EsimProfileInstance
        """
        payload, _, _ = await self._create_async(callback_url=callback_url, callback_method=callback_method, generate_matching_id=generate_matching_id, eid=eid)
        return EsimProfileInstance(self._version, payload)

    async def create_with_http_info_async(self, callback_url: Union[str, object]=values.unset, callback_method: Union[str, object]=values.unset, generate_matching_id: Union[bool, object]=values.unset, eid: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(callback_url=callback_url, callback_method=callback_method, generate_matching_id=generate_matching_id, eid=eid)
        instance = EsimProfileInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Supersim.Users_manisingh_codehq_open_api_spec_supersim_v1_openapi_yaml.EsimProfileList>'
