...
class ChannelInstance(InstanceResource):
    ...
    """
    :ivar sid: A 34 character string that uniquely identifies this Channel resource.
    :ivar message_sid: 
    ...
    :ivar channel: 
    :ivar from_: A single address in [E.164](https://www.twilio.com/docs/glossary/what-e164) format.
    :ivar to: A single address in [E.164](https://www.twilio.com/docs/glossary/what-e164) format.
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], message_sid: str, sid: Optional[str] = None):
        ...
        self.channel: Optional["ChannelInstance.ChannelName"] = payload.get("channel")
    ...
    def _proxy(self) -> "ChannelContext":
        ...
        if self._context is None:
            self._context = ChannelContext(self._version, message_sid=self._solution['message_sid'], sid=self._solution['sid'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Preview.Users_manisingh_codehq_open_api_spec_preview_dispatch_openapi_yaml.ChannelInstance {}>'.format(context)
...
class ChannelContext(InstanceContext):
    ...
    def __init__(self, version: Version, message_sid: str, sid: str):
        ...
        self._uri = '/Messages/{message_sid}/Channels/{sid}'.format(**self._solution)
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Preview.Users_manisingh_codehq_open_api_spec_preview_dispatch_openapi_yaml.ChannelContext {}>'.format(context)
...
class ChannelPage(Page):
    ...
    def get_instance(self, payload: Dict[str, Any]) -> ChannelInstance:
        ...
        return ChannelInstance(self._version, payload, message_sid=self._solution["message_sid"])
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Preview.Users_manisingh_codehq_open_api_spec_preview_dispatch_openapi_yaml.ChannelPage>"
...
class ChannelList(ListResource):
    ...
    def __init__(self, version: Version, message_sid: str):
        ...
        self._uri = '/Messages/{message_sid}/Channels'.format(**self._solution)
    ...
    def list(self, 
        ...
        return [ChannelInstance(self._version, item, message_sid=self._solution['message_sid']) for item in payload["channels"]]
    ...
    def get(self, sid: str) -> ChannelContext:
        ...
        :param sid: A 34 character string that uniquely identifies this Channel.
        """
        return ChannelContext(self._version, message_sid=self._solution['message_sid'], sid=sid)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Preview.Users_manisingh_codehq_open_api_spec_preview_dispatch_openapi_yaml.ChannelList>'
