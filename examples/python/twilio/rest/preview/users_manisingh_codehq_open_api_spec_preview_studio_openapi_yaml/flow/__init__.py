...
from twilio.rest.preview.users_manisingh_codehq_open_api_spec_preview_studio_openapi_yaml.flow.engagement import EngagementList
...
class FlowInstance(InstanceResource):
    ...
    """
    :ivar sid: A 34 character string that uniquely identifies this Flow.
    :ivar account_sid: The unique SID identifier of the Account.
    :ivar friendly_name: A human readable description of this resource, up to 64 characters.
    :ivar status: 
    :ivar debug: Boolean flag which will cause extra log data to be written to the SystemLog in a Flow Engagement Step.
    :ivar version: The latest version number of this Flow's definition.
    :ivar date_created: The date that this Flow was created, given in ISO 8601 format.
    :ivar date_updated: The date that this Flow was updated, given in ISO 8601 format.
    :ivar url: The URL of this resource.
    :ivar links: Contains a dictionary of URL links to nested resources of this Flow.
    """
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], sid: Optional[str] = None):
        ...
        self.debug: Optional[bool] = payload.get("debug")
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Preview.Users_manisingh_codehq_open_api_spec_preview_studio_openapi_yaml.FlowInstance {}>'.format(context)
...
class FlowContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Preview.Users_manisingh_codehq_open_api_spec_preview_studio_openapi_yaml.FlowContext {}>'.format(context)
...
class FlowPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Preview.Users_manisingh_codehq_open_api_spec_preview_studio_openapi_yaml.FlowPage>"
...
class FlowList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Preview.Users_manisingh_codehq_open_api_spec_preview_studio_openapi_yaml.FlowList>'
