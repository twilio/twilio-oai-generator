...
class StepInstance(InstanceResource):
    ...
    """
    :ivar sid: A 34 character string that uniquely identifies this Step.
    :ivar account_sid: The unique SID identifier of the Account.
    :ivar flow_sid: The unique SID identifier of the Flow.
    :ivar engagement_sid: The unique SID identifier of the Engagement.
    :ivar name: The Widget that implemented this Step.
    :ivar context: Contains a dictionary of URL links to nested resources of this Step.
    :ivar transitioned_from: The Widget that preceded the Widget for this Step.
    :ivar transitioned_to: The Widget that will follow the Widget for this Step.
    :ivar date_created: The date that this Step was created, given in ISO 8601 format.
    :ivar date_updated: The date that this Step was updated, given in ISO 8601 format.
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Preview.Users_manisingh_codehq_open_api_spec_preview_studio_openapi_yaml.StepInstance {}>'.format(context)
...
class StepContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Preview.Users_manisingh_codehq_open_api_spec_preview_studio_openapi_yaml.StepContext {}>'.format(context)
...
class StepPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Preview.Users_manisingh_codehq_open_api_spec_preview_studio_openapi_yaml.StepPage>"
...
class StepList(ListResource):
    ...
    def __init__(self, version: Version, flow_sid: str, engagement_sid: str):
        ...
        :param engagement_sid: The unique SID identifier of the Engagement.
    ...
    def list(self, 
        ...
        return [StepInstance(self._version, item, flow_sid=self._solution['flow_sid'], engagement_sid=self._solution['engagement_sid']) for item in payload["steps"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Preview.Users_manisingh_codehq_open_api_spec_preview_studio_openapi_yaml.StepList>'
