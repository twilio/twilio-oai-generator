...
class ExecutionInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], instance_sid: Optional[str] = None, sid: Optional[str] = None):
        ...
        self.end_reason: Optional["ExecutionInstance.EndReason"] = payload.get("end_reason")
    ...
    def _proxy(self) -> "ExecutionContext":
        ...
        if self._context is None:
            self._context = ExecutionContext(self._version, instance_sid=self._solution['instance_sid'], sid=self._solution['sid'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Preview.Users_manisingh_codehq_open_api_spec_preview_flex_openapi_yaml.ExecutionInstance {}>'.format(context)
...
class ExecutionContext(InstanceContext):
    ...
    def __init__(self, version: Version, instance_sid: str, sid: str):
        ...
        self._uri = '/Instances/{instance_sid}/Executions/{sid}'.format(**self._solution)
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Preview.Users_manisingh_codehq_open_api_spec_preview_flex_openapi_yaml.ExecutionContext {}>'.format(context)
...
class ExecutionPage(Page):
    ...
    def get_instance(self, payload: Dict[str, Any]) -> ExecutionInstance:
        ...
        return ExecutionInstance(self._version, payload, instance_sid=self._solution["instance_sid"])
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Preview.Users_manisingh_codehq_open_api_spec_preview_flex_openapi_yaml.ExecutionPage>"
...
class ExecutionList(ListResource):
    ...
    def __init__(self, version: Version, instance_sid: str):
        ...
        self._uri = '/Instances/{instance_sid}/Executions'.format(**self._solution)
    ...
    def list(self, 
        ...
        return [ExecutionInstance(self._version, item, instance_sid=self._solution['instance_sid']) for item in payload["executions"]]
    ...
    def create(self, body: Union[object, object]=values.unset) -> ExecutionInstance:
        """
    ...
    def create_with_http_info(self, body: Union[object, object]=values.unset) -> ApiResponse:
        ...
        instance = ExecutionInstance(self._version, payload, instance_sid=self._solution['instance_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    async def create_async(self, body: Union[object, object]=values.unset) -> ExecutionInstance:
        """
    ...
    def stream(self, 
        flow_identifier: Union[str, object] = values.unset,
    ...
    def get(self, instance_sid: str, sid: str) -> ExecutionContext:
        """
        ...
        :param sid: 
        """
        return ExecutionContext(self._version, instance_sid=instance_sid, sid=sid)

    def __call__(self, instance_sid: str, sid: str) -> ExecutionContext:
        """
        Constructs a ExecutionContext
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Preview.Users_manisingh_codehq_open_api_spec_preview_flex_openapi_yaml.ExecutionList>'
