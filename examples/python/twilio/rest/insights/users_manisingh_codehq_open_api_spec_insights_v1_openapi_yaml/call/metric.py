...
class MetricInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], call_sid: str):
        ...
        self.direction: Optional["MetricInstance.StreamDirection"] = payload.get("direction")
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Insights.Users_manisingh_codehq_open_api_spec_insights_v1_openapi_yaml.MetricInstance {}>'.format(context)
...
class MetricPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Insights.Users_manisingh_codehq_open_api_spec_insights_v1_openapi_yaml.MetricPage>"
...
class MetricList(ListResource):
    ...
    def list(self, 
        ...
        return [MetricInstance(self._version, item, call_sid=self._solution['call_sid']) for item in payload["metrics"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Insights.Users_manisingh_codehq_open_api_spec_insights_v1_openapi_yaml.MetricList>'
