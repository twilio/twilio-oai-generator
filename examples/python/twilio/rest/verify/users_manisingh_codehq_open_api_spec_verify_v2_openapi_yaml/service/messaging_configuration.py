...
class MessagingConfigurationInstance(InstanceResource):
    ...
    async def update_async(self, messaging_service_sid: str) -> "MessagingConfigurationInstance":
        ...
        :returns: The updated MessagingConfigurationInstance
        """
        return await self._proxy.update_async(messaging_service_sid=messaging_service_sid, )
    ...
    def update_with_http_info(self, messaging_service_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(messaging_service_sid=messaging_service_sid, )
    ...
    async def update_with_http_info_async(self, messaging_service_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(messaging_service_sid=messaging_service_sid, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.MessagingConfigurationInstance {}>'.format(context)
...
class MessagingConfigurationContext(InstanceContext):
    ...
    def update_with_http_info(self, messaging_service_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._update(messaging_service_sid=messaging_service_sid)
        instance = MessagingConfigurationInstance(
            self._version,
            payload,
            service_sid=self._solution['service_sid'],
    ...
    async def update_async(self, messaging_service_sid: str) -> MessagingConfigurationInstance:
        ...
        :returns: The updated MessagingConfigurationInstance
        """
        payload, _, _ = await self._update_async(messaging_service_sid=messaging_service_sid)
        return MessagingConfigurationInstance(
            self._version,
            payload,
            service_sid=self._solution['service_sid'],
    ...
    async def update_with_http_info_async(self, messaging_service_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(messaging_service_sid=messaging_service_sid)
        instance = MessagingConfigurationInstance(
            self._version,
            payload,
            service_sid=self._solution['service_sid'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.MessagingConfigurationContext {}>'.format(context)
...
class MessagingConfigurationPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.MessagingConfigurationPage>"
...
class MessagingConfigurationList(ListResource):
    ...
    def list(self, 
        ...
        return [MessagingConfigurationInstance(self._version, item, service_sid=self._solution['service_sid']) for item in payload["messaging_configurations"]]
    ...
    def page(self, 
        ...
        return MessagingConfigurationPage(self._version, response, solution=self._solution)
    ...
    def page_with_http_info(self, 
        ...
        page = MessagingConfigurationPage(self._version, response, solution=self._solution)
    ...
    def create(self, country: str, messaging_service_sid: str) -> MessagingConfigurationInstance:
        ...
        """
        payload, _, _ = self._create(country=country, messaging_service_sid=messaging_service_sid)
        return MessagingConfigurationInstance(self._version, payload, service_sid=self._solution['service_sid'])
    ...
    def create_with_http_info(self, country: str, messaging_service_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(country=country, messaging_service_sid=messaging_service_sid)
        instance = MessagingConfigurationInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    async def create_async(self, country: str, messaging_service_sid: str) -> MessagingConfigurationInstance:
        ...
        :returns: The created MessagingConfigurationInstance
        """
        payload, _, _ = await self._create_async(country=country, messaging_service_sid=messaging_service_sid)
        return MessagingConfigurationInstance(self._version, payload, service_sid=self._solution['service_sid'])
    ...
    async def create_with_http_info_async(self, country: str, messaging_service_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(country=country, messaging_service_sid=messaging_service_sid)
        instance = MessagingConfigurationInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.MessagingConfigurationList>'
