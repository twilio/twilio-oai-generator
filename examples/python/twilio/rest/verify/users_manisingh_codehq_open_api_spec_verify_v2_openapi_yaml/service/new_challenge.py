...
class NewChallengeInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.NewChallengeInstance {}>'.format(context)
...
class NewChallengeList(ListResource):
    ...
    def __init__(self, version: Version, service_sid: str):
        ...
        self._uri = '/Services/{service_sid}/Passkeys/Challenges'.format(**self._solution)
        
        
    
    def _create(self, create_passkeys_challenge_request: CreatePasskeysChallengeRequest) -> tuple:
        """
    ...
    def create(self, create_passkeys_challenge_request: CreatePasskeysChallengeRequest) -> NewChallengeInstance:
        ...
        return NewChallengeInstance(self._version, payload, service_sid=self._solution['service_sid'])
    ...
    def create_with_http_info(self, create_passkeys_challenge_request: CreatePasskeysChallengeRequest) -> ApiResponse:
        ...
        """
        payload, status_code, headers = self._create(create_passkeys_challenge_request=create_passkeys_challenge_request)
        instance = NewChallengeInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, create_passkeys_challenge_request: CreatePasskeysChallengeRequest) -> tuple:
        """
    ...
    async def create_async(self, create_passkeys_challenge_request: CreatePasskeysChallengeRequest) -> NewChallengeInstance:
        """
        Asynchronously create the NewChallengeInstance
    ...
    async def create_with_http_info_async(self, create_passkeys_challenge_request: CreatePasskeysChallengeRequest) -> ApiResponse:
        """
        Asynchronously create the NewChallengeInstance and return response metadata

        :param create_passkeys_challenge_request: 
        
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(create_passkeys_challenge_request=create_passkeys_challenge_request)
        instance = NewChallengeInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.NewChallengeList>'
