...
class BucketInstance(InstanceResource):
    ...
    def update_with_http_info(self, max: Union[int, object]=values.unset, interval: Union[int, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(max=max, interval=interval, )

    async def update_with_http_info_async(self, max: Union[int, object]=values.unset, interval: Union[int, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(max=max, interval=interval, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.BucketInstance {}>'.format(context)
...
class BucketContext(InstanceContext):
    ...
    def _update(self, max: Union[int, object]=values.unset, interval: Union[int, object]=values.unset) -> tuple:
        """
    ...
    async def _update_async(self, max: Union[int, object]=values.unset, interval: Union[int, object]=values.unset) -> tuple:
        """
    ...
    async def update_with_http_info_async(self, max: Union[int, object]=values.unset, interval: Union[int, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(max=max, interval=interval)
        instance = BucketInstance(
            self._version,
            payload,
            service_sid=self._solution['service_sid'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.BucketContext {}>'.format(context)
...
class BucketPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.BucketPage>"
...
class BucketList(ListResource):
    ...
    def list(self, 
        ...
        return [BucketInstance(self._version, item, service_sid=self._solution['service_sid'], rate_limit_sid=self._solution['rate_limit_sid']) for item in payload["buckets"]]
    ...
    def create_with_http_info(self, max: int, interval: int) -> ApiResponse:
        ...
        instance = BucketInstance(self._version, payload, service_sid=self._solution['service_sid'], rate_limit_sid=self._solution['rate_limit_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    async def create_with_http_info_async(self, max: int, interval: int) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(max=max, interval=interval)
        instance = BucketInstance(self._version, payload, service_sid=self._solution['service_sid'], rate_limit_sid=self._solution['rate_limit_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.BucketList>'
