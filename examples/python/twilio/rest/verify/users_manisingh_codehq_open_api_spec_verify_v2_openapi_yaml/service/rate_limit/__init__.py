...
from twilio.rest.verify.users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.service.rate_limit.bucket import BucketList
...
class RateLimitInstance(InstanceResource):
    ...
    def update_with_http_info(self, description: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(description=description, )

    async def update_with_http_info_async(self, description: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(description=description, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.RateLimitInstance {}>'.format(context)
...
class RateLimitContext(InstanceContext):
    ...
    async def _update_async(self, description: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def update_with_http_info_async(self, description: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(description=description)
        instance = RateLimitInstance(
            self._version,
            payload,
            service_sid=self._solution['service_sid'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.RateLimitContext {}>'.format(context)
...
class RateLimitPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.RateLimitPage>"
...
class RateLimitList(ListResource):
    ...
    def list(self, 
        ...
        return [RateLimitInstance(self._version, item, service_sid=self._solution['service_sid']) for item in payload["rate_limits"]]
    ...
    def _create(self, unique_name: str, description: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def create(self, unique_name: str, description: Union[str, object]=values.unset) -> RateLimitInstance:
        ...
        """
        payload, _, _ = self._create(unique_name=unique_name, description=description)
        return RateLimitInstance(self._version, payload, service_sid=self._solution['service_sid'])

    def create_with_http_info(self, unique_name: str, description: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(unique_name=unique_name, description=description)
        instance = RateLimitInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, unique_name: str, description: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, unique_name: str, description: Union[str, object]=values.unset) -> RateLimitInstance:
        ...
        :returns: The created RateLimitInstance
        """
        payload, _, _ = await self._create_async(unique_name=unique_name, description=description)
        return RateLimitInstance(self._version, payload, service_sid=self._solution['service_sid'])

    async def create_with_http_info_async(self, unique_name: str, description: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(unique_name=unique_name, description=description)
        instance = RateLimitInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.RateLimitList>'
