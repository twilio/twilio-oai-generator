...
class NewFactorInstance(InstanceResource):
    ...
    class CreateNewPasskeysFactorRequest(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.config: Optional[NewFactorList.CreateNewPasskeysFactorRequestConfig] = payload.get("config")
    ...
    class CreateNewPasskeysFactorRequestConfig(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.relying_party: Optional[NewFactorList.CreateNewPasskeysFactorRequestConfigRelyingParty] = payload.get("relying_party")
            self.authenticator_attachment: Optional["NewFactorInstance.str"] = payload.get("authenticator_attachment")
            self.discoverable_credentials: Optional["NewFactorInstance.str"] = payload.get("discoverable_credentials")
            self.user_verification: Optional["NewFactorInstance.str"] = payload.get("user_verification")
...
class NewFactorList(ListResource):
    ...
    def _create(self, create_new_passkeys_factor_request: CreateNewPasskeysFactorRequest) -> tuple:
        """
    ...
    def create(self, create_new_passkeys_factor_request: CreateNewPasskeysFactorRequest) -> NewFactorInstance:
        ...
        """
        payload, _, _ = self._create(create_new_passkeys_factor_request=create_new_passkeys_factor_request)
        return NewFactorInstance(self._version, payload, service_sid=self._solution['service_sid'])
    ...
    def create_with_http_info(self, create_new_passkeys_factor_request: CreateNewPasskeysFactorRequest) -> ApiResponse:
        ...
        """
        payload, status_code, headers = self._create(create_new_passkeys_factor_request=create_new_passkeys_factor_request)
        instance = NewFactorInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, create_new_passkeys_factor_request: CreateNewPasskeysFactorRequest) -> tuple:
        """
    ...
    async def create_async(self, create_new_passkeys_factor_request: CreateNewPasskeysFactorRequest) -> NewFactorInstance:
        ...
        :returns: The created NewFactorInstance
        """
        payload, _, _ = await self._create_async(create_new_passkeys_factor_request=create_new_passkeys_factor_request)
        return NewFactorInstance(self._version, payload, service_sid=self._solution['service_sid'])
    ...
    async def create_with_http_info_async(self, create_new_passkeys_factor_request: CreateNewPasskeysFactorRequest) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(create_new_passkeys_factor_request=create_new_passkeys_factor_request)
        instance = NewFactorInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
