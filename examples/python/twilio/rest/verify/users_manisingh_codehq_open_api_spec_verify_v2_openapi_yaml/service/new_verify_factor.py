...
class NewVerifyFactorInstance(InstanceResource):
    ...
    class VerifyPasskeysFactorRequest(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.authenticator_attachment: Optional["NewVerifyFactorInstance.str"] = payload.get("authenticatorAttachment")
            self.type: Optional["NewVerifyFactorInstance.str"] = payload.get("type")
            self.response: Optional[NewVerifyFactorList.VerifyPasskeysFactorRequestResponse] = payload.get("response")
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], service_sid: str):
        ...
        self.factor_type: Optional["NewVerifyFactorInstance.str"] = payload.get("factor_type")
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.NewVerifyFactorInstance {}>'.format(context)
...
class NewVerifyFactorList(ListResource):
    ...
    def __init__(self, version: Version, service_sid: str):
        ...
        self._uri = '/Services/{service_sid}/Passkeys/VerifyFactor'.format(**self._solution)
        
        
    

    def _update(self, verify_passkeys_factor_request: VerifyPasskeysFactorRequest) -> tuple:
        """
    ...
    def update(self, verify_passkeys_factor_request: VerifyPasskeysFactorRequest) -> NewVerifyFactorInstance:
        ...
        """
        payload, _, _ = self._update(verify_passkeys_factor_request=verify_passkeys_factor_request)
        return NewVerifyFactorInstance(self._version, payload, service_sid=self._solution['service_sid'])
    ...
    def update_with_http_info(self, verify_passkeys_factor_request: VerifyPasskeysFactorRequest) -> ApiResponse:
        ...
        """
        payload, status_code, headers = self._update(verify_passkeys_factor_request=verify_passkeys_factor_request)
        instance = NewVerifyFactorInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _update_async(self, verify_passkeys_factor_request: VerifyPasskeysFactorRequest) -> tuple:
        """
    ...
    async def update_async(self, verify_passkeys_factor_request: VerifyPasskeysFactorRequest) -> NewVerifyFactorInstance:
        ...
        :returns: The updated NewVerifyFactorInstance
        """
        payload, _, _ = await self._update_async(verify_passkeys_factor_request=verify_passkeys_factor_request)
        return NewVerifyFactorInstance(self._version, payload, service_sid=self._solution['service_sid'])
    ...
    async def update_with_http_info_async(self, verify_passkeys_factor_request: VerifyPasskeysFactorRequest) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(verify_passkeys_factor_request=verify_passkeys_factor_request)
        instance = NewVerifyFactorInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.NewVerifyFactorList>'
