...
class NewFactorInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], service_sid: str, identity: str):
        ...
        self.status: Optional["NewFactorInstance.FactorStatuses"] = payload.get("status")
        self.factor_type: Optional["NewFactorInstance.FactorTypes"] = payload.get("factor_type")
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.NewFactorInstance {}>'.format(context)
...
class NewFactorList(ListResource):
    ...
    def create(self, friendly_name: str, factor_type: "NewFactorInstance.FactorTypes", binding_alg: Union[str, object]=values.unset, binding_public_key: Union[str, object]=values.unset, config_app_id: Union[str, object]=values.unset, config_notification_platform: Union["NewFactorInstance.NotificationPlatforms", object]=values.unset, config_notification_token: Union[str, object]=values.unset, config_sdk_version: Union[str, object]=values.unset, binding_secret: Union[str, object]=values.unset, config_time_step: Union[int, object]=values.unset, config_skew: Union[int, object]=values.unset, config_code_length: Union[int, object]=values.unset, config_alg: Union["NewFactorInstance.TotpAlgorithms", object]=values.unset, metadata: Union[object, object]=values.unset) -> NewFactorInstance:
        """
    ...
    def create_with_http_info(self, friendly_name: str, factor_type: "NewFactorInstance.FactorTypes", binding_alg: Union[str, object]=values.unset, binding_public_key: Union[str, object]=values.unset, config_app_id: Union[str, object]=values.unset, config_notification_platform: Union["NewFactorInstance.NotificationPlatforms", object]=values.unset, config_notification_token: Union[str, object]=values.unset, config_sdk_version: Union[str, object]=values.unset, binding_secret: Union[str, object]=values.unset, config_time_step: Union[int, object]=values.unset, config_skew: Union[int, object]=values.unset, config_code_length: Union[int, object]=values.unset, config_alg: Union["NewFactorInstance.TotpAlgorithms", object]=values.unset, metadata: Union[object, object]=values.unset) -> ApiResponse:
        ...
        """
        payload, status_code, headers = self._create(friendly_name=friendly_name, factor_type=factor_type, binding_alg=binding_alg, binding_public_key=binding_public_key, config_app_id=config_app_id, config_notification_platform=config_notification_platform, config_notification_token=config_notification_token, config_sdk_version=config_sdk_version, binding_secret=binding_secret, config_time_step=config_time_step, config_skew=config_skew, config_code_length=config_code_length, config_alg=config_alg, metadata=metadata)
        instance = NewFactorInstance(self._version, payload, service_sid=self._solution['service_sid'], identity=self._solution['identity'])
    ...
    async def create_async(self, friendly_name: str, factor_type: "NewFactorInstance.FactorTypes", binding_alg: Union[str, object]=values.unset, binding_public_key: Union[str, object]=values.unset, config_app_id: Union[str, object]=values.unset, config_notification_platform: Union["NewFactorInstance.NotificationPlatforms", object]=values.unset, config_notification_token: Union[str, object]=values.unset, config_sdk_version: Union[str, object]=values.unset, binding_secret: Union[str, object]=values.unset, config_time_step: Union[int, object]=values.unset, config_skew: Union[int, object]=values.unset, config_code_length: Union[int, object]=values.unset, config_alg: Union["NewFactorInstance.TotpAlgorithms", object]=values.unset, metadata: Union[object, object]=values.unset) -> NewFactorInstance:
        ...
        :returns: The created NewFactorInstance
        """
        payload, _, _ = await self._create_async(friendly_name=friendly_name, factor_type=factor_type, binding_alg=binding_alg, binding_public_key=binding_public_key, config_app_id=config_app_id, config_notification_platform=config_notification_platform, config_notification_token=config_notification_token, config_sdk_version=config_sdk_version, binding_secret=binding_secret, config_time_step=config_time_step, config_skew=config_skew, config_code_length=config_code_length, config_alg=config_alg, metadata=metadata)
        return NewFactorInstance(self._version, payload, service_sid=self._solution['service_sid'], identity=self._solution['identity'])
    ...
    async def create_with_http_info_async(self, friendly_name: str, factor_type: "NewFactorInstance.FactorTypes", binding_alg: Union[str, object]=values.unset, binding_public_key: Union[str, object]=values.unset, config_app_id: Union[str, object]=values.unset, config_notification_platform: Union["NewFactorInstance.NotificationPlatforms", object]=values.unset, config_notification_token: Union[str, object]=values.unset, config_sdk_version: Union[str, object]=values.unset, binding_secret: Union[str, object]=values.unset, config_time_step: Union[int, object]=values.unset, config_skew: Union[int, object]=values.unset, config_code_length: Union[int, object]=values.unset, config_alg: Union["NewFactorInstance.TotpAlgorithms", object]=values.unset, metadata: Union[object, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(friendly_name=friendly_name, factor_type=factor_type, binding_alg=binding_alg, binding_public_key=binding_public_key, config_app_id=config_app_id, config_notification_platform=config_notification_platform, config_notification_token=config_notification_token, config_sdk_version=config_sdk_version, binding_secret=binding_secret, config_time_step=config_time_step, config_skew=config_skew, config_code_length=config_code_length, config_alg=config_alg, metadata=metadata)
        instance = NewFactorInstance(self._version, payload, service_sid=self._solution['service_sid'], identity=self._solution['identity'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Verify.Users_manisingh_codehq_open_api_spec_verify_v2_openapi_yaml.NewFactorList>'
