...
class BindingInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Notifications.Users_manisingh_codehq_open_api_spec_notifications_v1_openapi_yaml.BindingInstance {}>'.format(context)
...
class BindingContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Notifications.Users_manisingh_codehq_open_api_spec_notifications_v1_openapi_yaml.BindingContext {}>'.format(context)
...
class BindingPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Notifications.Users_manisingh_codehq_open_api_spec_notifications_v1_openapi_yaml.BindingPage>"
...
class BindingList(ListResource):
    ...
    def list(self, 
        ...
        return [BindingInstance(self._version, item, service_sid=self._solution['service_sid']) for item in payload["bindings"]]
    ...
    def _create(self, identity: str, binding_type: "BindingInstance.BindingType", address: str, tag: Union[List[str], object]=values.unset, notification_protocol_version: Union[str, object]=values.unset, credential_sid: Union[str, object]=values.unset, endpoint: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def create(self, identity: str, binding_type: "BindingInstance.BindingType", address: str, tag: Union[List[str], object]=values.unset, notification_protocol_version: Union[str, object]=values.unset, credential_sid: Union[str, object]=values.unset, endpoint: Union[str, object]=values.unset) -> BindingInstance:
        ...
        """
        payload, _, _ = self._create(identity=identity, binding_type=binding_type, address=address, tag=tag, notification_protocol_version=notification_protocol_version, credential_sid=credential_sid, endpoint=endpoint)
        return BindingInstance(self._version, payload, service_sid=self._solution['service_sid'])

    def create_with_http_info(self, identity: str, binding_type: "BindingInstance.BindingType", address: str, tag: Union[List[str], object]=values.unset, notification_protocol_version: Union[str, object]=values.unset, credential_sid: Union[str, object]=values.unset, endpoint: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(identity=identity, binding_type=binding_type, address=address, tag=tag, notification_protocol_version=notification_protocol_version, credential_sid=credential_sid, endpoint=endpoint)
        instance = BindingInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, identity: str, binding_type: "BindingInstance.BindingType", address: str, tag: Union[List[str], object]=values.unset, notification_protocol_version: Union[str, object]=values.unset, credential_sid: Union[str, object]=values.unset, endpoint: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, identity: str, binding_type: "BindingInstance.BindingType", address: str, tag: Union[List[str], object]=values.unset, notification_protocol_version: Union[str, object]=values.unset, credential_sid: Union[str, object]=values.unset, endpoint: Union[str, object]=values.unset) -> BindingInstance:
        ...
        :returns: The created BindingInstance
        """
        payload, _, _ = await self._create_async(identity=identity, binding_type=binding_type, address=address, tag=tag, notification_protocol_version=notification_protocol_version, credential_sid=credential_sid, endpoint=endpoint)
        return BindingInstance(self._version, payload, service_sid=self._solution['service_sid'])

    async def create_with_http_info_async(self, identity: str, binding_type: "BindingInstance.BindingType", address: str, tag: Union[List[str], object]=values.unset, notification_protocol_version: Union[str, object]=values.unset, credential_sid: Union[str, object]=values.unset, endpoint: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(identity=identity, binding_type=binding_type, address=address, tag=tag, notification_protocol_version=notification_protocol_version, credential_sid=credential_sid, endpoint=endpoint)
        instance = BindingInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Notifications.Users_manisingh_codehq_open_api_spec_notifications_v1_openapi_yaml.BindingList>'
