...
class MediaInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Ai.Users_manisingh_codehq_open_api_spec_ai_v1_openapi_yaml.MediaInstance {}>'.format(context)
...
class MediaList(ListResource):
    ...
    def __init__(self, version: Version, service_sid: str, sid: str):
        ...
        self._uri = '/Services/{service_sid}/Transcripts/{sid}/Media'.format(**self._solution)
    ...
    def fetch(self) -> MediaInstance:
        ...
        return MediaInstance(self._version, payload, service_sid=self._solution['service_sid'], sid=self._solution['sid'])
    ...
    def fetch_with_http_info(self) -> ApiResponse:
        ...
        instance = MediaInstance(self._version, payload, service_sid=self._solution['service_sid'], sid=self._solution['sid'])
    ...
    def list(self, 
        ...
        return [MediaInstance(self._version, item, service_sid=self._solution['service_sid'], sid=self._solution['sid']) for item in payload[""]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Ai.Users_manisingh_codehq_open_api_spec_ai_v1_openapi_yaml.MediaList>'
