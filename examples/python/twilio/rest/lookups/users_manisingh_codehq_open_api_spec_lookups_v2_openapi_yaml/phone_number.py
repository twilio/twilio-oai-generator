...
class PhoneNumberInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], phone_number: Optional[str] = None):
        ...
        self.validation_errors: Optional[List[Enumstr]] = payload.get("validation_errors")
        ...
        self.line_type_intelligence: Optional[str] = payload.get("line_type_intelligence")
    ...
    def fetch_with_http_info(self, fields: Union[str, object]=values.unset, country_code: Union[str, object]=values.unset, first_name: Union[str, object]=values.unset, last_name: Union[str, object]=values.unset, address_line1: Union[str, object]=values.unset, address_line2: Union[str, object]=values.unset, city: Union[str, object]=values.unset, state: Union[str, object]=values.unset, postal_code: Union[str, object]=values.unset, address_country_code: Union[str, object]=values.unset, national_id: Union[str, object]=values.unset, date_of_birth: Union[str, object]=values.unset, last_verified_date: Union[str, object]=values.unset, verification_sid: Union[str, object]=values.unset, partner_sub_id: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        """
        return self._proxy.fetch_with_http_info(fields=fields, country_code=country_code, first_name=first_name, last_name=last_name, address_line1=address_line1, address_line2=address_line2, city=city, state=state, postal_code=postal_code, address_country_code=address_country_code, national_id=national_id, date_of_birth=date_of_birth, last_verified_date=last_verified_date, verification_sid=verification_sid, partner_sub_id=partner_sub_id, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Lookups.Users_manisingh_codehq_open_api_spec_lookups_v2_openapi_yaml.PhoneNumberInstance {}>'.format(context)
...
class PhoneNumberContext(InstanceContext):
    ...
    def _fetch(self, fields: Union[str, object]=values.unset, country_code: Union[str, object]=values.unset, first_name: Union[str, object]=values.unset, last_name: Union[str, object]=values.unset, address_line1: Union[str, object]=values.unset, address_line2: Union[str, object]=values.unset, city: Union[str, object]=values.unset, state: Union[str, object]=values.unset, postal_code: Union[str, object]=values.unset, address_country_code: Union[str, object]=values.unset, national_id: Union[str, object]=values.unset, date_of_birth: Union[str, object]=values.unset, last_verified_date: Union[str, object]=values.unset, verification_sid: Union[str, object]=values.unset, partner_sub_id: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Lookups.Users_manisingh_codehq_open_api_spec_lookups_v2_openapi_yaml.PhoneNumberContext {}>'.format(context)
...
class PhoneNumberList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Lookups.Users_manisingh_codehq_open_api_spec_lookups_v2_openapi_yaml.PhoneNumberList>'
