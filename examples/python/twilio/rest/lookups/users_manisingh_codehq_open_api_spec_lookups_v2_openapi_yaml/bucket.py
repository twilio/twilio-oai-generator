...
class BucketInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], field: Optional[str] = None, bucket: Optional[str] = None):
    ...
    def _proxy(self) -> "BucketContext":
        ...
        if self._context is None:
            self._context = BucketContext(self._version, field=self._solution['field'], bucket=self._solution['bucket'],)
    ...
    def update(self, rate_limit_request: Union[RateLimitRequest, object]=values.unset) -> "BucketInstance":
        """
        ...
        """
        return self._proxy.update(rate_limit_request=rate_limit_request, )

    async def update_async(self, rate_limit_request: Union[RateLimitRequest, object]=values.unset) -> "BucketInstance":
        """
        ...
        :returns: The updated BucketInstance
        """
        return await self._proxy.update_async(rate_limit_request=rate_limit_request, )

    def update_with_http_info(self, rate_limit_request: Union[RateLimitRequest, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(rate_limit_request=rate_limit_request, )

    async def update_with_http_info_async(self, rate_limit_request: Union[RateLimitRequest, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(rate_limit_request=rate_limit_request, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Lookups.Users_manisingh_codehq_open_api_spec_lookups_v2_openapi_yaml.BucketInstance {}>'.format(context)
...
class BucketContext(InstanceContext):
    ...
    def __init__(self, version: Version, field: str, bucket: str):
        ...
        self._uri = '/RateLimits/Fields/{field}/Bucket/{bucket}'.format(**self._solution)
    ...
    def _update(self, rate_limit_request: Union[RateLimitRequest, object]=values.unset) -> tuple:
        """
    ...
    def update_with_http_info(self, rate_limit_request: Union[RateLimitRequest, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._update(rate_limit_request=rate_limit_request)
        instance = BucketInstance(
            self._version,
            payload,
            field=self._solution['field'],
    ...
    async def _update_async(self, rate_limit_request: Union[RateLimitRequest, object]=values.unset) -> tuple:
        """
    ...
    async def update_with_http_info_async(self, rate_limit_request: Union[RateLimitRequest, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(rate_limit_request=rate_limit_request)
        instance = BucketInstance(
            self._version,
            payload,
            field=self._solution['field'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Lookups.Users_manisingh_codehq_open_api_spec_lookups_v2_openapi_yaml.BucketContext {}>'.format(context)
...
class BucketList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Lookups.Users_manisingh_codehq_open_api_spec_lookups_v2_openapi_yaml.BucketList>'
