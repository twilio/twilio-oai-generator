...
class DeliveryReceiptInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], chat_service_sid: str, conversation_sid: str, message_sid: str, sid: Optional[str] = None):
        ...
        self.status: Optional["DeliveryReceiptInstance.DeliveryStatus"] = payload.get("status")
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.DeliveryReceiptInstance {}>'.format(context)
...
class DeliveryReceiptContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.DeliveryReceiptContext {}>'.format(context)
...
class DeliveryReceiptPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.DeliveryReceiptPage>"
...
class DeliveryReceiptList(ListResource):
    ...
    def list(self, 
        ...
        return [DeliveryReceiptInstance(self._version, item, chat_service_sid=self._solution['chat_service_sid'], conversation_sid=self._solution['conversation_sid'], message_sid=self._solution['message_sid']) for item in payload["delivery_receipts"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.DeliveryReceiptList>'
