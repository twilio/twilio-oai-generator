...
class WebhookList(ListResource):
    ...
    def list(self, 
        ...
        return [WebhookInstance(self._version, item, chat_service_sid=self._solution['chat_service_sid'], conversation_sid=self._solution['conversation_sid']) for item in payload["webhooks"]]
    ...
    def create_with_http_info(self, target: "WebhookInstance.Target", configuration_url: Union[str, object]=values.unset, configuration_method: Union["WebhookInstance.Method", object]=values.unset, configuration_filters: Union[List[str], object]=values.unset, configuration_triggers: Union[List[str], object]=values.unset, configuration_flow_sid: Union[str, object]=values.unset, configuration_replay_after: Union[int, object]=values.unset) -> ApiResponse:
        ...
        instance = WebhookInstance(self._version, payload, chat_service_sid=self._solution['chat_service_sid'], conversation_sid=self._solution['conversation_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
