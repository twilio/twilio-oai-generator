...
class RoleInstance(InstanceResource):
    ...
    def _proxy(self) -> "RoleContext":
        ...
        if self._context is None:
            self._context = RoleContext(self._version, chat_service_sid=self._solution['chat_service_sid'], sid=self._solution['sid'],)
    ...
    async def update_async(self, permission: List[str]) -> "RoleInstance":
        ...
        :returns: The updated RoleInstance
        """
        return await self._proxy.update_async(permission=permission, )
    ...
    def update_with_http_info(self, permission: List[str]) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(permission=permission, )
    ...
    async def update_with_http_info_async(self, permission: List[str]) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(permission=permission, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.RoleInstance {}>'.format(context)
...
class RoleContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.RoleContext {}>'.format(context)
...
class RolePage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.RolePage>"
...
class RoleList(ListResource):
    ...
    def list(self, 
        ...
        return [RoleInstance(self._version, item, chat_service_sid=self._solution['chat_service_sid']) for item in payload["roles"]]
    ...
    def _create(self, friendly_name: str, type: "RoleInstance.RoleType", permission: List[str]) -> tuple:
        """
    ...
    def create(self, friendly_name: str, type: "RoleInstance.RoleType", permission: List[str]) -> RoleInstance:
        ...
        """
        payload, _, _ = self._create(friendly_name=friendly_name, type=type, permission=permission)
        return RoleInstance(self._version, payload, chat_service_sid=self._solution['chat_service_sid'])
    ...
    def create_with_http_info(self, friendly_name: str, type: "RoleInstance.RoleType", permission: List[str]) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(friendly_name=friendly_name, type=type, permission=permission)
        instance = RoleInstance(self._version, payload, chat_service_sid=self._solution['chat_service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, friendly_name: str, type: "RoleInstance.RoleType", permission: List[str]) -> tuple:
        """
    ...
    async def create_async(self, friendly_name: str, type: "RoleInstance.RoleType", permission: List[str]) -> RoleInstance:
        ...
        :returns: The created RoleInstance
        """
        payload, _, _ = await self._create_async(friendly_name=friendly_name, type=type, permission=permission)
        return RoleInstance(self._version, payload, chat_service_sid=self._solution['chat_service_sid'])
    ...
    async def create_with_http_info_async(self, friendly_name: str, type: "RoleInstance.RoleType", permission: List[str]) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(friendly_name=friendly_name, type=type, permission=permission)
        instance = RoleInstance(self._version, payload, chat_service_sid=self._solution['chat_service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.RoleList>'
