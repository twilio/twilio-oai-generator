...
class BindingInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], chat_service_sid: str, sid: Optional[str] = None):
        ...
        self.binding_type: Optional["BindingInstance.BindingType"] = payload.get("binding_type")
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.BindingInstance {}>'.format(context)
...
class BindingContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.BindingContext {}>'.format(context)
...
class BindingPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.BindingPage>"
...
class BindingList(ListResource):
    ...
    def list(self, 
        ...
        return [BindingInstance(self._version, item, chat_service_sid=self._solution['chat_service_sid']) for item in payload["bindings"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.BindingList>'
