...
from twilio.rest.conversations.users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.conversation.export import ExportList
from twilio.rest.conversations.users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.conversation.message import MessageList
from twilio.rest.conversations.users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.conversation.participant import ParticipantList
from twilio.rest.conversations.users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.conversation.webhook import WebhookList
...
class ConversationList(ListResource):
    ...
    def list(self, 
        ...
        return [ConversationInstance(self._version, item) for item in payload["conversations"]]
    ...
    def create(self, x_twilio_webhook_enabled: Union["ConversationInstance.WebhookEnabledType", object]=values.unset, friendly_name: Union[str, object]=values.unset, unique_name: Union[str, object]=values.unset, date_created: Union[datetime, object]=values.unset, date_updated: Union[datetime, object]=values.unset, messaging_service_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, state: Union["ConversationInstance.State", object]=values.unset, timers_inactive: Union[str, object]=values.unset, timers_closed: Union[str, object]=values.unset, bindings_email_address: Union[str, object]=values.unset, bindings_email_name: Union[str, object]=values.unset) -> ConversationInstance:
        """
        ...
        """
        payload, _, _ = self._create(x_twilio_webhook_enabled=x_twilio_webhook_enabled, friendly_name=friendly_name, unique_name=unique_name, date_created=date_created, date_updated=date_updated, messaging_service_sid=messaging_service_sid, attributes=attributes, state=state, timers_inactive=timers_inactive, timers_closed=timers_closed, bindings_email_address=bindings_email_address, bindings_email_name=bindings_email_name)
        return ConversationInstance(self._version, payload)

    def create_with_http_info(self, x_twilio_webhook_enabled: Union["ConversationInstance.WebhookEnabledType", object]=values.unset, friendly_name: Union[str, object]=values.unset, unique_name: Union[str, object]=values.unset, date_created: Union[datetime, object]=values.unset, date_updated: Union[datetime, object]=values.unset, messaging_service_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, state: Union["ConversationInstance.State", object]=values.unset, timers_inactive: Union[str, object]=values.unset, timers_closed: Union[str, object]=values.unset, bindings_email_address: Union[str, object]=values.unset, bindings_email_name: Union[str, object]=values.unset) -> ApiResponse:
        """
