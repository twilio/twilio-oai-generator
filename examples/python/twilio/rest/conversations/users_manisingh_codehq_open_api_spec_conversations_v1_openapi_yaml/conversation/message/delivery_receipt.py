...
class DeliveryReceiptList(ListResource):
    ...
    def list(self, 
        ...
        return [DeliveryReceiptInstance(self._version, item, conversation_sid=self._solution['conversation_sid'], message_sid=self._solution['message_sid']) for item in payload["delivery_receipts"]]
