...
from twilio.rest.conversations.users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.conversation.message.channel_metadata import ChannelMetadataList
from twilio.rest.conversations.users_manisingh_codehq_open_api_spec_conversations_v1_openapi_yaml.conversation.message.delivery_receipt import DeliveryReceiptList
...
class MessageList(ListResource):
    ...
    def list(self, 
        ...
        return [MessageInstance(self._version, item, conversation_sid=self._solution['conversation_sid']) for item in payload["messages"]]
    ...
    def create_with_http_info(self, x_twilio_webhook_enabled: Union["MessageInstance.WebhookEnabledType", object]=values.unset, author: Union[str, object]=values.unset, body: Union[str, object]=values.unset, date_created: Union[datetime, object]=values.unset, date_updated: Union[datetime, object]=values.unset, attributes: Union[str, object]=values.unset, media_sid: Union[str, object]=values.unset, content_sid: Union[str, object]=values.unset, content_variables: Union[str, object]=values.unset, subject: Union[str, object]=values.unset) -> ApiResponse:
        ...
        instance = MessageInstance(self._version, payload, conversation_sid=self._solution['conversation_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
