...
class CommunicationInstance(InstanceResource):
    ...
    class CreateCommunicationInConversationRequestAuthor(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.channel: Optional["CommunicationInstance.ConversationsV2Channel"] = payload.get("channel")
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v2_openapi_yaml.CommunicationInstance {}>'.format(context)
...
class CommunicationContext(InstanceContext):
    ...
    def __init__(self, version: Version, conversation_id: str, id: str):
        ...
        self._uri = '/Conversations/{conversation_id}/Communications/{id}'.format(**self._solution)
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v2_openapi_yaml.CommunicationContext {}>'.format(context)
...
class CommunicationPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v2_openapi_yaml.CommunicationPage>"
...
class CommunicationList(ListResource):
    ...
    def __init__(self, version: Version, conversation_id: str):
        ...
        self._uri = '/Conversations/{conversation_id}/Communications'.format(**self._solution)
    ...
    def get(self, conversation_id: str, id: str) -> CommunicationContext:
        """
        ...
        :param id: 
        """
        return CommunicationContext(self._version, conversation_id=conversation_id, id=id)

    def __call__(self, conversation_id: str, id: str) -> CommunicationContext:
        """
        Constructs a CommunicationContext
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v2_openapi_yaml.CommunicationList>'
