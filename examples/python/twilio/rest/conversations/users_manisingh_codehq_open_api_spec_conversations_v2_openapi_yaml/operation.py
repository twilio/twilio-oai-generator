...
class OperationInstance(InstanceResource):
    ...
    def _proxy(self) -> "OperationContext":
        ...
        if self._context is None:
            self._context = OperationContext(self._version, id=self._solution['id'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v2_openapi_yaml.OperationInstance {}>'.format(context)
...
class OperationContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v2_openapi_yaml.OperationContext {}>'.format(context)
...
class OperationList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Conversations.Users_manisingh_codehq_open_api_spec_conversations_v2_openapi_yaml.OperationList>'
