...
from twilio.rest.sync.users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.service.sync_stream.stream_message import StreamMessageList
...
class SyncStreamInstance(InstanceResource):
    ...
    async def update_async(self, ttl: Union[int, object]=values.unset) -> "SyncStreamInstance":
        """
        ...
        :returns: The updated SyncStreamInstance
        """
        return await self._proxy.update_async(ttl=ttl, )

    def update_with_http_info(self, ttl: Union[int, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(ttl=ttl, )

    async def update_with_http_info_async(self, ttl: Union[int, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(ttl=ttl, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.SyncStreamInstance {}>'.format(context)
...
class SyncStreamContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.SyncStreamContext {}>'.format(context)
...
class SyncStreamPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.SyncStreamPage>"
...
class SyncStreamList(ListResource):
    ...
    def list(self, 
        ...
        return [SyncStreamInstance(self._version, item, service_sid=self._solution['service_sid']) for item in payload["streams"]]
    ...
    def page(self, 
        ...
        return SyncStreamPage(self._version, response, solution=self._solution)
    ...
    def page_with_http_info(self, 
        ...
        page = SyncStreamPage(self._version, response, solution=self._solution)
    ...
    def _create(self, unique_name: Union[str, object]=values.unset, ttl: Union[int, object]=values.unset) -> tuple:
        """
    ...
    def create(self, unique_name: Union[str, object]=values.unset, ttl: Union[int, object]=values.unset) -> SyncStreamInstance:
        """
    ...
    def create_with_http_info(self, unique_name: Union[str, object]=values.unset, ttl: Union[int, object]=values.unset) -> ApiResponse:
        """
        ...
        instance = SyncStreamInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, unique_name: Union[str, object]=values.unset, ttl: Union[int, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, unique_name: Union[str, object]=values.unset, ttl: Union[int, object]=values.unset) -> SyncStreamInstance:
        """
    ...
    async def create_with_http_info_async(self, unique_name: Union[str, object]=values.unset, ttl: Union[int, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(unique_name=unique_name, ttl=ttl)
        instance = SyncStreamInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.SyncStreamList>'
