...
class DocumentPermissionInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.DocumentPermissionInstance {}>'.format(context)
...
class DocumentPermissionContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.DocumentPermissionContext {}>'.format(context)
...
class DocumentPermissionPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.DocumentPermissionPage>"
...
class DocumentPermissionList(ListResource):
    ...
    def list(self, 
        ...
        return [DocumentPermissionInstance(self._version, item, service_sid=self._solution['service_sid'], document_sid=self._solution['document_sid']) for item in payload["permissions"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.DocumentPermissionList>'
