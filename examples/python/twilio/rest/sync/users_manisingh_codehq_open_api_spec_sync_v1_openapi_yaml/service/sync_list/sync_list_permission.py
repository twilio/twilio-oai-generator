...
class SyncListPermissionInstance(InstanceResource):
    ...
    def _proxy(self) -> "SyncListPermissionContext":
        ...
        if self._context is None:
            self._context = SyncListPermissionContext(self._version, service_sid=self._solution['service_sid'], list_sid=self._solution['list_sid'], identity=self._solution['identity'],)
    ...
    def update_with_http_info(self, read: bool, write: bool, manage: bool) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(read=read, write=write, manage=manage, )
    ...
    async def update_with_http_info_async(self, read: bool, write: bool, manage: bool) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(read=read, write=write, manage=manage, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.SyncListPermissionInstance {}>'.format(context)
...
class SyncListPermissionContext(InstanceContext):
    ...
    def fetch_with_http_info(self) -> ApiResponse:
        ...
        instance = SyncListPermissionInstance(
            self._version,
            payload,
            service_sid=self._solution['service_sid'],
            list_sid=self._solution['list_sid'],
    ...
    def update_with_http_info(self, read: bool, write: bool, manage: bool) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._update(read=read, write=write, manage=manage)
        instance = SyncListPermissionInstance(
            self._version,
            payload,
            service_sid=self._solution['service_sid'],
    ...
    async def update_with_http_info_async(self, read: bool, write: bool, manage: bool) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(read=read, write=write, manage=manage)
        instance = SyncListPermissionInstance(
            self._version,
            payload,
            service_sid=self._solution['service_sid'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.SyncListPermissionContext {}>'.format(context)
...
class SyncListPermissionPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.SyncListPermissionPage>"
...
class SyncListPermissionList(ListResource):
    ...
    def list(self, 
        ...
        return [SyncListPermissionInstance(self._version, item, service_sid=self._solution['service_sid'], list_sid=self._solution['list_sid']) for item in payload["permissions"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.SyncListPermissionList>'
