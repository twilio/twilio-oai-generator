...
class SyncMapPermissionInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.SyncMapPermissionInstance {}>'.format(context)
...
class SyncMapPermissionContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.SyncMapPermissionContext {}>'.format(context)
...
class SyncMapPermissionPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.SyncMapPermissionPage>"
...
class SyncMapPermissionList(ListResource):
    ...
    def list(self, 
        ...
        return [SyncMapPermissionInstance(self._version, item, service_sid=self._solution['service_sid'], map_sid=self._solution['map_sid']) for item in payload["permissions"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.SyncMapPermissionList>'
