...
class SyncMapItemInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.SyncMapItemInstance {}>'.format(context)
...
class SyncMapItemContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.SyncMapItemContext {}>'.format(context)
...
class SyncMapItemPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.SyncMapItemPage>"
...
class SyncMapItemList(ListResource):
    ...
    def list(self, 
        ...
        return [SyncMapItemInstance(self._version, item, service_sid=self._solution['service_sid'], map_sid=self._solution['map_sid']) for item in payload["items"]]
    ...
    def _create(self, key: str, data: object, ttl: Union[int, object]=values.unset, item_ttl: Union[int, object]=values.unset, collection_ttl: Union[int, object]=values.unset) -> tuple:
        """
    ...
    def create(self, key: str, data: object, ttl: Union[int, object]=values.unset, item_ttl: Union[int, object]=values.unset, collection_ttl: Union[int, object]=values.unset) -> SyncMapItemInstance:
        ...
        """
        payload, _, _ = self._create(key=key, data=data, ttl=ttl, item_ttl=item_ttl, collection_ttl=collection_ttl)
        return SyncMapItemInstance(self._version, payload, service_sid=self._solution['service_sid'], map_sid=self._solution['map_sid'])

    def create_with_http_info(self, key: str, data: object, ttl: Union[int, object]=values.unset, item_ttl: Union[int, object]=values.unset, collection_ttl: Union[int, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(key=key, data=data, ttl=ttl, item_ttl=item_ttl, collection_ttl=collection_ttl)
        instance = SyncMapItemInstance(self._version, payload, service_sid=self._solution['service_sid'], map_sid=self._solution['map_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, key: str, data: object, ttl: Union[int, object]=values.unset, item_ttl: Union[int, object]=values.unset, collection_ttl: Union[int, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, key: str, data: object, ttl: Union[int, object]=values.unset, item_ttl: Union[int, object]=values.unset, collection_ttl: Union[int, object]=values.unset) -> SyncMapItemInstance:
        ...
        :returns: The created SyncMapItemInstance
        """
        payload, _, _ = await self._create_async(key=key, data=data, ttl=ttl, item_ttl=item_ttl, collection_ttl=collection_ttl)
        return SyncMapItemInstance(self._version, payload, service_sid=self._solution['service_sid'], map_sid=self._solution['map_sid'])

    async def create_with_http_info_async(self, key: str, data: object, ttl: Union[int, object]=values.unset, item_ttl: Union[int, object]=values.unset, collection_ttl: Union[int, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(key=key, data=data, ttl=ttl, item_ttl=item_ttl, collection_ttl=collection_ttl)
        instance = SyncMapItemInstance(self._version, payload, service_sid=self._solution['service_sid'], map_sid=self._solution['map_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Sync.Users_manisingh_codehq_open_api_spec_sync_v1_openapi_yaml.SyncMapItemList>'
