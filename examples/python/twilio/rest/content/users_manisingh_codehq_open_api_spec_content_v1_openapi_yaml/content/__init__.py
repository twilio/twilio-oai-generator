...
from twilio.rest.content.users_manisingh_codehq_open_api_spec_content_v1_openapi_yaml.content.approval_create import ApprovalCreateList
from twilio.rest.content.users_manisingh_codehq_open_api_spec_content_v1_openapi_yaml.content.approval_fetch import ApprovalFetchList
...
class ContentInstance(InstanceResource):
    ...
    class AuthenticationAction(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.type: Optional["ContentInstance.AuthenticationActionType"] = payload.get("type")
    ...
    class CallToActionAction(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.type: Optional["ContentInstance.CallToActionActionType"] = payload.get("type")
    ...
    class CardAction(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.id: Optional[str] = payload.get("id")
            self.code: Optional[str] = payload.get("code")
            self.webview_size: Optional["ContentInstance.WebviewSizeType"] = payload.get("webview_size")
    ...
    class CarouselAction(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.type: Optional["ContentInstance.CarouselActionType"] = payload.get("type")
            self.title: Optional[str] = payload.get("title")
            self.url: Optional[str] = payload.get("url")
            self.phone: Optional[str] = payload.get("phone")
            self.id: Optional[str] = payload.get("id")
    ...
    class FlowsPage(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.layout: Optional[List[ContentList.FlowsPageComponent]] = payload.get("layout")
        ...
        def to_dict(self):
            return {
                    ...
                    "layout": [layout.to_dict() for layout in self.layout] if self.layout is not None else None,
            }
    ...
    class QuickReplyAction(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.type: Optional["ContentInstance.QuickReplyActionType"] = payload.get("type")
            self.title: Optional[str] = payload.get("title")
            self.id: Optional[str] = payload.get("id")
    ...
    class TwilioCallToAction(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.body: Optional[str] = payload.get("body")
            self.actions: Optional[List[ContentList.CallToActionAction]] = payload.get("actions")
    ...
    class TwilioCarousel(object):
        ...
        def to_dict(self):
            return {
                    ...
                    "body": self.body,
                    "cards": [cards.to_dict() for cards in self.cards] if self.cards is not None else None,
            }
    ...
    class TwilioCatalog(object):
        ...
        def to_dict(self):
            return {
                    ...
                    "subtitle": self.subtitle,
                    "id": self.id,
                    "items": [items.to_dict() for items in self.items] if self.items is not None else None,
    ...
    class TwilioFlows(object):
        ...
        def to_dict(self):
            return {
                    ...
                    "subtitle": self.subtitle,
                    "media_url": self.media_url,
                    "pages": [pages.to_dict() for pages in self.pages] if self.pages is not None else None,
                    "type": self.type,
            }
    ...
    class TwilioQuickReply(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.body: Optional[str] = payload.get("body")
            self.actions: Optional[List[ContentList.QuickReplyAction]] = payload.get("actions")
    ...
    class Types(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.twilio_text: Optional[ContentList.TwilioText] = payload.get("twilio/text")
            self.twilio_media: Optional[ContentList.TwilioMedia] = payload.get("twilio/media")
            self.twilio_location: Optional[ContentList.TwilioLocation] = payload.get("twilio/location")
            self.twilio_list_picker: Optional[ContentList.TwilioListPicker] = payload.get("twilio/list-picker")
            self.twilio_call_to_action: Optional[ContentList.TwilioCallToAction] = payload.get("twilio/call-to-action")
            self.twilio_quick_reply: Optional[ContentList.TwilioQuickReply] = payload.get("twilio/quick-reply")
            self.twilio_card: Optional[ContentList.TwilioCard] = payload.get("twilio/card")
            self.twilio_catalog: Optional[ContentList.TwilioCatalog] = payload.get("twilio/catalog")
            self.twilio_carousel: Optional[ContentList.TwilioCarousel] = payload.get("twilio/carousel")
            self.twilio_flows: Optional[ContentList.TwilioFlows] = payload.get("twilio/flows")
            self.twilio_schedule: Optional[ContentList.TwilioSchedule] = payload.get("twilio/schedule")
            self.whatsapp_card: Optional[ContentList.WhatsappCard] = payload.get("whatsapp/card")
            self.whatsapp_authentication: Optional[ContentList.WhatsappAuthentication] = payload.get("whatsapp/authentication")
            self.whatsapp_flows: Optional[ContentList.WhatsappFlows] = payload.get("whatsapp/flows")

        def to_dict(self):
            return {
                
                    "twilio/text": self.twilio_text.to_dict() if self.twilio_text is not None else None ,
                    "twilio/media": self.twilio_media.to_dict() if self.twilio_media is not None else None ,
                    "twilio/location": self.twilio_location.to_dict() if self.twilio_location is not None else None ,
                    "twilio/list-picker": self.twilio_list_picker.to_dict() if self.twilio_list_picker is not None else None ,
                    "twilio/call-to-action": self.twilio_call_to_action.to_dict() if self.twilio_call_to_action is not None else None ,
                    "twilio/quick-reply": self.twilio_quick_reply.to_dict() if self.twilio_quick_reply is not None else None ,
                    "twilio/card": self.twilio_card.to_dict() if self.twilio_card is not None else None ,
                    "twilio/catalog": self.twilio_catalog.to_dict() if self.twilio_catalog is not None else None ,
                    "twilio/carousel": self.twilio_carousel.to_dict() if self.twilio_carousel is not None else None ,
                    "twilio/flows": self.twilio_flows.to_dict() if self.twilio_flows is not None else None ,
                    "twilio/schedule": self.twilio_schedule.to_dict() if self.twilio_schedule is not None else None ,
                    "whatsapp/card": self.whatsapp_card.to_dict() if self.whatsapp_card is not None else None ,
                    "whatsapp/authentication": self.whatsapp_authentication.to_dict() if self.whatsapp_authentication is not None else None ,
                    "whatsapp/flows": self.whatsapp_flows.to_dict() if self.whatsapp_flows is not None else None ,
            }
    ...
    class WhatsappAuthentication(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.add_security_recommendation: Optional[bool] = payload.get("add_security_recommendation")
            self.code_expiration_minutes: Optional[float] = payload.get("code_expiration_minutes")
    ...
    class WhatsappFlows(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.is_flow_first_page_endpoint: Optional[bool] = payload.get("is_flow_first_page_endpoint")
    ...
    def update(self, content_update_request: ContentUpdateRequest) -> "ContentInstance":
        ...
        """
        return self._proxy.update(content_update_request=content_update_request, )
    ...
    async def update_async(self, content_update_request: ContentUpdateRequest) -> "ContentInstance":
        ...
        :returns: The updated ContentInstance
        """
        return await self._proxy.update_async(content_update_request=content_update_request, )
    ...
    def update_with_http_info(self, content_update_request: ContentUpdateRequest) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(content_update_request=content_update_request, )
    ...
    async def update_with_http_info_async(self, content_update_request: ContentUpdateRequest) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(content_update_request=content_update_request, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Content.Users_manisingh_codehq_open_api_spec_content_v1_openapi_yaml.ContentInstance {}>'.format(context)
...
class ContentContext(InstanceContext):
    ...
    def update_with_http_info(self, content_update_request: ContentUpdateRequest) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._update(content_update_request=content_update_request)
        instance = ContentInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    async def _update_async(self, content_update_request: ContentUpdateRequest) -> tuple:
        """
    ...
    async def update_async(self, content_update_request: ContentUpdateRequest) -> ContentInstance:
        ...
        :returns: The updated ContentInstance
        """
        payload, _, _ = await self._update_async(content_update_request=content_update_request)
        return ContentInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    async def update_with_http_info_async(self, content_update_request: ContentUpdateRequest) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(content_update_request=content_update_request)
        instance = ContentInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Content.Users_manisingh_codehq_open_api_spec_content_v1_openapi_yaml.ContentContext {}>'.format(context)
...
class ContentPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Content.Users_manisingh_codehq_open_api_spec_content_v1_openapi_yaml.ContentPage>"
...
class ContentList(ListResource):
    ...
    def list(self, 
        ...
        return [ContentInstance(self._version, item) for item in payload["contents"]]
    ...
    def create_with_http_info(self, content_create_request: ContentCreateRequest) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(content_create_request=content_create_request)
        instance = ContentInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, content_create_request: ContentCreateRequest) -> tuple:
        """
    ...
    async def create_async(self, content_create_request: ContentCreateRequest) -> ContentInstance:
        ...
        :returns: The created ContentInstance
        """
        payload, _, _ = await self._create_async(content_create_request=content_create_request)
        return ContentInstance(self._version, payload)
    ...
    async def create_with_http_info_async(self, content_create_request: ContentCreateRequest) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(content_create_request=content_create_request)
        instance = ContentInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Content.Users_manisingh_codehq_open_api_spec_content_v1_openapi_yaml.ContentList>'
