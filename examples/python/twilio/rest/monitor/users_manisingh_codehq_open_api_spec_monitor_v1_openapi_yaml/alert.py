...
class AlertInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], sid: Optional[str] = None):
        ...
        self.date_generated: Optional[datetime] = deserialize.iso8601_datetime(payload.get("date_generated"))
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Monitor.Users_manisingh_codehq_open_api_spec_monitor_v1_openapi_yaml.AlertInstance {}>'.format(context)
...
class AlertContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Monitor.Users_manisingh_codehq_open_api_spec_monitor_v1_openapi_yaml.AlertContext {}>'.format(context)
...
class AlertPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Monitor.Users_manisingh_codehq_open_api_spec_monitor_v1_openapi_yaml.AlertPage>"
...
class AlertList(ListResource):
    ...
    def list(self, 
        ...
        return [AlertInstance(self._version, item) for item in payload["alerts"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Monitor.Users_manisingh_codehq_open_api_spec_monitor_v1_openapi_yaml.AlertList>'
