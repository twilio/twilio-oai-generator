...
class DayInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Bulkexports.Users_manisingh_codehq_open_api_spec_bulkexports_v1_openapi_yaml.DayInstance {}>'.format(context)
...
class DayContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Bulkexports.Users_manisingh_codehq_open_api_spec_bulkexports_v1_openapi_yaml.DayContext {}>'.format(context)
...
class DayPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Bulkexports.Users_manisingh_codehq_open_api_spec_bulkexports_v1_openapi_yaml.DayPage>"
...
class DayList(ListResource):
    ...
    def list(self, 
        ...
        return [DayInstance(self._version, item, resource_type=self._solution['resource_type']) for item in payload["days"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Bulkexports.Users_manisingh_codehq_open_api_spec_bulkexports_v1_openapi_yaml.DayList>'
