...
class JobInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Bulkexports.Users_manisingh_codehq_open_api_spec_bulkexports_v1_openapi_yaml.JobInstance {}>'.format(context)
...
class JobContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Bulkexports.Users_manisingh_codehq_open_api_spec_bulkexports_v1_openapi_yaml.JobContext {}>'.format(context)
...
class JobList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Bulkexports.Users_manisingh_codehq_open_api_spec_bulkexports_v1_openapi_yaml.JobList>'
