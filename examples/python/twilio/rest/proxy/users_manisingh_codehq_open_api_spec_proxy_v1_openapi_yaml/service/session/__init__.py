...
from twilio.rest.proxy.users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.service.session.interaction import InteractionList
from twilio.rest.proxy.users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.service.session.participant import ParticipantList
...
class SessionInstance(InstanceResource):
    ...
    def update_with_http_info(self, date_expiry: Union[datetime, object]=values.unset, ttl: Union[int, object]=values.unset, status: Union["SessionInstance.Status", object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(date_expiry=date_expiry, ttl=ttl, status=status, )

    async def update_with_http_info_async(self, date_expiry: Union[datetime, object]=values.unset, ttl: Union[int, object]=values.unset, status: Union["SessionInstance.Status", object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(date_expiry=date_expiry, ttl=ttl, status=status, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Proxy.Users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.SessionInstance {}>'.format(context)
...
class SessionContext(InstanceContext):
    ...
    def _update(self, date_expiry: Union[datetime, object]=values.unset, ttl: Union[int, object]=values.unset, status: Union["SessionInstance.Status", object]=values.unset) -> tuple:
        """
    ...
    def update_with_http_info(self, date_expiry: Union[datetime, object]=values.unset, ttl: Union[int, object]=values.unset, status: Union["SessionInstance.Status", object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._update(date_expiry=date_expiry, ttl=ttl, status=status)
        instance = SessionInstance(
            self._version,
            payload,
            service_sid=self._solution['service_sid'],
    ...
    async def _update_async(self, date_expiry: Union[datetime, object]=values.unset, ttl: Union[int, object]=values.unset, status: Union["SessionInstance.Status", object]=values.unset) -> tuple:
        """
    ...
    async def update_async(self, date_expiry: Union[datetime, object]=values.unset, ttl: Union[int, object]=values.unset, status: Union["SessionInstance.Status", object]=values.unset) -> SessionInstance:
        ...
        :returns: The updated SessionInstance
        """
        payload, _, _ = await self._update_async(date_expiry=date_expiry, ttl=ttl, status=status)
        return SessionInstance(
            self._version,
            payload,
            service_sid=self._solution['service_sid'],
    ...
    async def update_with_http_info_async(self, date_expiry: Union[datetime, object]=values.unset, ttl: Union[int, object]=values.unset, status: Union["SessionInstance.Status", object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(date_expiry=date_expiry, ttl=ttl, status=status)
        instance = SessionInstance(
            self._version,
            payload,
            service_sid=self._solution['service_sid'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Proxy.Users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.SessionContext {}>'.format(context)
...
class SessionPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Proxy.Users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.SessionPage>"
...
class SessionList(ListResource):
    ...
    def list(self, 
        ...
        return [SessionInstance(self._version, item, service_sid=self._solution['service_sid']) for item in payload["sessions"]]
    ...
    def _create(self, unique_name: Union[str, object]=values.unset, date_expiry: Union[datetime, object]=values.unset, ttl: Union[int, object]=values.unset, mode: Union["SessionInstance.Mode", object]=values.unset, status: Union["SessionInstance.Status", object]=values.unset, participants: Union[List[object], object]=values.unset) -> tuple:
        """
    ...
    def create(self, unique_name: Union[str, object]=values.unset, date_expiry: Union[datetime, object]=values.unset, ttl: Union[int, object]=values.unset, mode: Union["SessionInstance.Mode", object]=values.unset, status: Union["SessionInstance.Status", object]=values.unset, participants: Union[List[object], object]=values.unset) -> SessionInstance:
        ...
        """
        payload, _, _ = self._create(unique_name=unique_name, date_expiry=date_expiry, ttl=ttl, mode=mode, status=status, participants=participants)
        return SessionInstance(self._version, payload, service_sid=self._solution['service_sid'])

    def create_with_http_info(self, unique_name: Union[str, object]=values.unset, date_expiry: Union[datetime, object]=values.unset, ttl: Union[int, object]=values.unset, mode: Union["SessionInstance.Mode", object]=values.unset, status: Union["SessionInstance.Status", object]=values.unset, participants: Union[List[object], object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(unique_name=unique_name, date_expiry=date_expiry, ttl=ttl, mode=mode, status=status, participants=participants)
        instance = SessionInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    async def create_async(self, unique_name: Union[str, object]=values.unset, date_expiry: Union[datetime, object]=values.unset, ttl: Union[int, object]=values.unset, mode: Union["SessionInstance.Mode", object]=values.unset, status: Union["SessionInstance.Status", object]=values.unset, participants: Union[List[object], object]=values.unset) -> SessionInstance:
        ...
        :returns: The created SessionInstance
        """
        payload, _, _ = await self._create_async(unique_name=unique_name, date_expiry=date_expiry, ttl=ttl, mode=mode, status=status, participants=participants)
        return SessionInstance(self._version, payload, service_sid=self._solution['service_sid'])
    ...
    async def create_with_http_info_async(self, unique_name: Union[str, object]=values.unset, date_expiry: Union[datetime, object]=values.unset, ttl: Union[int, object]=values.unset, mode: Union["SessionInstance.Mode", object]=values.unset, status: Union["SessionInstance.Status", object]=values.unset, participants: Union[List[object], object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(unique_name=unique_name, date_expiry=date_expiry, ttl=ttl, mode=mode, status=status, participants=participants)
        instance = SessionInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Proxy.Users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.SessionList>'
