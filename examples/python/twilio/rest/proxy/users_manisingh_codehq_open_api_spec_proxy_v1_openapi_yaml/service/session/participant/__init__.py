...
from twilio.rest.proxy.users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.service.session.participant.message_interaction import MessageInteractionList
...
class ParticipantInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Proxy.Users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.ParticipantInstance {}>'.format(context)
...
class ParticipantContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Proxy.Users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.ParticipantContext {}>'.format(context)
...
class ParticipantPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Proxy.Users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.ParticipantPage>"
...
class ParticipantList(ListResource):
    ...
    def list(self, 
        ...
        return [ParticipantInstance(self._version, item, service_sid=self._solution['service_sid'], session_sid=self._solution['session_sid']) for item in payload["participants"]]
    ...
    def _create(self, identifier: str, friendly_name: Union[str, object]=values.unset, proxy_identifier: Union[str, object]=values.unset, proxy_identifier_sid: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def create(self, identifier: str, friendly_name: Union[str, object]=values.unset, proxy_identifier: Union[str, object]=values.unset, proxy_identifier_sid: Union[str, object]=values.unset) -> ParticipantInstance:
        ...
        """
        payload, _, _ = self._create(identifier=identifier, friendly_name=friendly_name, proxy_identifier=proxy_identifier, proxy_identifier_sid=proxy_identifier_sid)
        return ParticipantInstance(self._version, payload, service_sid=self._solution['service_sid'], session_sid=self._solution['session_sid'])

    def create_with_http_info(self, identifier: str, friendly_name: Union[str, object]=values.unset, proxy_identifier: Union[str, object]=values.unset, proxy_identifier_sid: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(identifier=identifier, friendly_name=friendly_name, proxy_identifier=proxy_identifier, proxy_identifier_sid=proxy_identifier_sid)
        instance = ParticipantInstance(self._version, payload, service_sid=self._solution['service_sid'], session_sid=self._solution['session_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, identifier: str, friendly_name: Union[str, object]=values.unset, proxy_identifier: Union[str, object]=values.unset, proxy_identifier_sid: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, identifier: str, friendly_name: Union[str, object]=values.unset, proxy_identifier: Union[str, object]=values.unset, proxy_identifier_sid: Union[str, object]=values.unset) -> ParticipantInstance:
        ...
        :returns: The created ParticipantInstance
        """
        payload, _, _ = await self._create_async(identifier=identifier, friendly_name=friendly_name, proxy_identifier=proxy_identifier, proxy_identifier_sid=proxy_identifier_sid)
        return ParticipantInstance(self._version, payload, service_sid=self._solution['service_sid'], session_sid=self._solution['session_sid'])

    async def create_with_http_info_async(self, identifier: str, friendly_name: Union[str, object]=values.unset, proxy_identifier: Union[str, object]=values.unset, proxy_identifier_sid: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(identifier=identifier, friendly_name=friendly_name, proxy_identifier=proxy_identifier, proxy_identifier_sid=proxy_identifier_sid)
        instance = ParticipantInstance(self._version, payload, service_sid=self._solution['service_sid'], session_sid=self._solution['session_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Proxy.Users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.ParticipantList>'
