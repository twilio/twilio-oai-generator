...
class InteractionInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Proxy.Users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.InteractionInstance {}>'.format(context)
...
class InteractionContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Proxy.Users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.InteractionContext {}>'.format(context)
...
class InteractionPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Proxy.Users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.InteractionPage>"
...
class InteractionList(ListResource):
    ...
    def list(self, 
        ...
        return [InteractionInstance(self._version, item, service_sid=self._solution['service_sid'], session_sid=self._solution['session_sid']) for item in payload["interactions"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Proxy.Users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.InteractionList>'
