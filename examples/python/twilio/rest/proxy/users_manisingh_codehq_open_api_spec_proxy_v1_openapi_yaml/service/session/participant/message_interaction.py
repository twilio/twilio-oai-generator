...
class MessageInteractionInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Proxy.Users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.MessageInteractionInstance {}>'.format(context)
...
class MessageInteractionContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Proxy.Users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.MessageInteractionContext {}>'.format(context)
...
class MessageInteractionPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Proxy.Users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.MessageInteractionPage>"
...
class MessageInteractionList(ListResource):
    ...
    def list(self, 
        ...
        return [MessageInteractionInstance(self._version, item, service_sid=self._solution['service_sid'], session_sid=self._solution['session_sid'], participant_sid=self._solution['participant_sid']) for item in payload["interactions"]]
    ...
    def _create(self, body: Union[str, object]=values.unset, media_url: Union[List[str], object]=values.unset) -> tuple:
        """
    ...
    def create_with_http_info(self, body: Union[str, object]=values.unset, media_url: Union[List[str], object]=values.unset) -> ApiResponse:
        """
        ...
        instance = MessageInteractionInstance(self._version, payload, service_sid=self._solution['service_sid'], session_sid=self._solution['session_sid'], participant_sid=self._solution['participant_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, body: Union[str, object]=values.unset, media_url: Union[List[str], object]=values.unset) -> tuple:
        """
    ...
    async def create_with_http_info_async(self, body: Union[str, object]=values.unset, media_url: Union[List[str], object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(body=body, media_url=media_url)
        instance = MessageInteractionInstance(self._version, payload, service_sid=self._solution['service_sid'], session_sid=self._solution['session_sid'], participant_sid=self._solution['participant_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Proxy.Users_manisingh_codehq_open_api_spec_proxy_v1_openapi_yaml.MessageInteractionList>'
