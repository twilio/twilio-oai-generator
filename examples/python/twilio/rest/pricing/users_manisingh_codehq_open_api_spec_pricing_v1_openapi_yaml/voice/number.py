...
class NumberInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Pricing.Users_manisingh_codehq_open_api_spec_pricing_v1_openapi_yaml.NumberInstance {}>'.format(context)
...
class NumberContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Pricing.Users_manisingh_codehq_open_api_spec_pricing_v1_openapi_yaml.NumberContext {}>'.format(context)
...
class NumberList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Pricing.Users_manisingh_codehq_open_api_spec_pricing_v1_openapi_yaml.NumberList>'
