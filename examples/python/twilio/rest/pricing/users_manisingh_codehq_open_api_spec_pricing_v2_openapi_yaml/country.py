...
class CountryInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], iso_country: Optional[str] = None):
        ...
        self.originating_call_prices: Optional[List[str]] = payload.get("originating_call_prices")
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Pricing.Users_manisingh_codehq_open_api_spec_pricing_v2_openapi_yaml.CountryInstance {}>'.format(context)
...
class CountryContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Pricing.Users_manisingh_codehq_open_api_spec_pricing_v2_openapi_yaml.CountryContext {}>'.format(context)
...
class CountryPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Pricing.Users_manisingh_codehq_open_api_spec_pricing_v2_openapi_yaml.CountryPage>"
...
class CountryList(ListResource):
    ...
    def list(self, 
        ...
        return [CountryInstance(self._version, item) for item in payload["countries"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Pricing.Users_manisingh_codehq_open_api_spec_pricing_v2_openapi_yaml.CountryList>'
