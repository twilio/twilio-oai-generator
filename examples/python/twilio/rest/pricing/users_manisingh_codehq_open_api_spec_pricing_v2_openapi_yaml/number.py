...
class NumberInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], destination_number: Optional[str] = None):
        ...
        self.terminating_prefix_prices: Optional[List[str]] = payload.get("terminating_prefix_prices")
        self.originating_call_price: Optional[str] = payload.get("originating_call_price")
    ...
    def _proxy(self) -> "NumberContext":
        ...
        if self._context is None:
            self._context = NumberContext(self._version, destination_number=self._solution['destination_number'],)
        return self._context
    
    
    def fetch(self, origination_number: Union[str, object]=values.unset) -> "NumberInstance":
        """
    ...
    async def fetch_async(self, origination_number: Union[str, object]=values.unset) -> "NumberInstance":
        """
        ...
        :returns: The fetched NumberInstance
        """
        return await self._proxy.fetch_async(origination_number=origination_number, )

    def fetch_with_http_info(self, origination_number: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        """
        return self._proxy.fetch_with_http_info(origination_number=origination_number, )

    async def fetch_with_http_info_async(self, origination_number: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.fetch_with_http_info_async(origination_number=origination_number, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Pricing.Users_manisingh_codehq_open_api_spec_pricing_v2_openapi_yaml.NumberInstance {}>'.format(context)
...
class NumberContext(InstanceContext):
    ...
    def fetch_with_http_info(self, origination_number: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._fetch(origination_number=origination_number)
    ...
    async def _fetch_async(self, origination_number: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def fetch_with_http_info_async(self, origination_number: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._fetch_async(origination_number=origination_number)
        instance = NumberInstance(
            self._version,
            payload,
            destination_number=self._solution['destination_number'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Pricing.Users_manisingh_codehq_open_api_spec_pricing_v2_openapi_yaml.NumberContext {}>'.format(context)
...
class NumberList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Pricing.Users_manisingh_codehq_open_api_spec_pricing_v2_openapi_yaml.NumberList>'
