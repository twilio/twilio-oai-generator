...
class EventTypeInstance(InstanceResource):
    ...
    def fetch(self, x_twilio_catalog_waiver: Union[str, object]=values.unset) -> "EventTypeInstance":
        """
        ...
        """
        return self._proxy.fetch(x_twilio_catalog_waiver=x_twilio_catalog_waiver, )

    async def fetch_async(self, x_twilio_catalog_waiver: Union[str, object]=values.unset) -> "EventTypeInstance":
        """
        ...
        :returns: The fetched EventTypeInstance
        """
        return await self._proxy.fetch_async(x_twilio_catalog_waiver=x_twilio_catalog_waiver, )

    def fetch_with_http_info(self, x_twilio_catalog_waiver: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        """
        return self._proxy.fetch_with_http_info(x_twilio_catalog_waiver=x_twilio_catalog_waiver, )

    async def fetch_with_http_info_async(self, x_twilio_catalog_waiver: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.fetch_with_http_info_async(x_twilio_catalog_waiver=x_twilio_catalog_waiver, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Events.Users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.EventTypeInstance {}>'.format(context)
...
class EventTypeContext(InstanceContext):
    ...
    def _fetch(self, x_twilio_catalog_waiver: Union[str, object]=values.unset) -> tuple:
        """
        ...
        if not (x_twilio_catalog_waiver is values.unset or (isinstance(x_twilio_catalog_waiver, str) and not x_twilio_catalog_waiver)):
    ...
    def fetch_with_http_info(self, x_twilio_catalog_waiver: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._fetch(x_twilio_catalog_waiver=x_twilio_catalog_waiver)
    ...
    async def _fetch_async(self, x_twilio_catalog_waiver: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def fetch_async(self, x_twilio_catalog_waiver: Union[str, object]=values.unset) -> EventTypeInstance:
        ...
        :returns: The fetched EventTypeInstance
        """
        payload, _, _ = await self._fetch_async(x_twilio_catalog_waiver=x_twilio_catalog_waiver)
        return EventTypeInstance(
            self._version,
            payload,
            type=self._solution['type'],
    ...
    async def fetch_with_http_info_async(self, x_twilio_catalog_waiver: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._fetch_async(x_twilio_catalog_waiver=x_twilio_catalog_waiver)
        instance = EventTypeInstance(
            self._version,
            payload,
            type=self._solution['type'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Events.Users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.EventTypeContext {}>'.format(context)
...
class EventTypePage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Events.Users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.EventTypePage>"
...
class EventTypeList(ListResource):
    ...
    def list(self, 
        ...
        return [EventTypeInstance(self._version, item) for item in payload["types"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Events.Users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.EventTypeList>'
