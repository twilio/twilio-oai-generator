...
from twilio.rest.events.users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.sink.sink_test import SinkTestList
from twilio.rest.events.users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.sink.sink_validate import SinkValidateList
...
class SinkInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], sid: Optional[str] = None):
        ...
        self.sink_configuration: Optional[Dict[str, object]] = payload.get("sink_configuration")
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Events.Users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.SinkInstance {}>'.format(context)
...
class SinkContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Events.Users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.SinkContext {}>'.format(context)
...
class SinkPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Events.Users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.SinkPage>"
...
class SinkList(ListResource):
    ...
    def list(self, 
        ...
        return [SinkInstance(self._version, item) for item in payload["sinks"]]
    ...
    def _create(self, description: str, sink_configuration: object, sink_type: "SinkInstance.SinkType") -> tuple:
        """
    ...
    def create(self, description: str, sink_configuration: object, sink_type: "SinkInstance.SinkType") -> SinkInstance:
        ...
        """
        payload, _, _ = self._create(description=description, sink_configuration=sink_configuration, sink_type=sink_type)
        return SinkInstance(self._version, payload)
    ...
    def create_with_http_info(self, description: str, sink_configuration: object, sink_type: "SinkInstance.SinkType") -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(description=description, sink_configuration=sink_configuration, sink_type=sink_type)
        instance = SinkInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, description: str, sink_configuration: object, sink_type: "SinkInstance.SinkType") -> tuple:
        """
    ...
    async def create_async(self, description: str, sink_configuration: object, sink_type: "SinkInstance.SinkType") -> SinkInstance:
        ...
        :returns: The created SinkInstance
        """
        payload, _, _ = await self._create_async(description=description, sink_configuration=sink_configuration, sink_type=sink_type)
        return SinkInstance(self._version, payload)
    ...
    async def create_with_http_info_async(self, description: str, sink_configuration: object, sink_type: "SinkInstance.SinkType") -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(description=description, sink_configuration=sink_configuration, sink_type=sink_type)
        instance = SinkInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Events.Users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.SinkList>'
