...
class SchemaVersionInstance(InstanceResource):
    ...
    async def fetch_async(self, x_twilio_catalog_waiver: Union[str, object]=values.unset) -> "SchemaVersionInstance":
        """
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Events.Users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.SchemaVersionInstance {}>'.format(context)
...
class SchemaVersionContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Events.Users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.SchemaVersionContext {}>'.format(context)
...
class SchemaVersionPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Events.Users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.SchemaVersionPage>"
...
class SchemaVersionList(ListResource):
    ...
    def list(self, 
        ...
        return [SchemaVersionInstance(self._version, item, id=self._solution['id']) for item in payload["schema_versions"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Events.Users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.SchemaVersionList>'
