...
from twilio.rest.events.users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.schema.schema_version import SchemaVersionList
...
class SchemaInstance(InstanceResource):
    ...
    def fetch(self, x_twilio_catalog_waiver: Union[str, object]=values.unset) -> "SchemaInstance":
        """
    ...
    async def fetch_async(self, x_twilio_catalog_waiver: Union[str, object]=values.unset) -> "SchemaInstance":
        """
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Events.Users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.SchemaInstance {}>'.format(context)
...
class SchemaContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Events.Users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.SchemaContext {}>'.format(context)
...
class SchemaList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Events.Users_manisingh_codehq_open_api_spec_events_v1_openapi_yaml.SchemaList>'
