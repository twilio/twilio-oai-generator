...
class PluginVersionsInstance(InstanceResource):
    ...
    def _proxy(self) -> "PluginVersionsContext":
        ...
        if self._context is None:
            self._context = PluginVersionsContext(self._version, plugin_sid=self._solution['plugin_sid'], sid=self._solution['sid'],)
        return self._context
    
    
    def fetch(self, flex_metadata: Union[str, object]=values.unset) -> "PluginVersionsInstance":
        """
    ...
    async def fetch_async(self, flex_metadata: Union[str, object]=values.unset) -> "PluginVersionsInstance":
        """
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.PluginVersionsInstance {}>'.format(context)
...
class PluginVersionsContext(InstanceContext):
    ...
    def __init__(self, version: Version, plugin_sid: str, sid: str):
        ...
        self._uri = '/PluginService/Plugins/{plugin_sid}/Versions/{sid}'.format(**self._solution)
    ...
    def fetch_with_http_info(self, flex_metadata: Union[str, object]=values.unset) -> ApiResponse:
        ...
        instance = PluginVersionsInstance(
            self._version,
            payload,
            plugin_sid=self._solution['plugin_sid'],
            sid=self._solution['sid'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.PluginVersionsContext {}>'.format(context)
...
class PluginVersionsPage(Page):
    ...
    def get_instance(self, payload: Dict[str, Any]) -> PluginVersionsInstance:
        ...
        return PluginVersionsInstance(self._version, payload, plugin_sid=self._solution["plugin_sid"])
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.PluginVersionsPage>"
...
class PluginVersionsList(ListResource):
    ...
    def __init__(self, version: Version, plugin_sid: str):
        ...
        # Path Solution
        self._solution = { 'plugin_sid': plugin_sid,  }
        self._uri = '/PluginService/Plugins/{plugin_sid}/Versions'.format(**self._solution)
    ...
    def list(self, 
        ...
        return [PluginVersionsInstance(self._version, item, plugin_sid=self._solution['plugin_sid']) for item in payload["plugin_versions"]]
    ...
    def _create(self, resource_version: str, plugin_url: str, flex_metadata: Union[str, object]=values.unset, changelog: Union[str, object]=values.unset, private: Union[bool, object]=values.unset, cli_version: Union[str, object]=values.unset, validate_status: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def create(self, resource_version: str, plugin_url: str, flex_metadata: Union[str, object]=values.unset, changelog: Union[str, object]=values.unset, private: Union[bool, object]=values.unset, cli_version: Union[str, object]=values.unset, validate_status: Union[str, object]=values.unset) -> PluginVersionsInstance:
        """
        ...
        """
        payload, _, _ = self._create(resource_version=resource_version, plugin_url=plugin_url, flex_metadata=flex_metadata, changelog=changelog, private=private, cli_version=cli_version, validate_status=validate_status)
        return PluginVersionsInstance(self._version, payload, plugin_sid=self._solution['plugin_sid'])

    def create_with_http_info(self, resource_version: str, plugin_url: str, flex_metadata: Union[str, object]=values.unset, changelog: Union[str, object]=values.unset, private: Union[bool, object]=values.unset, cli_version: Union[str, object]=values.unset, validate_status: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(resource_version=resource_version, plugin_url=plugin_url, flex_metadata=flex_metadata, changelog=changelog, private=private, cli_version=cli_version, validate_status=validate_status)
        instance = PluginVersionsInstance(self._version, payload, plugin_sid=self._solution['plugin_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, resource_version: str, plugin_url: str, flex_metadata: Union[str, object]=values.unset, changelog: Union[str, object]=values.unset, private: Union[bool, object]=values.unset, cli_version: Union[str, object]=values.unset, validate_status: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, resource_version: str, plugin_url: str, flex_metadata: Union[str, object]=values.unset, changelog: Union[str, object]=values.unset, private: Union[bool, object]=values.unset, cli_version: Union[str, object]=values.unset, validate_status: Union[str, object]=values.unset) -> PluginVersionsInstance:
        """
        ...
        :returns: The created PluginVersionsInstance
        """
        payload, _, _ = await self._create_async(resource_version=resource_version, plugin_url=plugin_url, flex_metadata=flex_metadata, changelog=changelog, private=private, cli_version=cli_version, validate_status=validate_status)
        return PluginVersionsInstance(self._version, payload, plugin_sid=self._solution['plugin_sid'])
    ...
    async def create_with_http_info_async(self, resource_version: str, plugin_url: str, flex_metadata: Union[str, object]=values.unset, changelog: Union[str, object]=values.unset, private: Union[bool, object]=values.unset, cli_version: Union[str, object]=values.unset, validate_status: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(resource_version=resource_version, plugin_url=plugin_url, flex_metadata=flex_metadata, changelog=changelog, private=private, cli_version=cli_version, validate_status=validate_status)
        instance = PluginVersionsInstance(self._version, payload, plugin_sid=self._solution['plugin_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def get(self, sid: str) -> PluginVersionsContext:
        ...
        :param sid: The SID of the Flex Plugin Version resource to fetch.
        """
        return PluginVersionsContext(self._version, plugin_sid=self._solution['plugin_sid'], sid=sid)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.PluginVersionsList>'
