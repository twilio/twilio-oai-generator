...
class InsightsAssessmentsCommentInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.InsightsAssessmentsCommentInstance>'
...
class InsightsAssessmentsCommentPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.InsightsAssessmentsCommentPage>"
...
class InsightsAssessmentsCommentList(ListResource):
    ...
    def _create(self, category_id: str, category_name: str, comment: str, segment_id: str, agent_id: str, offset: float, authorization: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def create(self, category_id: str, category_name: str, comment: str, segment_id: str, agent_id: str, offset: float, authorization: Union[str, object]=values.unset) -> InsightsAssessmentsCommentInstance:
        ...
        """
        payload, _, _ = self._create(category_id=category_id, category_name=category_name, comment=comment, segment_id=segment_id, agent_id=agent_id, offset=offset, authorization=authorization)
        return InsightsAssessmentsCommentInstance(self._version, payload)

    def create_with_http_info(self, category_id: str, category_name: str, comment: str, segment_id: str, agent_id: str, offset: float, authorization: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        """
        payload, status_code, headers = self._create(category_id=category_id, category_name=category_name, comment=comment, segment_id=segment_id, agent_id=agent_id, offset=offset, authorization=authorization)
        instance = InsightsAssessmentsCommentInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, category_id: str, category_name: str, comment: str, segment_id: str, agent_id: str, offset: float, authorization: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, category_id: str, category_name: str, comment: str, segment_id: str, agent_id: str, offset: float, authorization: Union[str, object]=values.unset) -> InsightsAssessmentsCommentInstance:
        ...
        :returns: The created InsightsAssessmentsCommentInstance
        """
        payload, _, _ = await self._create_async(category_id=category_id, category_name=category_name, comment=comment, segment_id=segment_id, agent_id=agent_id, offset=offset, authorization=authorization)
        return InsightsAssessmentsCommentInstance(self._version, payload)

    async def create_with_http_info_async(self, category_id: str, category_name: str, comment: str, segment_id: str, agent_id: str, offset: float, authorization: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(category_id=category_id, category_name=category_name, comment=comment, segment_id=segment_id, agent_id=agent_id, offset=offset, authorization=authorization)
        instance = InsightsAssessmentsCommentInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def list(self, 
        ...
        return [InsightsAssessmentsCommentInstance(self._version, item) for item in payload["comments"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.InsightsAssessmentsCommentList>'
