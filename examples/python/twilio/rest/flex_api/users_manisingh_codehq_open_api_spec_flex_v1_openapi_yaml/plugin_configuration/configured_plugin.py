...
class ConfiguredPluginInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.ConfiguredPluginInstance {}>'.format(context)
...
class ConfiguredPluginContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.ConfiguredPluginContext {}>'.format(context)
...
class ConfiguredPluginPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.ConfiguredPluginPage>"
...
class ConfiguredPluginList(ListResource):
    ...
    def list(self, 
        ...
        return [ConfiguredPluginInstance(self._version, item, configuration_sid=self._solution['configuration_sid']) for item in payload["plugins"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.ConfiguredPluginList>'
