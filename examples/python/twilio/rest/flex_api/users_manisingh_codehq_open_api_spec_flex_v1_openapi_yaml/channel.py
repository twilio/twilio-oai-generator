...
class ChannelInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.ChannelInstance {}>'.format(context)
...
class ChannelContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.ChannelContext {}>'.format(context)
...
class ChannelPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.ChannelPage>"
...
class ChannelList(ListResource):
    ...
    def list(self, 
        ...
        return [ChannelInstance(self._version, item) for item in payload["flex_chat_channels"]]
    ...
    def _create(self, flex_flow_sid: str, identity: str, chat_user_friendly_name: str, chat_friendly_name: str, target: Union[str, object]=values.unset, chat_unique_name: Union[str, object]=values.unset, pre_engagement_data: Union[str, object]=values.unset, task_sid: Union[str, object]=values.unset, task_attributes: Union[str, object]=values.unset, long_lived: Union[bool, object]=values.unset) -> tuple:
        """
    ...
    def create(self, flex_flow_sid: str, identity: str, chat_user_friendly_name: str, chat_friendly_name: str, target: Union[str, object]=values.unset, chat_unique_name: Union[str, object]=values.unset, pre_engagement_data: Union[str, object]=values.unset, task_sid: Union[str, object]=values.unset, task_attributes: Union[str, object]=values.unset, long_lived: Union[bool, object]=values.unset) -> ChannelInstance:
        ...
        """
        payload, _, _ = self._create(flex_flow_sid=flex_flow_sid, identity=identity, chat_user_friendly_name=chat_user_friendly_name, chat_friendly_name=chat_friendly_name, target=target, chat_unique_name=chat_unique_name, pre_engagement_data=pre_engagement_data, task_sid=task_sid, task_attributes=task_attributes, long_lived=long_lived)
        return ChannelInstance(self._version, payload)

    def create_with_http_info(self, flex_flow_sid: str, identity: str, chat_user_friendly_name: str, chat_friendly_name: str, target: Union[str, object]=values.unset, chat_unique_name: Union[str, object]=values.unset, pre_engagement_data: Union[str, object]=values.unset, task_sid: Union[str, object]=values.unset, task_attributes: Union[str, object]=values.unset, long_lived: Union[bool, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(flex_flow_sid=flex_flow_sid, identity=identity, chat_user_friendly_name=chat_user_friendly_name, chat_friendly_name=chat_friendly_name, target=target, chat_unique_name=chat_unique_name, pre_engagement_data=pre_engagement_data, task_sid=task_sid, task_attributes=task_attributes, long_lived=long_lived)
    ...
    async def create_async(self, flex_flow_sid: str, identity: str, chat_user_friendly_name: str, chat_friendly_name: str, target: Union[str, object]=values.unset, chat_unique_name: Union[str, object]=values.unset, pre_engagement_data: Union[str, object]=values.unset, task_sid: Union[str, object]=values.unset, task_attributes: Union[str, object]=values.unset, long_lived: Union[bool, object]=values.unset) -> ChannelInstance:
        ...
        :returns: The created ChannelInstance
        """
        payload, _, _ = await self._create_async(flex_flow_sid=flex_flow_sid, identity=identity, chat_user_friendly_name=chat_user_friendly_name, chat_friendly_name=chat_friendly_name, target=target, chat_unique_name=chat_unique_name, pre_engagement_data=pre_engagement_data, task_sid=task_sid, task_attributes=task_attributes, long_lived=long_lived)
        return ChannelInstance(self._version, payload)
    ...
    async def create_with_http_info_async(self, flex_flow_sid: str, identity: str, chat_user_friendly_name: str, chat_friendly_name: str, target: Union[str, object]=values.unset, chat_unique_name: Union[str, object]=values.unset, pre_engagement_data: Union[str, object]=values.unset, task_sid: Union[str, object]=values.unset, task_attributes: Union[str, object]=values.unset, long_lived: Union[bool, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(flex_flow_sid=flex_flow_sid, identity=identity, chat_user_friendly_name=chat_user_friendly_name, chat_friendly_name=chat_friendly_name, target=target, chat_unique_name=chat_unique_name, pre_engagement_data=pre_engagement_data, task_sid=task_sid, task_attributes=task_attributes, long_lived=long_lived)
        instance = ChannelInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.ChannelList>'
