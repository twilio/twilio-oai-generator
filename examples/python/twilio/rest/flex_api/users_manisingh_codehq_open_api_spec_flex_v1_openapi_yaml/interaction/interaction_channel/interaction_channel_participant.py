...
class InteractionChannelParticipantInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.InteractionChannelParticipantInstance {}>'.format(context)
...
class InteractionChannelParticipantContext(InstanceContext):
    ...
    async def _update_async(self, status: "InteractionChannelParticipantInstance.Status") -> tuple:
        """
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.InteractionChannelParticipantContext {}>'.format(context)
...
class InteractionChannelParticipantPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.InteractionChannelParticipantPage>"
...
class InteractionChannelParticipantList(ListResource):
    ...
    def list(self, 
        ...
        return [InteractionChannelParticipantInstance(self._version, item, interaction_sid=self._solution['interaction_sid'], channel_sid=self._solution['channel_sid']) for item in payload["participants"]]
    ...
    def _create(self, type: "InteractionChannelParticipantInstance.Type", media_properties: object, routing_properties: Union[object, object]=values.unset) -> tuple:
        """
    ...
    def create(self, type: "InteractionChannelParticipantInstance.Type", media_properties: object, routing_properties: Union[object, object]=values.unset) -> InteractionChannelParticipantInstance:
        ...
        """
        payload, _, _ = self._create(type=type, media_properties=media_properties, routing_properties=routing_properties)
        return InteractionChannelParticipantInstance(self._version, payload, interaction_sid=self._solution['interaction_sid'], channel_sid=self._solution['channel_sid'])

    def create_with_http_info(self, type: "InteractionChannelParticipantInstance.Type", media_properties: object, routing_properties: Union[object, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(type=type, media_properties=media_properties, routing_properties=routing_properties)
        instance = InteractionChannelParticipantInstance(self._version, payload, interaction_sid=self._solution['interaction_sid'], channel_sid=self._solution['channel_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, type: "InteractionChannelParticipantInstance.Type", media_properties: object, routing_properties: Union[object, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, type: "InteractionChannelParticipantInstance.Type", media_properties: object, routing_properties: Union[object, object]=values.unset) -> InteractionChannelParticipantInstance:
        ...
        :returns: The created InteractionChannelParticipantInstance
        """
        payload, _, _ = await self._create_async(type=type, media_properties=media_properties, routing_properties=routing_properties)
        return InteractionChannelParticipantInstance(self._version, payload, interaction_sid=self._solution['interaction_sid'], channel_sid=self._solution['channel_sid'])

    async def create_with_http_info_async(self, type: "InteractionChannelParticipantInstance.Type", media_properties: object, routing_properties: Union[object, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(type=type, media_properties=media_properties, routing_properties=routing_properties)
        instance = InteractionChannelParticipantInstance(self._version, payload, interaction_sid=self._solution['interaction_sid'], channel_sid=self._solution['channel_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.InteractionChannelParticipantList>'
