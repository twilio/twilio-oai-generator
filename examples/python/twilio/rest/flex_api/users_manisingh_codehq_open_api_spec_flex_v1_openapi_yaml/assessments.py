...
class AssessmentsInstance(InstanceResource):
    ...
    def update_with_http_info(self, offset: float, answer_text: str, answer_id: str, authorization: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        """
        return self._proxy.update_with_http_info(offset=offset, answer_text=answer_text, answer_id=answer_id, authorization=authorization, )

    async def update_with_http_info_async(self, offset: float, answer_text: str, answer_id: str, authorization: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(offset=offset, answer_text=answer_text, answer_id=answer_id, authorization=authorization, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.AssessmentsInstance {}>'.format(context)
...
class AssessmentsContext(InstanceContext):
    ...
    def _update(self, offset: float, answer_text: str, answer_id: str, authorization: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def update(self, offset: float, answer_text: str, answer_id: str, authorization: Union[str, object]=values.unset) -> AssessmentsInstance:
        ...
        :returns: The updated AssessmentsInstance
        """
        payload, _, _ = self._update(offset=offset, answer_text=answer_text, answer_id=answer_id, authorization=authorization)
    ...
    def update_with_http_info(self, offset: float, answer_text: str, answer_id: str, authorization: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._update(offset=offset, answer_text=answer_text, answer_id=answer_id, authorization=authorization)
    ...
    async def _update_async(self, offset: float, answer_text: str, answer_id: str, authorization: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def update_async(self, offset: float, answer_text: str, answer_id: str, authorization: Union[str, object]=values.unset) -> AssessmentsInstance:
        ...
        :returns: The updated AssessmentsInstance
        """
        payload, _, _ = await self._update_async(offset=offset, answer_text=answer_text, answer_id=answer_id, authorization=authorization)
        return AssessmentsInstance(
            self._version,
            payload,
            assessment_sid=self._solution['assessment_sid']
    ...
    async def update_with_http_info_async(self, offset: float, answer_text: str, answer_id: str, authorization: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(offset=offset, answer_text=answer_text, answer_id=answer_id, authorization=authorization)
        instance = AssessmentsInstance(
            self._version,
            payload,
            assessment_sid=self._solution['assessment_sid']
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.AssessmentsContext {}>'.format(context)
...
class AssessmentsPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.AssessmentsPage>"
...
class AssessmentsList(ListResource):
    ...
    def list(self, 
        ...
        return [AssessmentsInstance(self._version, item) for item in payload["assessments"]]
    ...
    def _create(self, category_sid: str, category_name: str, segment_id: str, agent_id: str, offset: float, metric_id: str, metric_name: str, answer_text: str, answer_id: str, questionnaire_sid: str, authorization: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def create(self, category_sid: str, category_name: str, segment_id: str, agent_id: str, offset: float, metric_id: str, metric_name: str, answer_text: str, answer_id: str, questionnaire_sid: str, authorization: Union[str, object]=values.unset) -> AssessmentsInstance:
        ...
        """
        payload, _, _ = self._create(category_sid=category_sid, category_name=category_name, segment_id=segment_id, agent_id=agent_id, offset=offset, metric_id=metric_id, metric_name=metric_name, answer_text=answer_text, answer_id=answer_id, questionnaire_sid=questionnaire_sid, authorization=authorization)
        return AssessmentsInstance(self._version, payload)

    def create_with_http_info(self, category_sid: str, category_name: str, segment_id: str, agent_id: str, offset: float, metric_id: str, metric_name: str, answer_text: str, answer_id: str, questionnaire_sid: str, authorization: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(category_sid=category_sid, category_name=category_name, segment_id=segment_id, agent_id=agent_id, offset=offset, metric_id=metric_id, metric_name=metric_name, answer_text=answer_text, answer_id=answer_id, questionnaire_sid=questionnaire_sid, authorization=authorization)
        instance = AssessmentsInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, category_sid: str, category_name: str, segment_id: str, agent_id: str, offset: float, metric_id: str, metric_name: str, answer_text: str, answer_id: str, questionnaire_sid: str, authorization: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, category_sid: str, category_name: str, segment_id: str, agent_id: str, offset: float, metric_id: str, metric_name: str, answer_text: str, answer_id: str, questionnaire_sid: str, authorization: Union[str, object]=values.unset) -> AssessmentsInstance:
        ...
        :returns: The created AssessmentsInstance
        """
        payload, _, _ = await self._create_async(category_sid=category_sid, category_name=category_name, segment_id=segment_id, agent_id=agent_id, offset=offset, metric_id=metric_id, metric_name=metric_name, answer_text=answer_text, answer_id=answer_id, questionnaire_sid=questionnaire_sid, authorization=authorization)
        return AssessmentsInstance(self._version, payload)

    async def create_with_http_info_async(self, category_sid: str, category_name: str, segment_id: str, agent_id: str, offset: float, metric_id: str, metric_name: str, answer_text: str, answer_id: str, questionnaire_sid: str, authorization: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(category_sid=category_sid, category_name=category_name, segment_id=segment_id, agent_id=agent_id, offset=offset, metric_id=metric_id, metric_name=metric_name, answer_text=answer_text, answer_id=answer_id, questionnaire_sid=questionnaire_sid, authorization=authorization)
        instance = AssessmentsInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.AssessmentsList>'
