...
class WebChannelInstance(InstanceResource):
    ...
    def update_with_http_info(self, chat_status: Union["WebChannelInstance.ChatStatus", object]=values.unset, post_engagement_data: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(chat_status=chat_status, post_engagement_data=post_engagement_data, )

    async def update_with_http_info_async(self, chat_status: Union["WebChannelInstance.ChatStatus", object]=values.unset, post_engagement_data: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(chat_status=chat_status, post_engagement_data=post_engagement_data, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.WebChannelInstance {}>'.format(context)
...
class WebChannelContext(InstanceContext):
    ...
    def _update(self, chat_status: Union["WebChannelInstance.ChatStatus", object]=values.unset, post_engagement_data: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def update(self, chat_status: Union["WebChannelInstance.ChatStatus", object]=values.unset, post_engagement_data: Union[str, object]=values.unset) -> WebChannelInstance:
        ...
        :returns: The updated WebChannelInstance
        """
        payload, _, _ = self._update(chat_status=chat_status, post_engagement_data=post_engagement_data)
        return WebChannelInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    def update_with_http_info(self, chat_status: Union["WebChannelInstance.ChatStatus", object]=values.unset, post_engagement_data: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._update(chat_status=chat_status, post_engagement_data=post_engagement_data)
        instance = WebChannelInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    async def _update_async(self, chat_status: Union["WebChannelInstance.ChatStatus", object]=values.unset, post_engagement_data: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def update_async(self, chat_status: Union["WebChannelInstance.ChatStatus", object]=values.unset, post_engagement_data: Union[str, object]=values.unset) -> WebChannelInstance:
        ...
        :returns: The updated WebChannelInstance
        """
        payload, _, _ = await self._update_async(chat_status=chat_status, post_engagement_data=post_engagement_data)
        return WebChannelInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    async def update_with_http_info_async(self, chat_status: Union["WebChannelInstance.ChatStatus", object]=values.unset, post_engagement_data: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(chat_status=chat_status, post_engagement_data=post_engagement_data)
        instance = WebChannelInstance(
            self._version,
            payload,
            sid=self._solution['sid']
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.WebChannelContext {}>'.format(context)
...
class WebChannelPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.WebChannelPage>"
...
class WebChannelList(ListResource):
    ...
    def list(self, 
        ...
        return [WebChannelInstance(self._version, item) for item in payload["flex_chat_channels"]]
    ...
    def _create(self, flex_flow_sid: str, identity: str, customer_friendly_name: str, chat_friendly_name: str, chat_unique_name: Union[str, object]=values.unset, pre_engagement_data: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def create(self, flex_flow_sid: str, identity: str, customer_friendly_name: str, chat_friendly_name: str, chat_unique_name: Union[str, object]=values.unset, pre_engagement_data: Union[str, object]=values.unset) -> WebChannelInstance:
        ...
        """
        payload, _, _ = self._create(flex_flow_sid=flex_flow_sid, identity=identity, customer_friendly_name=customer_friendly_name, chat_friendly_name=chat_friendly_name, chat_unique_name=chat_unique_name, pre_engagement_data=pre_engagement_data)
        return WebChannelInstance(self._version, payload)

    def create_with_http_info(self, flex_flow_sid: str, identity: str, customer_friendly_name: str, chat_friendly_name: str, chat_unique_name: Union[str, object]=values.unset, pre_engagement_data: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(flex_flow_sid=flex_flow_sid, identity=identity, customer_friendly_name=customer_friendly_name, chat_friendly_name=chat_friendly_name, chat_unique_name=chat_unique_name, pre_engagement_data=pre_engagement_data)
        instance = WebChannelInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, flex_flow_sid: str, identity: str, customer_friendly_name: str, chat_friendly_name: str, chat_unique_name: Union[str, object]=values.unset, pre_engagement_data: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, flex_flow_sid: str, identity: str, customer_friendly_name: str, chat_friendly_name: str, chat_unique_name: Union[str, object]=values.unset, pre_engagement_data: Union[str, object]=values.unset) -> WebChannelInstance:
        ...
        :returns: The created WebChannelInstance
        """
        payload, _, _ = await self._create_async(flex_flow_sid=flex_flow_sid, identity=identity, customer_friendly_name=customer_friendly_name, chat_friendly_name=chat_friendly_name, chat_unique_name=chat_unique_name, pre_engagement_data=pre_engagement_data)
        return WebChannelInstance(self._version, payload)

    async def create_with_http_info_async(self, flex_flow_sid: str, identity: str, customer_friendly_name: str, chat_friendly_name: str, chat_unique_name: Union[str, object]=values.unset, pre_engagement_data: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(flex_flow_sid=flex_flow_sid, identity=identity, customer_friendly_name=customer_friendly_name, chat_friendly_name=chat_friendly_name, chat_unique_name=chat_unique_name, pre_engagement_data=pre_engagement_data)
        instance = WebChannelInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.WebChannelList>'
