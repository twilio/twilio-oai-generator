...
class PluginReleaseInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.PluginReleaseInstance {}>'.format(context)
...
class PluginReleaseContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.PluginReleaseContext {}>'.format(context)
...
class PluginReleasePage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.PluginReleasePage>"
...
class PluginReleaseList(ListResource):
    ...
    def list(self, 
        ...
        return [PluginReleaseInstance(self._version, item) for item in payload["releases"]]
    ...
    def _create(self, configuration_id: str, flex_metadata: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def create(self, configuration_id: str, flex_metadata: Union[str, object]=values.unset) -> PluginReleaseInstance:
        ...
        """
        payload, _, _ = self._create(configuration_id=configuration_id, flex_metadata=flex_metadata)
        return PluginReleaseInstance(self._version, payload)

    def create_with_http_info(self, configuration_id: str, flex_metadata: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(configuration_id=configuration_id, flex_metadata=flex_metadata)
        instance = PluginReleaseInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, configuration_id: str, flex_metadata: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, configuration_id: str, flex_metadata: Union[str, object]=values.unset) -> PluginReleaseInstance:
        ...
        :returns: The created PluginReleaseInstance
        """
        payload, _, _ = await self._create_async(configuration_id=configuration_id, flex_metadata=flex_metadata)
        return PluginReleaseInstance(self._version, payload)

    async def create_with_http_info_async(self, configuration_id: str, flex_metadata: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(configuration_id=configuration_id, flex_metadata=flex_metadata)
        instance = PluginReleaseInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.FlexApi.Users_manisingh_codehq_open_api_spec_flex_v1_openapi_yaml.PluginReleaseList>'
