...
class TemplateInstance(InstanceResource):
    ...
    """
    :ivar templates: List of available messaging templates
    """
    ...
    def __init__(self, version: Version, payload:Dict[str, Any]):
        ...
        self.templates: Optional[List[str]] = payload.get("templates")
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Trial.Users_manisingh_codehq_open_api_spec_trial_v1_openapi_yaml.TemplateInstance>'
...
class TemplateList(ListResource):
    ...
    def list(self, 
        ...
        return [TemplateInstance(self._version, item) for item in payload[""]]
    ...
    def list_with_http_info(self, 
        ...
        :param str product: Optional product type to filter templates
        :param limit: Upper limit for the number of records to return. list() guarantees
                      never to return more than limit.  Default is no limit
        :param page_size: Number of records to fetch per request, when not set will use
                          the default value of 50 records.  If no page_size is defined
    ...
    def page(self, 
      product: Union[str, object] = values.unset,
        ...
        :param product: Optional product type to filter templates
        :param page_token: PageToken provided by the API
        :param page_number: Page Number, this value is simply for client state
        :param page_size: Number of records to return, defaults to 50
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Trial.Users_manisingh_codehq_open_api_spec_trial_v1_openapi_yaml.TemplateList>'
