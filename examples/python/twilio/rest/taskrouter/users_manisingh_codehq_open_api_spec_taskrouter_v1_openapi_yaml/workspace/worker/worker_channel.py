...
class WorkerChannelInstance(InstanceResource):
    ...
    def update_with_http_info(self, capacity: Union[int, object]=values.unset, available: Union[bool, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(capacity=capacity, available=available, )

    async def update_with_http_info_async(self, capacity: Union[int, object]=values.unset, available: Union[bool, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(capacity=capacity, available=available, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Taskrouter.Users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.WorkerChannelInstance {}>'.format(context)
...
class WorkerChannelContext(InstanceContext):
    ...
    def _update(self, capacity: Union[int, object]=values.unset, available: Union[bool, object]=values.unset) -> tuple:
        """
    ...
    def update_with_http_info(self, capacity: Union[int, object]=values.unset, available: Union[bool, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._update(capacity=capacity, available=available)
        instance = WorkerChannelInstance(
            self._version,
            payload,
            workspace_sid=self._solution['workspace_sid'],
    ...
    async def _update_async(self, capacity: Union[int, object]=values.unset, available: Union[bool, object]=values.unset) -> tuple:
        """
    ...
    async def update_with_http_info_async(self, capacity: Union[int, object]=values.unset, available: Union[bool, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(capacity=capacity, available=available)
        instance = WorkerChannelInstance(
            self._version,
            payload,
            workspace_sid=self._solution['workspace_sid'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Taskrouter.Users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.WorkerChannelContext {}>'.format(context)
...
class WorkerChannelPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Taskrouter.Users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.WorkerChannelPage>"
...
class WorkerChannelList(ListResource):
    ...
    def list(self, 
        ...
        return [WorkerChannelInstance(self._version, item, workspace_sid=self._solution['workspace_sid'], worker_sid=self._solution['worker_sid']) for item in payload["channels"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Taskrouter.Users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.WorkerChannelList>'
