...
from twilio.rest.taskrouter.users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.workspace.worker.reservation import ReservationList
from twilio.rest.taskrouter.users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.workspace.worker.worker_channel import WorkerChannelList
from twilio.rest.taskrouter.users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.workspace.worker.worker_statistics import WorkerStatisticsList
from twilio.rest.taskrouter.users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.workspace.worker.workers_cumulative_statistics import WorkersCumulativeStatisticsList
from twilio.rest.taskrouter.users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.workspace.worker.workers_real_time_statistics import WorkersRealTimeStatisticsList
from twilio.rest.taskrouter.users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.workspace.worker.workers_statistics import WorkersStatisticsList
...
class WorkerInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], workspace_sid: str, sid: Optional[str] = None):
        ...
        self.date_status_changed: Optional[datetime] = deserialize.iso8601_datetime(payload.get("date_status_changed"))
        ...
        self.consumed_concurrency: Optional[int] = deserialize.integer(payload.get("consumed_concurrency"))
        self.consumed_attention: Optional[int] = deserialize.integer(payload.get("consumed_attention"))
        self.configured_concurrency: Optional[int] = deserialize.integer(payload.get("configured_concurrency"))
    ...
    def update(self, if_match: Union[str, object]=values.unset, activity_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, friendly_name: Union[str, object]=values.unset, reject_pending_reservations: Union[bool, object]=values.unset, operating_unit_sid: Union[str, object]=values.unset, concurrency: Union[int, object]=values.unset) -> "WorkerInstance":
        """
        ...
        """
        return self._proxy.update(if_match=if_match, activity_sid=activity_sid, attributes=attributes, friendly_name=friendly_name, reject_pending_reservations=reject_pending_reservations, operating_unit_sid=operating_unit_sid, concurrency=concurrency, )

    async def update_async(self, if_match: Union[str, object]=values.unset, activity_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, friendly_name: Union[str, object]=values.unset, reject_pending_reservations: Union[bool, object]=values.unset, operating_unit_sid: Union[str, object]=values.unset, concurrency: Union[int, object]=values.unset) -> "WorkerInstance":
        """
        ...
        :returns: The updated WorkerInstance
        """
        return await self._proxy.update_async(if_match=if_match, activity_sid=activity_sid, attributes=attributes, friendly_name=friendly_name, reject_pending_reservations=reject_pending_reservations, operating_unit_sid=operating_unit_sid, concurrency=concurrency, )

    def update_with_http_info(self, if_match: Union[str, object]=values.unset, activity_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, friendly_name: Union[str, object]=values.unset, reject_pending_reservations: Union[bool, object]=values.unset, operating_unit_sid: Union[str, object]=values.unset, concurrency: Union[int, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(if_match=if_match, activity_sid=activity_sid, attributes=attributes, friendly_name=friendly_name, reject_pending_reservations=reject_pending_reservations, operating_unit_sid=operating_unit_sid, concurrency=concurrency, )

    async def update_with_http_info_async(self, if_match: Union[str, object]=values.unset, activity_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, friendly_name: Union[str, object]=values.unset, reject_pending_reservations: Union[bool, object]=values.unset, operating_unit_sid: Union[str, object]=values.unset, concurrency: Union[int, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(if_match=if_match, activity_sid=activity_sid, attributes=attributes, friendly_name=friendly_name, reject_pending_reservations=reject_pending_reservations, operating_unit_sid=operating_unit_sid, concurrency=concurrency, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Taskrouter.Users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.WorkerInstance {}>'.format(context)
...
class WorkerContext(InstanceContext):
    ...
    def _update(self, if_match: Union[str, object]=values.unset, activity_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, friendly_name: Union[str, object]=values.unset, reject_pending_reservations: Union[bool, object]=values.unset, operating_unit_sid: Union[str, object]=values.unset, concurrency: Union[int, object]=values.unset) -> tuple:
        """
    ...
    def update(self, if_match: Union[str, object]=values.unset, activity_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, friendly_name: Union[str, object]=values.unset, reject_pending_reservations: Union[bool, object]=values.unset, operating_unit_sid: Union[str, object]=values.unset, concurrency: Union[int, object]=values.unset) -> WorkerInstance:
        ...
        :returns: The updated WorkerInstance
        """
        payload, _, _ = self._update(if_match=if_match, activity_sid=activity_sid, attributes=attributes, friendly_name=friendly_name, reject_pending_reservations=reject_pending_reservations, operating_unit_sid=operating_unit_sid, concurrency=concurrency)
        return WorkerInstance(
            self._version,
            payload,
            workspace_sid=self._solution['workspace_sid'],
    ...
    def update_with_http_info(self, if_match: Union[str, object]=values.unset, activity_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, friendly_name: Union[str, object]=values.unset, reject_pending_reservations: Union[bool, object]=values.unset, operating_unit_sid: Union[str, object]=values.unset, concurrency: Union[int, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._update(if_match=if_match, activity_sid=activity_sid, attributes=attributes, friendly_name=friendly_name, reject_pending_reservations=reject_pending_reservations, operating_unit_sid=operating_unit_sid, concurrency=concurrency)
        instance = WorkerInstance(
            self._version,
            payload,
            workspace_sid=self._solution['workspace_sid'],
    ...
    async def _update_async(self, if_match: Union[str, object]=values.unset, activity_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, friendly_name: Union[str, object]=values.unset, reject_pending_reservations: Union[bool, object]=values.unset, operating_unit_sid: Union[str, object]=values.unset, concurrency: Union[int, object]=values.unset) -> tuple:
        """
    ...
    async def update_async(self, if_match: Union[str, object]=values.unset, activity_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, friendly_name: Union[str, object]=values.unset, reject_pending_reservations: Union[bool, object]=values.unset, operating_unit_sid: Union[str, object]=values.unset, concurrency: Union[int, object]=values.unset) -> WorkerInstance:
        ...
        :returns: The updated WorkerInstance
        """
        payload, _, _ = await self._update_async(if_match=if_match, activity_sid=activity_sid, attributes=attributes, friendly_name=friendly_name, reject_pending_reservations=reject_pending_reservations, operating_unit_sid=operating_unit_sid, concurrency=concurrency)
        return WorkerInstance(
            self._version,
            payload,
            workspace_sid=self._solution['workspace_sid'],
    ...
    async def update_with_http_info_async(self, if_match: Union[str, object]=values.unset, activity_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, friendly_name: Union[str, object]=values.unset, reject_pending_reservations: Union[bool, object]=values.unset, operating_unit_sid: Union[str, object]=values.unset, concurrency: Union[int, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(if_match=if_match, activity_sid=activity_sid, attributes=attributes, friendly_name=friendly_name, reject_pending_reservations=reject_pending_reservations, operating_unit_sid=operating_unit_sid, concurrency=concurrency)
        instance = WorkerInstance(
            self._version,
            payload,
            workspace_sid=self._solution['workspace_sid'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Taskrouter.Users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.WorkerContext {}>'.format(context)
...
class WorkerPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Taskrouter.Users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.WorkerPage>"
...
class WorkerList(ListResource):
    ...
    def list(self, 
        ...
        return [WorkerInstance(self._version, item, workspace_sid=self._solution['workspace_sid']) for item in payload["workers"]]
    ...
    def _create(self, friendly_name: str, activity_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, operating_unit_sid: Union[str, object]=values.unset, concurrency: Union[int, object]=values.unset) -> tuple:
        """
    ...
    def create(self, friendly_name: str, activity_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, operating_unit_sid: Union[str, object]=values.unset, concurrency: Union[int, object]=values.unset) -> WorkerInstance:
        """
        ...
        """
        payload, _, _ = self._create(friendly_name=friendly_name, activity_sid=activity_sid, attributes=attributes, operating_unit_sid=operating_unit_sid, concurrency=concurrency)
        return WorkerInstance(self._version, payload, workspace_sid=self._solution['workspace_sid'])

    def create_with_http_info(self, friendly_name: str, activity_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, operating_unit_sid: Union[str, object]=values.unset, concurrency: Union[int, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(friendly_name=friendly_name, activity_sid=activity_sid, attributes=attributes, operating_unit_sid=operating_unit_sid, concurrency=concurrency)
        instance = WorkerInstance(self._version, payload, workspace_sid=self._solution['workspace_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, friendly_name: str, activity_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, operating_unit_sid: Union[str, object]=values.unset, concurrency: Union[int, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, friendly_name: str, activity_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, operating_unit_sid: Union[str, object]=values.unset, concurrency: Union[int, object]=values.unset) -> WorkerInstance:
        """
        ...
        :returns: The created WorkerInstance
        """
        payload, _, _ = await self._create_async(friendly_name=friendly_name, activity_sid=activity_sid, attributes=attributes, operating_unit_sid=operating_unit_sid, concurrency=concurrency)
        return WorkerInstance(self._version, payload, workspace_sid=self._solution['workspace_sid'])

    async def create_with_http_info_async(self, friendly_name: str, activity_sid: Union[str, object]=values.unset, attributes: Union[str, object]=values.unset, operating_unit_sid: Union[str, object]=values.unset, concurrency: Union[int, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(friendly_name=friendly_name, activity_sid=activity_sid, attributes=attributes, operating_unit_sid=operating_unit_sid, concurrency=concurrency)
        instance = WorkerInstance(self._version, payload, workspace_sid=self._solution['workspace_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Taskrouter.Users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.WorkerList>'
