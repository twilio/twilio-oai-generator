...
class ActivityInstance(InstanceResource):
    ...
    def update(self, friendly_name: Union[str, object]=values.unset) -> "ActivityInstance":
        """
    ...
    async def update_async(self, friendly_name: Union[str, object]=values.unset) -> "ActivityInstance":
        """
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Taskrouter.Users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.ActivityInstance {}>'.format(context)
...
class ActivityContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Taskrouter.Users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.ActivityContext {}>'.format(context)
...
class ActivityPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Taskrouter.Users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.ActivityPage>"
...
class ActivityList(ListResource):
    ...
    def list(self, 
        ...
        return [ActivityInstance(self._version, item, workspace_sid=self._solution['workspace_sid']) for item in payload["activities"]]
    ...
    def _create(self, friendly_name: str, available: Union[bool, object]=values.unset) -> tuple:
        """
    ...
    def create(self, friendly_name: str, available: Union[bool, object]=values.unset) -> ActivityInstance:
        """
    ...
    def create_with_http_info(self, friendly_name: str, available: Union[bool, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(friendly_name=friendly_name, available=available)
        instance = ActivityInstance(self._version, payload, workspace_sid=self._solution['workspace_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, friendly_name: str, available: Union[bool, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, friendly_name: str, available: Union[bool, object]=values.unset) -> ActivityInstance:
        """
        ...
        :returns: The created ActivityInstance
        """
        payload, _, _ = await self._create_async(friendly_name=friendly_name, available=available)
        return ActivityInstance(self._version, payload, workspace_sid=self._solution['workspace_sid'])

    async def create_with_http_info_async(self, friendly_name: str, available: Union[bool, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(friendly_name=friendly_name, available=available)
        instance = ActivityInstance(self._version, payload, workspace_sid=self._solution['workspace_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Taskrouter.Users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.ActivityList>'
