...
class TaskQueueBulkRealTimeStatisticsInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Taskrouter.Users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.TaskQueueBulkRealTimeStatisticsInstance {}>'.format(context)
...
class TaskQueueBulkRealTimeStatisticsList(ListResource):
    ...
    def create_with_http_info(self, body: Union[object, object]=values.unset) -> ApiResponse:
        ...
        instance = TaskQueueBulkRealTimeStatisticsInstance(self._version, payload, workspace_sid=self._solution['workspace_sid'])
    ...
    def list(self, 
    ) -> List[TaskQueueBulkRealTimeStatisticsInstance]:
        """
        Lists TaskQueueBulkRealTimeStatisticsInstance records from the API as a list.
        ...
        return [TaskQueueBulkRealTimeStatisticsInstance(self._version, item, workspace_sid=self._solution['workspace_sid']) for item in payload[""]]
        

    async def list_async(self, 
    ) -> List[TaskQueueBulkRealTimeStatisticsInstance]:
        """
        Asynchronously lists TaskQueueBulkRealTimeStatisticsInstance records from the API as a list.
    ...
    def list_with_http_info(self, 
        ...
        """
        Lists TaskQueueBulkRealTimeStatisticsInstance and returns headers from first page
    ...
    async def list_with_http_info_async(self, 
        ...
        """
        Asynchronously lists TaskQueueBulkRealTimeStatisticsInstance and returns headers from first page
    ...
    def page(self, 
    ...
    ) -> TaskQueueBulkRealTimeStatisticsPage:
        """
        Retrieve a single page of TaskQueueBulkRealTimeStatisticsInstance records from the API.
        ...
        :returns: Page of TaskQueueBulkRealTimeStatisticsInstance
        """
        data = values.of({ 
        ...
        return TaskQueueBulkRealTimeStatisticsPage(self._version, response, solution=self._solution)
    ...
    async def page_async(self, 
        ...
        """
        Asynchronously retrieve a single page of TaskQueueBulkRealTimeStatisticsInstance records from the API.
        Request is executed immediately
    ...
    def page_with_http_info(self, 
        ...
        :returns: ApiResponse with TaskQueueBulkRealTimeStatisticsPage, status code, and headers
        """
        data = values.of({ 
            'PageToken': page_token,
            'Page': page_number,
        ...
        page = TaskQueueBulkRealTimeStatisticsPage(self._version, response, solution=self._solution)
    ...
    def get_page(self, target_url: str) -> TaskQueueBulkRealTimeStatisticsPage:
        """
        Retrieve a specific page of TaskQueueBulkRealTimeStatisticsInstance records from the API.
        Request is executed immediately
    ...
    async def get_page_async(self, target_url: str) -> TaskQueueBulkRealTimeStatisticsPage:
        """
        Asynchronously retrieve a specific page of TaskQueueBulkRealTimeStatisticsInstance records from the API.
        Request is executed immediately
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Taskrouter.Users_manisingh_codehq_open_api_spec_taskrouter_v1_openapi_yaml.TaskQueueBulkRealTimeStatisticsList>'
