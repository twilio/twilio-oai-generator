...
class BulkHostedNumberOrderInstance(InstanceResource):
    ...
    def fetch_with_http_info(self, order_status: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        """
        return self._proxy.fetch_with_http_info(order_status=order_status, )

    async def fetch_with_http_info_async(self, order_status: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.fetch_with_http_info_async(order_status=order_status, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.BulkHostedNumberOrderInstance {}>'.format(context)
...
class BulkHostedNumberOrderContext(InstanceContext):
    ...
    async def _fetch_async(self, order_status: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def fetch_with_http_info_async(self, order_status: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._fetch_async(order_status=order_status)
        instance = BulkHostedNumberOrderInstance(
            self._version,
            payload,
            bulk_hosting_sid=self._solution['bulk_hosting_sid'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.BulkHostedNumberOrderContext {}>'.format(context)
...
class BulkHostedNumberOrderList(ListResource):
    ...
    def list(self, 
    ) -> List[BulkHostedNumberOrderInstance]:
        """
        Lists BulkHostedNumberOrderInstance records from the API as a list.
        ...
        return [BulkHostedNumberOrderInstance(self._version, item) for item in payload[""]]
        

    async def list_async(self, 
    ) -> List[BulkHostedNumberOrderInstance]:
        """
        Asynchronously lists BulkHostedNumberOrderInstance records from the API as a list.
    ...
    def list_with_http_info(self, 
        ...
        """
        Lists BulkHostedNumberOrderInstance and returns headers from first page
    ...
    async def list_with_http_info_async(self, 
        ...
        """
        Asynchronously lists BulkHostedNumberOrderInstance and returns headers from first page
    ...
    def page(self, 
    ...
    ) -> BulkHostedNumberOrderPage:
        """
        Retrieve a single page of BulkHostedNumberOrderInstance records from the API.
        ...
        :returns: Page of BulkHostedNumberOrderInstance
        """
        data = values.of({ 
        ...
        return BulkHostedNumberOrderPage(self._version, response)
    ...
    async def page_async(self, 
        ...
        """
        Asynchronously retrieve a single page of BulkHostedNumberOrderInstance records from the API.
        Request is executed immediately
    ...
    def page_with_http_info(self, 
        ...
        :returns: ApiResponse with BulkHostedNumberOrderPage, status code, and headers
        """
        data = values.of({ 
            'PageToken': page_token,
            'Page': page_number,
        ...
        page = BulkHostedNumberOrderPage(self._version, response)
    ...
    def get_page(self, target_url: str) -> BulkHostedNumberOrderPage:
        """
        Retrieve a specific page of BulkHostedNumberOrderInstance records from the API.
        Request is executed immediately
    ...
    async def get_page_async(self, target_url: str) -> BulkHostedNumberOrderPage:
        """
        Asynchronously retrieve a specific page of BulkHostedNumberOrderInstance records from the API.
        Request is executed immediately
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.BulkHostedNumberOrderList>'
