...
from twilio.rest.numbers.users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.authorization_document.dependent_hosted_number_order import DependentHostedNumberOrderList
...
class AuthorizationDocumentInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.AuthorizationDocumentInstance {}>'.format(context)
...
class AuthorizationDocumentContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.AuthorizationDocumentContext {}>'.format(context)
...
class AuthorizationDocumentPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.AuthorizationDocumentPage>"
...
class AuthorizationDocumentList(ListResource):
    ...
    def _create(self, address_sid: str, email: str, contact_phone_number: str, hosted_number_order_sids: List[str], contact_title: Union[str, object]=values.unset, cc_emails: Union[List[str], object]=values.unset) -> tuple:
        """
    ...
    def create(self, address_sid: str, email: str, contact_phone_number: str, hosted_number_order_sids: List[str], contact_title: Union[str, object]=values.unset, cc_emails: Union[List[str], object]=values.unset) -> AuthorizationDocumentInstance:
        ...
        """
        payload, _, _ = self._create(address_sid=address_sid, email=email, contact_phone_number=contact_phone_number, hosted_number_order_sids=hosted_number_order_sids, contact_title=contact_title, cc_emails=cc_emails)
        return AuthorizationDocumentInstance(self._version, payload)

    def create_with_http_info(self, address_sid: str, email: str, contact_phone_number: str, hosted_number_order_sids: List[str], contact_title: Union[str, object]=values.unset, cc_emails: Union[List[str], object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(address_sid=address_sid, email=email, contact_phone_number=contact_phone_number, hosted_number_order_sids=hosted_number_order_sids, contact_title=contact_title, cc_emails=cc_emails)
        instance = AuthorizationDocumentInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, address_sid: str, email: str, contact_phone_number: str, hosted_number_order_sids: List[str], contact_title: Union[str, object]=values.unset, cc_emails: Union[List[str], object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, address_sid: str, email: str, contact_phone_number: str, hosted_number_order_sids: List[str], contact_title: Union[str, object]=values.unset, cc_emails: Union[List[str], object]=values.unset) -> AuthorizationDocumentInstance:
        ...
        :returns: The created AuthorizationDocumentInstance
        """
        payload, _, _ = await self._create_async(address_sid=address_sid, email=email, contact_phone_number=contact_phone_number, hosted_number_order_sids=hosted_number_order_sids, contact_title=contact_title, cc_emails=cc_emails)
        return AuthorizationDocumentInstance(self._version, payload)

    async def create_with_http_info_async(self, address_sid: str, email: str, contact_phone_number: str, hosted_number_order_sids: List[str], contact_title: Union[str, object]=values.unset, cc_emails: Union[List[str], object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(address_sid=address_sid, email=email, contact_phone_number=contact_phone_number, hosted_number_order_sids=hosted_number_order_sids, contact_title=contact_title, cc_emails=cc_emails)
        instance = AuthorizationDocumentInstance(self._version, payload)
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.AuthorizationDocumentList>'
