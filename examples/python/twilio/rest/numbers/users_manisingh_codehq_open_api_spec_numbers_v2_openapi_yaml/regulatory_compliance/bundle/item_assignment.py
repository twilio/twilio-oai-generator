...
class ItemAssignmentInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.ItemAssignmentInstance {}>'.format(context)
...
class ItemAssignmentContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.ItemAssignmentContext {}>'.format(context)
...
class ItemAssignmentPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.ItemAssignmentPage>"
...
class ItemAssignmentList(ListResource):
    ...
    def list(self, 
        ...
        return [ItemAssignmentInstance(self._version, item, bundle_sid=self._solution['bundle_sid']) for item in payload["results"]]
    ...
    def create_with_http_info(self, object_sid: str) -> ApiResponse:
        ...
        instance = ItemAssignmentInstance(self._version, payload, bundle_sid=self._solution['bundle_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.ItemAssignmentList>'
