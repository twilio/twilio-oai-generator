...
class EvaluationInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.EvaluationInstance {}>'.format(context)
...
class EvaluationContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.EvaluationContext {}>'.format(context)
...
class EvaluationPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.EvaluationPage>"
...
class EvaluationList(ListResource):
    ...
    def list(self, 
        ...
        return [EvaluationInstance(self._version, item, bundle_sid=self._solution['bundle_sid']) for item in payload["results"]]
    ...
    def create_with_http_info(self) -> ApiResponse:
        ...
        instance = EvaluationInstance(self._version, payload, bundle_sid=self._solution['bundle_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.EvaluationList>'
