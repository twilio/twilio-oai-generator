...
class SupportingDocumentInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.SupportingDocumentInstance {}>'.format(context)
...
class SupportingDocumentContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.SupportingDocumentContext {}>'.format(context)
...
class SupportingDocumentPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.SupportingDocumentPage>"
...
class SupportingDocumentList(ListResource):
    ...
    def list(self, 
        ...
        return [SupportingDocumentInstance(self._version, item) for item in payload["results"]]
    ...
    def _create(self, friendly_name: str, type: str, attributes: Union[object, object]=values.unset) -> tuple:
        """
    ...
    def create_with_http_info(self, friendly_name: str, type: str, attributes: Union[object, object]=values.unset) -> ApiResponse:
        """
    ...
    async def _create_async(self, friendly_name: str, type: str, attributes: Union[object, object]=values.unset) -> tuple:
        """
    ...
    async def create_with_http_info_async(self, friendly_name: str, type: str, attributes: Union[object, object]=values.unset) -> ApiResponse:
        """
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.SupportingDocumentList>'
