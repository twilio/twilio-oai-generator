...
class RegulationInstance(InstanceResource):
    ...
    def fetch_with_http_info(self, include_constraints: Union[bool, object]=values.unset) -> ApiResponse:
        """
        ...
        """
        return self._proxy.fetch_with_http_info(include_constraints=include_constraints, )

    async def fetch_with_http_info_async(self, include_constraints: Union[bool, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.fetch_with_http_info_async(include_constraints=include_constraints, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.RegulationInstance {}>'.format(context)
...
class RegulationContext(InstanceContext):
    ...
    def fetch_with_http_info(self, include_constraints: Union[bool, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._fetch(include_constraints=include_constraints)
    ...
    async def _fetch_async(self, include_constraints: Union[bool, object]=values.unset) -> tuple:
        """
    ...
    async def fetch_with_http_info_async(self, include_constraints: Union[bool, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._fetch_async(include_constraints=include_constraints)
        instance = RegulationInstance(
            self._version,
            payload,
            sid=self._solution['sid'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.RegulationContext {}>'.format(context)
...
class RegulationPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.RegulationPage>"
...
class RegulationList(ListResource):
    ...
    def list(self, 
        ...
        return [RegulationInstance(self._version, item) for item in payload["results"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.RegulationList>'
