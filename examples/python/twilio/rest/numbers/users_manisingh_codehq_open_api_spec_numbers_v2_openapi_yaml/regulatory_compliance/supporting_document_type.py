...
class SupportingDocumentTypeInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.SupportingDocumentTypeInstance {}>'.format(context)
...
class SupportingDocumentTypeContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.SupportingDocumentTypeContext {}>'.format(context)
...
class SupportingDocumentTypePage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.SupportingDocumentTypePage>"
...
class SupportingDocumentTypeList(ListResource):
    ...
    def list(self, 
        ...
        return [SupportingDocumentTypeInstance(self._version, item) for item in payload["supporting_document_types"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v2_openapi_yaml.SupportingDocumentTypeList>'
