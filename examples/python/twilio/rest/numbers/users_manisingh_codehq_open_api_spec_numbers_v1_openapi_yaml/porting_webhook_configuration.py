...
class PortingWebhookConfigurationInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v1_openapi_yaml.PortingWebhookConfigurationInstance>'
...
class PortingWebhookConfigurationList(ListResource):
    ...
    def create(self, body: Union[object, object]=values.unset) -> PortingWebhookConfigurationInstance:
        """
    ...
    async def create_async(self, body: Union[object, object]=values.unset) -> PortingWebhookConfigurationInstance:
        """
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v1_openapi_yaml.PortingWebhookConfigurationList>'
