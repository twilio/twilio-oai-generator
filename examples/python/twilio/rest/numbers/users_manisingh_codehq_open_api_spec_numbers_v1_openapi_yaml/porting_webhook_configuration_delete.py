...
class PortingWebhookConfigurationDeleteContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v1_openapi_yaml.PortingWebhookConfigurationDeleteContext {}>'.format(context)
...
class PortingWebhookConfigurationDeleteList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v1_openapi_yaml.PortingWebhookConfigurationDeleteList>'
