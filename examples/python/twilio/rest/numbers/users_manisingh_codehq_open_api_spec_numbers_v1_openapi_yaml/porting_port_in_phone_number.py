...
class PortingPortInPhoneNumberInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], port_in_request_sid: Optional[str] = None, phone_number_sid: Optional[str] = None):
        ...
        self.port_date: Optional[datetime] = deserialize.iso8601_datetime(payload.get("port_date"))
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v1_openapi_yaml.PortingPortInPhoneNumberInstance {}>'.format(context)
...
class PortingPortInPhoneNumberContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v1_openapi_yaml.PortingPortInPhoneNumberContext {}>'.format(context)
...
class PortingPortInPhoneNumberList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v1_openapi_yaml.PortingPortInPhoneNumberList>'
