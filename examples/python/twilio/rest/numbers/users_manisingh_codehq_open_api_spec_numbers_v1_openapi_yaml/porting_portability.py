...
class PortingPortabilityInstance(InstanceResource):
    ...
    def fetch(self, target_account_sid: Union[str, object]=values.unset, address_sid: Union[str, object]=values.unset) -> "PortingPortabilityInstance":
        """
        ...
        """
        return self._proxy.fetch(target_account_sid=target_account_sid, address_sid=address_sid, )

    async def fetch_async(self, target_account_sid: Union[str, object]=values.unset, address_sid: Union[str, object]=values.unset) -> "PortingPortabilityInstance":
        """
        ...
        :returns: The fetched PortingPortabilityInstance
        """
        return await self._proxy.fetch_async(target_account_sid=target_account_sid, address_sid=address_sid, )

    def fetch_with_http_info(self, target_account_sid: Union[str, object]=values.unset, address_sid: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        """
        return self._proxy.fetch_with_http_info(target_account_sid=target_account_sid, address_sid=address_sid, )

    async def fetch_with_http_info_async(self, target_account_sid: Union[str, object]=values.unset, address_sid: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.fetch_with_http_info_async(target_account_sid=target_account_sid, address_sid=address_sid, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v1_openapi_yaml.PortingPortabilityInstance {}>'.format(context)
...
class PortingPortabilityContext(InstanceContext):
    ...
    def _fetch(self, target_account_sid: Union[str, object]=values.unset, address_sid: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def fetch(self, target_account_sid: Union[str, object]=values.unset, address_sid: Union[str, object]=values.unset) -> PortingPortabilityInstance:
        ...
        :returns: The fetched PortingPortabilityInstance
        """
        payload, _, _ = self._fetch(target_account_sid=target_account_sid, address_sid=address_sid)
    ...
    def fetch_with_http_info(self, target_account_sid: Union[str, object]=values.unset, address_sid: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._fetch(target_account_sid=target_account_sid, address_sid=address_sid)
    ...
    async def _fetch_async(self, target_account_sid: Union[str, object]=values.unset, address_sid: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def fetch_async(self, target_account_sid: Union[str, object]=values.unset, address_sid: Union[str, object]=values.unset) -> PortingPortabilityInstance:
        ...
        :returns: The fetched PortingPortabilityInstance
        """
        payload, _, _ = await self._fetch_async(target_account_sid=target_account_sid, address_sid=address_sid)
        return PortingPortabilityInstance(
            self._version,
            payload,
            phone_number=self._solution['phone_number'],
    ...
    async def fetch_with_http_info_async(self, target_account_sid: Union[str, object]=values.unset, address_sid: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._fetch_async(target_account_sid=target_account_sid, address_sid=address_sid)
        instance = PortingPortabilityInstance(
            self._version,
            payload,
            phone_number=self._solution['phone_number'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v1_openapi_yaml.PortingPortabilityContext {}>'.format(context)
...
class PortingPortabilityList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Numbers.Users_manisingh_codehq_open_api_spec_numbers_v1_openapi_yaml.PortingPortabilityList>'
