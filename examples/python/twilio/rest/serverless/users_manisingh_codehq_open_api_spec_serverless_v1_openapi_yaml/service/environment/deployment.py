...
class DeploymentInstance(InstanceResource):
    ...
    def _proxy(self) -> "DeploymentContext":
        ...
        if self._context is None:
            self._context = DeploymentContext(self._version, service_sid=self._solution['service_sid'], environment_sid=self._solution['environment_sid'], sid=self._solution['sid'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.DeploymentInstance {}>'.format(context)
...
class DeploymentContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.DeploymentContext {}>'.format(context)
...
class DeploymentPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.DeploymentPage>"
...
class DeploymentList(ListResource):
    ...
    def list(self, 
        ...
        return [DeploymentInstance(self._version, item, service_sid=self._solution['service_sid'], environment_sid=self._solution['environment_sid']) for item in payload["deployments"]]
    ...
    def _create(self, build_sid: Union[str, object]=values.unset, is_plugin: Union[bool, object]=values.unset) -> tuple:
        """
    ...
    def create(self, build_sid: Union[str, object]=values.unset, is_plugin: Union[bool, object]=values.unset) -> DeploymentInstance:
        """
    ...
    def create_with_http_info(self, build_sid: Union[str, object]=values.unset, is_plugin: Union[bool, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(build_sid=build_sid, is_plugin=is_plugin)
        instance = DeploymentInstance(self._version, payload, service_sid=self._solution['service_sid'], environment_sid=self._solution['environment_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, build_sid: Union[str, object]=values.unset, is_plugin: Union[bool, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, build_sid: Union[str, object]=values.unset, is_plugin: Union[bool, object]=values.unset) -> DeploymentInstance:
        """
        ...
        :returns: The created DeploymentInstance
        """
        payload, _, _ = await self._create_async(build_sid=build_sid, is_plugin=is_plugin)
        return DeploymentInstance(self._version, payload, service_sid=self._solution['service_sid'], environment_sid=self._solution['environment_sid'])

    async def create_with_http_info_async(self, build_sid: Union[str, object]=values.unset, is_plugin: Union[bool, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(build_sid=build_sid, is_plugin=is_plugin)
        instance = DeploymentInstance(self._version, payload, service_sid=self._solution['service_sid'], environment_sid=self._solution['environment_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.DeploymentList>'
