...
class VariableInstance(InstanceResource):
    ...
    def update_with_http_info(self, key: Union[str, object]=values.unset, value: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(key=key, value=value, )

    async def update_with_http_info_async(self, key: Union[str, object]=values.unset, value: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(key=key, value=value, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.VariableInstance {}>'.format(context)
...
class VariableContext(InstanceContext):
    ...
    def _update(self, key: Union[str, object]=values.unset, value: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def _update_async(self, key: Union[str, object]=values.unset, value: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.VariableContext {}>'.format(context)
...
class VariablePage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.VariablePage>"
...
class VariableList(ListResource):
    ...
    def list(self, 
        ...
        return [VariableInstance(self._version, item, service_sid=self._solution['service_sid'], environment_sid=self._solution['environment_sid']) for item in payload["variables"]]
    ...
    def create_with_http_info(self, key: str, value: str) -> ApiResponse:
        ...
        instance = VariableInstance(self._version, payload, service_sid=self._solution['service_sid'], environment_sid=self._solution['environment_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.VariableList>'
