...
from twilio.rest.serverless.users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.service.function.function_version.function_version_content import FunctionVersionContentList
...
class FunctionVersionInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], service_sid: str, function_sid: str, sid: Optional[str] = None):
        ...
        self.visibility: Optional["FunctionVersionInstance.Visibility"] = payload.get("visibility")
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.FunctionVersionInstance {}>'.format(context)
...
class FunctionVersionContext(InstanceContext):
    ...
    def fetch_with_http_info(self) -> ApiResponse:
        ...
        instance = FunctionVersionInstance(
            self._version,
            payload,
            service_sid=self._solution['service_sid'],
            function_sid=self._solution['function_sid'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.FunctionVersionContext {}>'.format(context)
...
class FunctionVersionPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.FunctionVersionPage>"
...
class FunctionVersionList(ListResource):
    ...
    def list(self, 
        ...
        return [FunctionVersionInstance(self._version, item, service_sid=self._solution['service_sid'], function_sid=self._solution['function_sid']) for item in payload["function_versions"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.FunctionVersionList>'
