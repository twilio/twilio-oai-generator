...
from twilio.rest.serverless.users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.service.function.function_version import FunctionVersionList
...
class FunctionInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.FunctionInstance {}>'.format(context)
...
class FunctionContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.FunctionContext {}>'.format(context)
...
class FunctionPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.FunctionPage>"
...
class FunctionList(ListResource):
    ...
    def list(self, 
        ...
        return [FunctionInstance(self._version, item, service_sid=self._solution['service_sid']) for item in payload["functions"]]
    ...
    def create_with_http_info(self, friendly_name: str) -> ApiResponse:
        ...
        instance = FunctionInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.FunctionList>'
