...
class AssetVersionInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], service_sid: str, asset_sid: str, sid: Optional[str] = None):
        ...
        self.visibility: Optional["AssetVersionInstance.Visibility"] = payload.get("visibility")
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.AssetVersionInstance {}>'.format(context)
...
class AssetVersionContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.AssetVersionContext {}>'.format(context)
...
class AssetVersionPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.AssetVersionPage>"
...
class AssetVersionList(ListResource):
    ...
    def list(self, 
        ...
        return [AssetVersionInstance(self._version, item, service_sid=self._solution['service_sid'], asset_sid=self._solution['asset_sid']) for item in payload["asset_versions"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.AssetVersionList>'
