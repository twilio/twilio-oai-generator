...
from twilio.rest.serverless.users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.service.asset.asset_version import AssetVersionList
...
class AssetInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.AssetInstance {}>'.format(context)
...
class AssetContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.AssetContext {}>'.format(context)
...
class AssetPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.AssetPage>"
...
class AssetList(ListResource):
    ...
    def list(self, 
        ...
        return [AssetInstance(self._version, item, service_sid=self._solution['service_sid']) for item in payload["assets"]]
    ...
    def create_with_http_info(self, friendly_name: str) -> ApiResponse:
        ...
        instance = AssetInstance(self._version, payload, service_sid=self._solution['service_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.AssetList>'
