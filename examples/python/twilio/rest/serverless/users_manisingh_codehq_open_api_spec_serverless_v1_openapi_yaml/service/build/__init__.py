...
from twilio.rest.serverless.users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.service.build.build_status import BuildStatusList
...
class BuildInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.BuildInstance {}>'.format(context)
...
class BuildContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.BuildContext {}>'.format(context)
...
class BuildPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.BuildPage>"
...
class BuildList(ListResource):
    ...
    def list(self, 
        ...
        return [BuildInstance(self._version, item, service_sid=self._solution['service_sid']) for item in payload["builds"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Serverless.Users_manisingh_codehq_open_api_spec_serverless_v1_openapi_yaml.BuildList>'
