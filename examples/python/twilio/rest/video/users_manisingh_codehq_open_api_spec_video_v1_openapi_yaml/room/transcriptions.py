...
class TranscriptionsInstance(InstanceResource):
    ...
    def _proxy(self) -> "TranscriptionsContext":
        ...
        if self._context is None:
            self._context = TranscriptionsContext(self._version, room_sid=self._solution['room_sid'], ttid=self._solution['ttid'],)
    ...
    def update(self, status: Union["TranscriptionsInstance.Status", object]=values.unset, configuration: Union[object, object]=values.unset) -> "TranscriptionsInstance":
        """
        ...
        """
        return self._proxy.update(status=status, configuration=configuration, )

    async def update_async(self, status: Union["TranscriptionsInstance.Status", object]=values.unset, configuration: Union[object, object]=values.unset) -> "TranscriptionsInstance":
        """
        ...
        :returns: The updated TranscriptionsInstance
        """
        return await self._proxy.update_async(status=status, configuration=configuration, )

    def update_with_http_info(self, status: Union["TranscriptionsInstance.Status", object]=values.unset, configuration: Union[object, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(status=status, configuration=configuration, )

    async def update_with_http_info_async(self, status: Union["TranscriptionsInstance.Status", object]=values.unset, configuration: Union[object, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(status=status, configuration=configuration, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Video.Users_manisingh_codehq_open_api_spec_video_v1_openapi_yaml.TranscriptionsInstance {}>'.format(context)
...
class TranscriptionsContext(InstanceContext):
    ...
    def _update(self, status: Union["TranscriptionsInstance.Status", object]=values.unset, configuration: Union[object, object]=values.unset) -> tuple:
        """
    ...
    def update_with_http_info(self, status: Union["TranscriptionsInstance.Status", object]=values.unset, configuration: Union[object, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._update(status=status, configuration=configuration)
        instance = TranscriptionsInstance(
            self._version,
            payload,
            room_sid=self._solution['room_sid'],
    ...
    async def _update_async(self, status: Union["TranscriptionsInstance.Status", object]=values.unset, configuration: Union[object, object]=values.unset) -> tuple:
        """
    ...
    async def update_async(self, status: Union["TranscriptionsInstance.Status", object]=values.unset, configuration: Union[object, object]=values.unset) -> TranscriptionsInstance:
        ...
        :returns: The updated TranscriptionsInstance
        """
        payload, _, _ = await self._update_async(status=status, configuration=configuration)
        return TranscriptionsInstance(
            self._version,
            payload,
            room_sid=self._solution['room_sid'],
    ...
    async def update_with_http_info_async(self, status: Union["TranscriptionsInstance.Status", object]=values.unset, configuration: Union[object, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(status=status, configuration=configuration)
        instance = TranscriptionsInstance(
            self._version,
            payload,
            room_sid=self._solution['room_sid'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Video.Users_manisingh_codehq_open_api_spec_video_v1_openapi_yaml.TranscriptionsContext {}>'.format(context)
...
class TranscriptionsPage(Page):
    ...
    def get_instance(self, payload: Dict[str, Any]) -> TranscriptionsInstance:
        ...
        return TranscriptionsInstance(self._version, payload, room_sid=self._solution["room_sid"])
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Video.Users_manisingh_codehq_open_api_spec_video_v1_openapi_yaml.TranscriptionsPage>"
...
class TranscriptionsList(ListResource):
    ...
    def list(self, 
        ...
        return [TranscriptionsInstance(self._version, item, room_sid=self._solution['room_sid']) for item in payload["transcriptions"]]
    ...
    def create(self, configuration: Union[object, object]=values.unset) -> TranscriptionsInstance:
        """
    ...
    def create_with_http_info(self, configuration: Union[object, object]=values.unset) -> ApiResponse:
        """
        ...
        instance = TranscriptionsInstance(self._version, payload, room_sid=self._solution['room_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, configuration: Union[object, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, configuration: Union[object, object]=values.unset) -> TranscriptionsInstance:
        """
    ...
    async def create_with_http_info_async(self, configuration: Union[object, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(configuration=configuration)
        instance = TranscriptionsInstance(self._version, payload, room_sid=self._solution['room_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def get(self, ttid: str) -> TranscriptionsContext:
        ...
        :param ttid: The Twilio type id of the transcriptions resource to update.
        """
        return TranscriptionsContext(self._version, room_sid=self._solution['room_sid'], ttid=ttid)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Video.Users_manisingh_codehq_open_api_spec_video_v1_openapi_yaml.TranscriptionsList>'
