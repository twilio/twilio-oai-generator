...
class SubscribedTrackInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Video.Users_manisingh_codehq_open_api_spec_video_v1_openapi_yaml.SubscribedTrackInstance {}>'.format(context)
...
class SubscribedTrackContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Video.Users_manisingh_codehq_open_api_spec_video_v1_openapi_yaml.SubscribedTrackContext {}>'.format(context)
...
class SubscribedTrackPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Video.Users_manisingh_codehq_open_api_spec_video_v1_openapi_yaml.SubscribedTrackPage>"
...
class SubscribedTrackList(ListResource):
    ...
    def list(self, 
        ...
        return [SubscribedTrackInstance(self._version, item, room_sid=self._solution['room_sid'], participant_sid=self._solution['participant_sid']) for item in payload["subscribed_tracks"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Video.Users_manisingh_codehq_open_api_spec_video_v1_openapi_yaml.SubscribedTrackList>'
