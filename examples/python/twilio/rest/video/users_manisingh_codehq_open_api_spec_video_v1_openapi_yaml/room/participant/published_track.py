...
class PublishedTrackInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Video.Users_manisingh_codehq_open_api_spec_video_v1_openapi_yaml.PublishedTrackInstance {}>'.format(context)
...
class PublishedTrackContext(InstanceContext):
    ...
    def fetch_with_http_info(self) -> ApiResponse:
        ...
        instance = PublishedTrackInstance(
            self._version,
            payload,
            room_sid=self._solution['room_sid'],
            participant_sid=self._solution['participant_sid'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Video.Users_manisingh_codehq_open_api_spec_video_v1_openapi_yaml.PublishedTrackContext {}>'.format(context)
...
class PublishedTrackPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Video.Users_manisingh_codehq_open_api_spec_video_v1_openapi_yaml.PublishedTrackPage>"
...
class PublishedTrackList(ListResource):
    ...
    def list(self, 
        ...
        return [PublishedTrackInstance(self._version, item, room_sid=self._solution['room_sid'], participant_sid=self._solution['participant_sid']) for item in payload["published_tracks"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Video.Users_manisingh_codehq_open_api_spec_video_v1_openapi_yaml.PublishedTrackList>'
