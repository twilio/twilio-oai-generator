...
class IpAccessControlListInstance(InstanceResource):
    ...
    def _proxy(self) -> "IpAccessControlListContext":
        ...
        if self._context is None:
            self._context = IpAccessControlListContext(self._version, trunk_sid=self._solution['trunk_sid'], sid=self._solution['sid'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Trunking.Users_manisingh_codehq_open_api_spec_trunking_v1_openapi_yaml.IpAccessControlListInstance {}>'.format(context)
...
class IpAccessControlListContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Trunking.Users_manisingh_codehq_open_api_spec_trunking_v1_openapi_yaml.IpAccessControlListContext {}>'.format(context)
...
class IpAccessControlListPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Trunking.Users_manisingh_codehq_open_api_spec_trunking_v1_openapi_yaml.IpAccessControlListPage>"
...
class IpAccessControlListList(ListResource):
    ...
    def list(self, 
        ...
        return [IpAccessControlListInstance(self._version, item, trunk_sid=self._solution['trunk_sid']) for item in payload["ip_access_control_lists"]]
    ...
    def create_with_http_info(self, ip_access_control_list_sid: str) -> ApiResponse:
        ...
        instance = IpAccessControlListInstance(self._version, payload, trunk_sid=self._solution['trunk_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Trunking.Users_manisingh_codehq_open_api_spec_trunking_v1_openapi_yaml.IpAccessControlListList>'
