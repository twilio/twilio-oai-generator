...
class PhoneNumberInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], trunk_sid: str, sid: Optional[str] = None):
        ...
        self.address_requirements: Optional["PhoneNumberInstance.AddressRequirement"] = payload.get("address_requirements")
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Trunking.Users_manisingh_codehq_open_api_spec_trunking_v1_openapi_yaml.PhoneNumberInstance {}>'.format(context)
...
class PhoneNumberContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Trunking.Users_manisingh_codehq_open_api_spec_trunking_v1_openapi_yaml.PhoneNumberContext {}>'.format(context)
...
class PhoneNumberPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Trunking.Users_manisingh_codehq_open_api_spec_trunking_v1_openapi_yaml.PhoneNumberPage>"
...
class PhoneNumberList(ListResource):
    ...
    def list(self, 
        ...
        return [PhoneNumberInstance(self._version, item, trunk_sid=self._solution['trunk_sid']) for item in payload["phone_numbers"]]
    ...
    def create_with_http_info(self, phone_number_sid: str) -> ApiResponse:
        ...
        instance = PhoneNumberInstance(self._version, payload, trunk_sid=self._solution['trunk_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    async def create_with_http_info_async(self, phone_number_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(phone_number_sid=phone_number_sid)
        instance = PhoneNumberInstance(self._version, payload, trunk_sid=self._solution['trunk_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Trunking.Users_manisingh_codehq_open_api_spec_trunking_v1_openapi_yaml.PhoneNumberList>'
