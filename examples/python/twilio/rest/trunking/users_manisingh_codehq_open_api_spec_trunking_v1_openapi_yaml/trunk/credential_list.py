...
class CredentialListInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Trunking.Users_manisingh_codehq_open_api_spec_trunking_v1_openapi_yaml.CredentialListInstance {}>'.format(context)
...
class CredentialListContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Trunking.Users_manisingh_codehq_open_api_spec_trunking_v1_openapi_yaml.CredentialListContext {}>'.format(context)
...
class CredentialListPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Trunking.Users_manisingh_codehq_open_api_spec_trunking_v1_openapi_yaml.CredentialListPage>"
...
class CredentialListList(ListResource):
    ...
    def list(self, 
        ...
        return [CredentialListInstance(self._version, item, trunk_sid=self._solution['trunk_sid']) for item in payload["credential_lists"]]
    ...
    def create_with_http_info(self, credential_list_sid: str) -> ApiResponse:
        ...
        instance = CredentialListInstance(self._version, payload, trunk_sid=self._solution['trunk_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Trunking.Users_manisingh_codehq_open_api_spec_trunking_v1_openapi_yaml.CredentialListList>'
