...
class RoleAssignmentInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], organization_sid: Optional[str] = None, role_assignment_sid: Optional[str] = None):
    ...
    def _proxy(self) -> "RoleAssignmentContext":
        ...
        if self._context is None:
            self._context = RoleAssignmentContext(self._version, organization_sid=self._solution['organization_sid'], role_assignment_sid=self._solution['role_assignment_sid'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.PreviewIam.Organizations.RoleAssignmentInstance {}>'.format(context)
...
class RoleAssignmentContext(InstanceContext):
    ...
    def __init__(self, version: Version, organization_sid: str, role_assignment_sid: str):
        """
        ...
        self._uri = '/{organization_sid}/RoleAssignments/{role_assignment_sid}'.format(**self._solution)
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.PreviewIam.Organizations.RoleAssignmentContext {}>'.format(context)
...
class RoleAssignmentPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.PreviewIam.Organizations.RoleAssignmentPage>"
...
class RoleAssignmentList(ListResource):
    ...
    def _create(self, public_api_create_role_assignment_request: PublicApiCreateRoleAssignmentRequest) -> tuple:
        """
    ...
    def create(self, public_api_create_role_assignment_request: PublicApiCreateRoleAssignmentRequest) -> RoleAssignmentInstance:
        ...
        """
        payload, _, _ = self._create(public_api_create_role_assignment_request=public_api_create_role_assignment_request)
        return RoleAssignmentInstance(self._version, payload, organization_sid=self._solution['organization_sid'])
    ...
    def create_with_http_info(self, public_api_create_role_assignment_request: PublicApiCreateRoleAssignmentRequest) -> ApiResponse:
        ...
        """
        payload, status_code, headers = self._create(public_api_create_role_assignment_request=public_api_create_role_assignment_request)
        instance = RoleAssignmentInstance(self._version, payload, organization_sid=self._solution['organization_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, public_api_create_role_assignment_request: PublicApiCreateRoleAssignmentRequest) -> tuple:
        """
    ...
    async def create_async(self, public_api_create_role_assignment_request: PublicApiCreateRoleAssignmentRequest) -> RoleAssignmentInstance:
        ...
        :returns: The created RoleAssignmentInstance
        """
        payload, _, _ = await self._create_async(public_api_create_role_assignment_request=public_api_create_role_assignment_request)
        return RoleAssignmentInstance(self._version, payload, organization_sid=self._solution['organization_sid'])
    ...
    async def create_with_http_info_async(self, public_api_create_role_assignment_request: PublicApiCreateRoleAssignmentRequest) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(public_api_create_role_assignment_request=public_api_create_role_assignment_request)
        instance = RoleAssignmentInstance(self._version, payload, organization_sid=self._solution['organization_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def list(self, 
        ...
        return [RoleAssignmentInstance(self._version, item, organization_sid=self._solution['organization_sid']) for item in payload["content"]]
    ...
    def get(self, organization_sid: str, role_assignment_sid: str) -> RoleAssignmentContext:
        """
        ...
        :param role_assignment_sid: 
        """
        return RoleAssignmentContext(self._version, organization_sid=organization_sid, role_assignment_sid=role_assignment_sid)

    def __call__(self, organization_sid: str, role_assignment_sid: str) -> RoleAssignmentContext:
        """
        Constructs a RoleAssignmentContext
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.PreviewIam.Organizations.RoleAssignmentList>'
