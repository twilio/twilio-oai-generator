...
class AccountInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], organization_sid: Optional[str] = None, account_sid: Optional[str] = None):
...
class AccountList(ListResource):
    ...
    def list(self, 
        ...
        return [AccountInstance(self._version, item, organization_sid=self._solution['organization_sid']) for item in payload["content"]]
    ...
    def get(self, organization_sid: str, account_sid: str) -> AccountContext:
        ...
        :param account_sid: 
        """
        return AccountContext(self._version, organization_sid=organization_sid, account_sid=account_sid)
