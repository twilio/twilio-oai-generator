...
from twilio.rest.studio.users_manisingh_codehq_open_api_spec_studio_v2_openapi_yaml.flow.execution.execution import ExecutionList
from twilio.rest.studio.users_manisingh_codehq_open_api_spec_studio_v2_openapi_yaml.flow.execution.execution_context import ExecutionContextList
from twilio.rest.studio.users_manisingh_codehq_open_api_spec_studio_v2_openapi_yaml.flow.execution.execution_step import ExecutionStepList
...
class ExecutionPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Studio.Users_manisingh_codehq_open_api_spec_studio_v2_openapi_yaml.ExecutionPage>"
...
class ExecutionList(ListResource):
    ...
    def list(self, 
        ...
        return [ExecutionInstance(self._version, item, flow_sid=self._solution['flow_sid']) for item in payload["executions"]]
    ...
    def _create(self, to: str, from_: str, parameters: Union[object, object]=values.unset, external_id: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def create(self, to: str, from_: str, parameters: Union[object, object]=values.unset, external_id: Union[str, object]=values.unset) -> ExecutionInstance:
        """
        ...
        """
        payload, _, _ = self._create(to=to, from_=from_, parameters=parameters, external_id=external_id)
        return ExecutionInstance(self._version, payload, flow_sid=self._solution['flow_sid'])

    def create_with_http_info(self, to: str, from_: str, parameters: Union[object, object]=values.unset, external_id: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(to=to, from_=from_, parameters=parameters, external_id=external_id)
        instance = ExecutionInstance(self._version, payload, flow_sid=self._solution['flow_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, to: str, from_: str, parameters: Union[object, object]=values.unset, external_id: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, to: str, from_: str, parameters: Union[object, object]=values.unset, external_id: Union[str, object]=values.unset) -> ExecutionInstance:
        """
        ...
        :returns: The created ExecutionInstance
        """
        payload, _, _ = await self._create_async(to=to, from_=from_, parameters=parameters, external_id=external_id)
        return ExecutionInstance(self._version, payload, flow_sid=self._solution['flow_sid'])

    async def create_with_http_info_async(self, to: str, from_: str, parameters: Union[object, object]=values.unset, external_id: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(to=to, from_=from_, parameters=parameters, external_id=external_id)
        instance = ExecutionInstance(self._version, payload, flow_sid=self._solution['flow_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
