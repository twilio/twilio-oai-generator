...
from twilio.rest.studio.users_manisingh_codehq_open_api_spec_studio_v2_openapi_yaml.flow.execution.execution_step.execution_step_context import ExecutionStepContextList
...
class ExecutionStepInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Studio.Users_manisingh_codehq_open_api_spec_studio_v2_openapi_yaml.ExecutionStepInstance {}>'.format(context)
...
class ExecutionStepContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Studio.Users_manisingh_codehq_open_api_spec_studio_v2_openapi_yaml.ExecutionStepContext {}>'.format(context)
...
class ExecutionStepPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Studio.Users_manisingh_codehq_open_api_spec_studio_v2_openapi_yaml.ExecutionStepPage>"
...
class ExecutionStepList(ListResource):
    ...
    def list(self, 
        ...
        return [ExecutionStepInstance(self._version, item, flow_sid=self._solution['flow_sid'], execution_sid=self._solution['execution_sid']) for item in payload["steps"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Studio.Users_manisingh_codehq_open_api_spec_studio_v2_openapi_yaml.ExecutionStepList>'
