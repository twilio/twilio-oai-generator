...
from twilio.rest.studio.users_manisingh_codehq_open_api_spec_studio_v1_openapi_yaml.flow.execution.execution_context import ExecutionContextList
from twilio.rest.studio.users_manisingh_codehq_open_api_spec_studio_v1_openapi_yaml.flow.execution.execution_step import ExecutionStepList
...
class ExecutionInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Studio.Users_manisingh_codehq_open_api_spec_studio_v1_openapi_yaml.ExecutionInstance {}>'.format(context)
...
class ExecutionContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Studio.Users_manisingh_codehq_open_api_spec_studio_v1_openapi_yaml.ExecutionContext {}>'.format(context)
...
class ExecutionPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Studio.Users_manisingh_codehq_open_api_spec_studio_v1_openapi_yaml.ExecutionPage>"
...
class ExecutionList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Studio.Users_manisingh_codehq_open_api_spec_studio_v1_openapi_yaml.ExecutionList>'
