...
class DailyInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.DailyInstance {}>'.format(context)
...
class DailyPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.DailyPage>"
...
class DailyList(ListResource):
    ...
    def page(self, 
      ...
      include_subaccounts: Union[bool, object] = values.unset,
        ...
        return DailyPage(self._version, response, solution=self._solution)
    ...
    def page_with_http_info(self, 
        ...
        page = DailyPage(self._version, response, solution=self._solution)
    ...
    def list(self, 
        ...
        return [DailyInstance(self._version, item, account_sid=self._solution['account_sid']) for item in payload["usage_records"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.DailyList>'
