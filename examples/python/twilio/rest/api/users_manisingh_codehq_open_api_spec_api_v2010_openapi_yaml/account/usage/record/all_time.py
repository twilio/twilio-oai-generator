...
class AllTimeInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AllTimeInstance {}>'.format(context)
...
class AllTimePage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AllTimePage>"
...
class AllTimeList(ListResource):
    ...
    def page(self, 
      ...
      include_subaccounts: Union[bool, object] = values.unset,
        ...
        return AllTimePage(self._version, response, solution=self._solution)
    ...
    def page_with_http_info(self, 
        ...
        page = AllTimePage(self._version, response, solution=self._solution)
    ...
    def list(self, 
        ...
        return [AllTimeInstance(self._version, item, account_sid=self._solution['account_sid']) for item in payload["usage_records"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AllTimeList>'
