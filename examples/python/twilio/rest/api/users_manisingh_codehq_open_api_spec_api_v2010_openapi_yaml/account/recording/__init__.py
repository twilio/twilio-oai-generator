...
from twilio.rest.api.users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.account.recording.add_on_result import AddOnResultList
from twilio.rest.api.users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.account.recording.transcription import TranscriptionList
...
class RecordingInstance(InstanceResource):
    ...
    def fetch_with_http_info(self, include_soft_deleted: Union[bool, object]=values.unset) -> ApiResponse:
        """
        ...
        """
        return self._proxy.fetch_with_http_info(include_soft_deleted=include_soft_deleted, )

    async def fetch_with_http_info_async(self, include_soft_deleted: Union[bool, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.fetch_with_http_info_async(include_soft_deleted=include_soft_deleted, )
...
class RecordingContext(InstanceContext):
    ...
    def fetch_with_http_info(self, include_soft_deleted: Union[bool, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._fetch(include_soft_deleted=include_soft_deleted)
    ...
    async def _fetch_async(self, include_soft_deleted: Union[bool, object]=values.unset) -> tuple:
        """
    ...
    async def fetch_with_http_info_async(self, include_soft_deleted: Union[bool, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._fetch_async(include_soft_deleted=include_soft_deleted)
        instance = RecordingInstance(
            self._version,
            payload,
            account_sid=self._solution['account_sid'],
...
class RecordingList(ListResource):
    ...
    def list(self, 
        ...
        return [RecordingInstance(self._version, item, account_sid=self._solution['account_sid']) for item in payload["recordings"]]
