...
class TranscriptionPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.TranscriptionPage>"
...
class TranscriptionList(ListResource):
    ...
    def list(self, 
        ...
        return [TranscriptionInstance(self._version, item, account_sid=self._solution['account_sid'], recording_sid=self._solution['recording_sid']) for item in payload["transcriptions"]]
