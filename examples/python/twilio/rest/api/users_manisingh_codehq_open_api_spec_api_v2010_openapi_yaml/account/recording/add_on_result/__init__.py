...
from twilio.rest.api.users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.account.recording.add_on_result.payload import PayloadList
...
class AddOnResultInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], account_sid: str, reference_sid: str, sid: Optional[str] = None):
        ...
        self.date_completed: Optional[datetime] = deserialize.rfc2822_datetime(payload.get("date_completed"))
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AddOnResultInstance {}>'.format(context)
...
class AddOnResultContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AddOnResultContext {}>'.format(context)
...
class AddOnResultPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AddOnResultPage>"
...
class AddOnResultList(ListResource):
    ...
    def list(self, 
        ...
        return [AddOnResultInstance(self._version, item, account_sid=self._solution['account_sid'], reference_sid=self._solution['reference_sid']) for item in payload["add_on_results"]]
    ...
    def page(self, 
        ...
        return AddOnResultPage(self._version, response, solution=self._solution)
    ...
    def page_with_http_info(self, 
        ...
        page = AddOnResultPage(self._version, response, solution=self._solution)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AddOnResultList>'
