...
class MobilePage(Page):
    ...
    def get_instance(self, payload: Dict[str, Any]) -> MobileInstance:
        ...
        return MobileInstance(self._version, payload, account_sid=self._solution["account_sid"], country_code=self._solution["country_code"])
...
class MobileList(ListResource):
    ...
    def list(self, 
        ...
        return [MobileInstance(self._version, item, account_sid=self._solution['account_sid'], country_code=self._solution['country_code']) for item in payload["available_phone_numbers"]]
