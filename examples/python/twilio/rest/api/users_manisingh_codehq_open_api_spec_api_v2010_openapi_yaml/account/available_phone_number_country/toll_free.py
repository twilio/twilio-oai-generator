...
class TollFreeList(ListResource):
    ...
    def list(self, 
        ...
        return [TollFreeInstance(self._version, item, account_sid=self._solution['account_sid'], country_code=self._solution['country_code']) for item in payload["available_phone_numbers"]]
