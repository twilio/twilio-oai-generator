...
from twilio.rest.api.users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.account.incoming_phone_number.assigned_add_on.assigned_add_on_extension import AssignedAddOnExtensionList
...
class AssignedAddOnInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AssignedAddOnInstance {}>'.format(context)
...
class AssignedAddOnContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AssignedAddOnContext {}>'.format(context)
...
class AssignedAddOnPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AssignedAddOnPage>"
...
class AssignedAddOnList(ListResource):
    ...
    def list(self, 
        ...
        return [AssignedAddOnInstance(self._version, item, account_sid=self._solution['account_sid'], resource_sid=self._solution['resource_sid']) for item in payload["assigned_add_ons"]]
    ...
    def create_with_http_info(self, installed_add_on_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(installed_add_on_sid=installed_add_on_sid)
        instance = AssignedAddOnInstance(self._version, payload, account_sid=self._solution['account_sid'], resource_sid=self._solution['resource_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    async def create_async(self, installed_add_on_sid: str) -> AssignedAddOnInstance:
        ...
        :returns: The created AssignedAddOnInstance
        """
        payload, _, _ = await self._create_async(installed_add_on_sid=installed_add_on_sid)
        return AssignedAddOnInstance(self._version, payload, account_sid=self._solution['account_sid'], resource_sid=self._solution['resource_sid'])
    ...
    async def create_with_http_info_async(self, installed_add_on_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(installed_add_on_sid=installed_add_on_sid)
        instance = AssignedAddOnInstance(self._version, payload, account_sid=self._solution['account_sid'], resource_sid=self._solution['resource_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AssignedAddOnList>'
