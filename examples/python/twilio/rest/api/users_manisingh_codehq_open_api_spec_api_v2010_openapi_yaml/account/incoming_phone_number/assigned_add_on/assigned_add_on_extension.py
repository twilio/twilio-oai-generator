...
class AssignedAddOnExtensionInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AssignedAddOnExtensionInstance {}>'.format(context)
...
class AssignedAddOnExtensionContext(InstanceContext):
    ...
    def fetch_with_http_info(self) -> ApiResponse:
        ...
        instance = AssignedAddOnExtensionInstance(
            self._version,
            payload,
            account_sid=self._solution['account_sid'],
            resource_sid=self._solution['resource_sid'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AssignedAddOnExtensionContext {}>'.format(context)
...
class AssignedAddOnExtensionPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AssignedAddOnExtensionPage>"
...
class AssignedAddOnExtensionList(ListResource):
    ...
    def list(self, 
        ...
        return [AssignedAddOnExtensionInstance(self._version, item, account_sid=self._solution['account_sid'], resource_sid=self._solution['resource_sid'], assigned_add_on_sid=self._solution['assigned_add_on_sid']) for item in payload["extensions"]]
    ...
    def page(self, 
        ...
        return AssignedAddOnExtensionPage(self._version, response, solution=self._solution)
    ...
    def page_with_http_info(self, 
        ...
        page = AssignedAddOnExtensionPage(self._version, response, solution=self._solution)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AssignedAddOnExtensionList>'
