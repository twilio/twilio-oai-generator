...
class TollFreeInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], account_sid: str):
        ...
        self.address_requirements: Optional["TollFreeInstance.AddressRequirement"] = payload.get("address_requirements")
        ...
        self.voice_receive_mode: Optional["TollFreeInstance.VoiceReceiveMode"] = payload.get("voice_receive_mode")
        ...
        self.emergency_status: Optional["TollFreeInstance.EmergencyStatus"] = payload.get("emergency_status")
        self.emergency_address_sid: Optional[str] = payload.get("emergency_address_sid")
        self.emergency_address_status: Optional["TollFreeInstance.EmergencyAddressStatus"] = payload.get("emergency_address_status")
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.TollFreeInstance {}>'.format(context)
...
class TollFreePage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.TollFreePage>"
...
class TollFreeList(ListResource):
    ...
    def create(self, phone_number: str, api_version: Union[str, object]=values.unset, friendly_name: Union[str, object]=values.unset, sms_application_sid: Union[str, object]=values.unset, sms_fallback_method: Union[str, object]=values.unset, sms_fallback_url: Union[str, object]=values.unset, sms_method: Union[str, object]=values.unset, sms_url: Union[str, object]=values.unset, status_callback: Union[str, object]=values.unset, status_callback_method: Union[str, object]=values.unset, voice_application_sid: Union[str, object]=values.unset, voice_caller_id_lookup: Union[bool, object]=values.unset, voice_fallback_method: Union[str, object]=values.unset, voice_fallback_url: Union[str, object]=values.unset, voice_method: Union[str, object]=values.unset, voice_url: Union[str, object]=values.unset, identity_sid: Union[str, object]=values.unset, address_sid: Union[str, object]=values.unset, emergency_status: Union["TollFreeInstance.EmergencyStatus", object]=values.unset, emergency_address_sid: Union[str, object]=values.unset, trunk_sid: Union[str, object]=values.unset, voice_receive_mode: Union["TollFreeInstance.VoiceReceiveMode", object]=values.unset, bundle_sid: Union[str, object]=values.unset) -> TollFreeInstance:
        """
    ...
    def create_with_http_info(self, phone_number: str, api_version: Union[str, object]=values.unset, friendly_name: Union[str, object]=values.unset, sms_application_sid: Union[str, object]=values.unset, sms_fallback_method: Union[str, object]=values.unset, sms_fallback_url: Union[str, object]=values.unset, sms_method: Union[str, object]=values.unset, sms_url: Union[str, object]=values.unset, status_callback: Union[str, object]=values.unset, status_callback_method: Union[str, object]=values.unset, voice_application_sid: Union[str, object]=values.unset, voice_caller_id_lookup: Union[bool, object]=values.unset, voice_fallback_method: Union[str, object]=values.unset, voice_fallback_url: Union[str, object]=values.unset, voice_method: Union[str, object]=values.unset, voice_url: Union[str, object]=values.unset, identity_sid: Union[str, object]=values.unset, address_sid: Union[str, object]=values.unset, emergency_status: Union["TollFreeInstance.EmergencyStatus", object]=values.unset, emergency_address_sid: Union[str, object]=values.unset, trunk_sid: Union[str, object]=values.unset, voice_receive_mode: Union["TollFreeInstance.VoiceReceiveMode", object]=values.unset, bundle_sid: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        instance = TollFreeInstance(self._version, payload, account_sid=self._solution['account_sid'])
    ...
    def list(self, 
        ...
        return [TollFreeInstance(self._version, item, account_sid=self._solution['account_sid']) for item in payload["incoming_phone_numbers"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.TollFreeList>'
