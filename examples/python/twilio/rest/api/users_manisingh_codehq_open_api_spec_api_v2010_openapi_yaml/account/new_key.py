...
class NewKeyInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.NewKeyInstance {}>'.format(context)
...
class NewKeyList(ListResource):
    ...
    def create(self, friendly_name: Union[str, object]=values.unset) -> NewKeyInstance:
        """
    ...
    def create_with_http_info(self, friendly_name: Union[str, object]=values.unset) -> ApiResponse:
        ...
        instance = NewKeyInstance(self._version, payload, account_sid=self._solution['account_sid'])
    ...
    async def create_async(self, friendly_name: Union[str, object]=values.unset) -> NewKeyInstance:
        """
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.NewKeyList>'
