...
class CredentialInstance(InstanceResource):
    ...
    async def update_async(self, password: Union[str, object]=values.unset) -> "CredentialInstance":
        """
        ...
        :returns: The updated CredentialInstance
        """
        return await self._proxy.update_async(password=password, )

    def update_with_http_info(self, password: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(password=password, )

    async def update_with_http_info_async(self, password: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(password=password, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.CredentialInstance {}>'.format(context)
...
class CredentialContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.CredentialContext {}>'.format(context)
...
class CredentialPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.CredentialPage>"
...
class CredentialList(ListResource):
    ...
    def list(self, 
        ...
        return [CredentialInstance(self._version, item, account_sid=self._solution['account_sid'], credential_list_sid=self._solution['credential_list_sid']) for item in payload["credentials"]]
    ...
    def create_with_http_info(self, username: str, password: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(username=username, password=password)
        instance = CredentialInstance(self._version, payload, account_sid=self._solution['account_sid'], credential_list_sid=self._solution['credential_list_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    async def create_with_http_info_async(self, username: str, password: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(username=username, password=password)
        instance = CredentialInstance(self._version, payload, account_sid=self._solution['account_sid'], credential_list_sid=self._solution['credential_list_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.CredentialList>'
