...
from twilio.rest.api.users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.account.sip.domain.auth_types.auth_type_calls.auth_calls_credential_list_mapping import AuthCallsCredentialListMappingList
from twilio.rest.api.users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.account.sip.domain.auth_types.auth_type_calls.auth_calls_ip_access_control_list_mapping import AuthCallsIpAccessControlListMappingList
...
class AuthTypeCallsList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AuthTypeCallsList>'
