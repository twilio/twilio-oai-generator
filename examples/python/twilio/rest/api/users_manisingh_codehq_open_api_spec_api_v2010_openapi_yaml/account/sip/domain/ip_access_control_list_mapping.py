...
class IpAccessControlListMappingInstance(InstanceResource):
    ...
    def _proxy(self) -> "IpAccessControlListMappingContext":
        ...
        if self._context is None:
            self._context = IpAccessControlListMappingContext(self._version, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid'], sid=self._solution['sid'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.IpAccessControlListMappingInstance {}>'.format(context)
...
class IpAccessControlListMappingContext(InstanceContext):
    ...
    def fetch_with_http_info(self) -> ApiResponse:
        ...
        instance = IpAccessControlListMappingInstance(
            self._version,
            payload,
            account_sid=self._solution['account_sid'],
            domain_sid=self._solution['domain_sid'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.IpAccessControlListMappingContext {}>'.format(context)
...
class IpAccessControlListMappingPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.IpAccessControlListMappingPage>"
...
class IpAccessControlListMappingList(ListResource):
    ...
    def list(self, 
        ...
        return [IpAccessControlListMappingInstance(self._version, item, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid']) for item in payload["ip_access_control_list_mappings"]]
    ...
    def page(self, 
        ...
        return IpAccessControlListMappingPage(self._version, response, solution=self._solution)
    ...
    def page_with_http_info(self, 
        ...
        page = IpAccessControlListMappingPage(self._version, response, solution=self._solution)
    ...
    def create_with_http_info(self, ip_access_control_list_sid: str) -> ApiResponse:
        ...
        instance = IpAccessControlListMappingInstance(self._version, payload, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.IpAccessControlListMappingList>'
