...
class AuthCallsIpAccessControlListMappingInstance(InstanceResource):
    ...
    def _proxy(self) -> "AuthCallsIpAccessControlListMappingContext":
        ...
        if self._context is None:
            self._context = AuthCallsIpAccessControlListMappingContext(self._version, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid'], sid=self._solution['sid'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AuthCallsIpAccessControlListMappingInstance {}>'.format(context)
...
class AuthCallsIpAccessControlListMappingContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AuthCallsIpAccessControlListMappingContext {}>'.format(context)
...
class AuthCallsIpAccessControlListMappingPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AuthCallsIpAccessControlListMappingPage>"
...
class AuthCallsIpAccessControlListMappingList(ListResource):
    ...
    def list(self, 
        ...
        return [AuthCallsIpAccessControlListMappingInstance(self._version, item, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid']) for item in payload["contents"]]
    ...
    def page(self, 
        ...
        return AuthCallsIpAccessControlListMappingPage(self._version, response, solution=self._solution)
    ...
    def page_with_http_info(self, 
        ...
        page = AuthCallsIpAccessControlListMappingPage(self._version, response, solution=self._solution)
    ...
    def create(self, ip_access_control_list_sid: str) -> AuthCallsIpAccessControlListMappingInstance:
        ...
        """
        payload, _, _ = self._create(ip_access_control_list_sid=ip_access_control_list_sid)
        return AuthCallsIpAccessControlListMappingInstance(self._version, payload, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid'])
    ...
    def create_with_http_info(self, ip_access_control_list_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(ip_access_control_list_sid=ip_access_control_list_sid)
        instance = AuthCallsIpAccessControlListMappingInstance(self._version, payload, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    async def create_async(self, ip_access_control_list_sid: str) -> AuthCallsIpAccessControlListMappingInstance:
        ...
        :returns: The created AuthCallsIpAccessControlListMappingInstance
        """
        payload, _, _ = await self._create_async(ip_access_control_list_sid=ip_access_control_list_sid)
        return AuthCallsIpAccessControlListMappingInstance(self._version, payload, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid'])
    ...
    async def create_with_http_info_async(self, ip_access_control_list_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(ip_access_control_list_sid=ip_access_control_list_sid)
        instance = AuthCallsIpAccessControlListMappingInstance(self._version, payload, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def get(self, sid: str) -> AuthCallsIpAccessControlListMappingContext:
        ...
        :param sid: The Twilio-provided string that uniquely identifies the IpAccessControlListMapping resource to fetch.
        """
        return AuthCallsIpAccessControlListMappingContext(self._version, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid'], sid=sid)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AuthCallsIpAccessControlListMappingList>'
