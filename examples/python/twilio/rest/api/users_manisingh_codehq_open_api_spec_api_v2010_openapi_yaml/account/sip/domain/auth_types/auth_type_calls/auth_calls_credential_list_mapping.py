...
class AuthCallsCredentialListMappingInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AuthCallsCredentialListMappingInstance {}>'.format(context)
...
class AuthCallsCredentialListMappingContext(InstanceContext):
    ...
    def fetch_with_http_info(self) -> ApiResponse:
        ...
        instance = AuthCallsCredentialListMappingInstance(
            self._version,
            payload,
            account_sid=self._solution['account_sid'],
            domain_sid=self._solution['domain_sid'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AuthCallsCredentialListMappingContext {}>'.format(context)
...
class AuthCallsCredentialListMappingPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AuthCallsCredentialListMappingPage>"
...
class AuthCallsCredentialListMappingList(ListResource):
    ...
    def list(self, 
        ...
        return [AuthCallsCredentialListMappingInstance(self._version, item, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid']) for item in payload["contents"]]
    ...
    def page(self, 
        ...
        return AuthCallsCredentialListMappingPage(self._version, response, solution=self._solution)
    ...
    def page_with_http_info(self, 
        ...
        page = AuthCallsCredentialListMappingPage(self._version, response, solution=self._solution)
    ...
    def create_with_http_info(self, credential_list_sid: str) -> ApiResponse:
        ...
        instance = AuthCallsCredentialListMappingInstance(self._version, payload, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AuthCallsCredentialListMappingList>'
