...
class AuthRegistrationsCredentialListMappingInstance(InstanceResource):
    ...
    def _proxy(self) -> "AuthRegistrationsCredentialListMappingContext":
        ...
        if self._context is None:
            self._context = AuthRegistrationsCredentialListMappingContext(self._version, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid'], sid=self._solution['sid'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AuthRegistrationsCredentialListMappingInstance {}>'.format(context)
...
class AuthRegistrationsCredentialListMappingContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AuthRegistrationsCredentialListMappingContext {}>'.format(context)
...
class AuthRegistrationsCredentialListMappingPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AuthRegistrationsCredentialListMappingPage>"
...
class AuthRegistrationsCredentialListMappingList(ListResource):
    ...
    def list(self, 
        ...
        return [AuthRegistrationsCredentialListMappingInstance(self._version, item, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid']) for item in payload["contents"]]
    ...
    def page(self, 
        ...
        return AuthRegistrationsCredentialListMappingPage(self._version, response, solution=self._solution)
    ...
    def page_with_http_info(self, 
        ...
        page = AuthRegistrationsCredentialListMappingPage(self._version, response, solution=self._solution)
    ...
    def create_with_http_info(self, credential_list_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(credential_list_sid=credential_list_sid)
        instance = AuthRegistrationsCredentialListMappingInstance(self._version, payload, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    async def create_async(self, credential_list_sid: str) -> AuthRegistrationsCredentialListMappingInstance:
        ...
        :returns: The created AuthRegistrationsCredentialListMappingInstance
        """
        payload, _, _ = await self._create_async(credential_list_sid=credential_list_sid)
        return AuthRegistrationsCredentialListMappingInstance(self._version, payload, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid'])
    ...
    async def create_with_http_info_async(self, credential_list_sid: str) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(credential_list_sid=credential_list_sid)
        instance = AuthRegistrationsCredentialListMappingInstance(self._version, payload, account_sid=self._solution['account_sid'], domain_sid=self._solution['domain_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AuthRegistrationsCredentialListMappingList>'
