...
from twilio.rest.api.users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.account.sip.credential_list.credential import CredentialList
...
class CredentialListInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.CredentialListInstance {}>'.format(context)
...
class CredentialListContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.CredentialListContext {}>'.format(context)
...
class CredentialListPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.CredentialListPage>"
...
class CredentialListList(ListResource):
    ...
    def list(self, 
        ...
        return [CredentialListInstance(self._version, item, account_sid=self._solution['account_sid']) for item in payload["credential_lists"]]
    ...
    def create_with_http_info(self, friendly_name: str) -> ApiResponse:
        ...
        instance = CredentialListInstance(self._version, payload, account_sid=self._solution['account_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.CredentialListList>'
