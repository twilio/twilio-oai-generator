...
from twilio.rest.api.users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.account.sip.ip_access_control_list.ip_address import IpAddressList
...
class IpAccessControlListInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.IpAccessControlListInstance {}>'.format(context)
...
class IpAccessControlListContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.IpAccessControlListContext {}>'.format(context)
...
class IpAccessControlListPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.IpAccessControlListPage>"
...
class IpAccessControlListList(ListResource):
    ...
    def list(self, 
        ...
        return [IpAccessControlListInstance(self._version, item, account_sid=self._solution['account_sid']) for item in payload["ip_access_control_lists"]]
    ...
    def create_with_http_info(self, friendly_name: str) -> ApiResponse:
        ...
        instance = IpAccessControlListInstance(self._version, payload, account_sid=self._solution['account_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.IpAccessControlListList>'
