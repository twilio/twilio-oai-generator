...
class TranscriptionInstance(InstanceResource):
    ...
    def _proxy(self) -> "TranscriptionContext":
        ...
        if self._context is None:
            self._context = TranscriptionContext(self._version, account_sid=self._solution['account_sid'], call_sid=self._solution['call_sid'], sid=self._solution['sid'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.TranscriptionInstance {}>'.format(context)
...
class TranscriptionContext(InstanceContext):
    ...
    def __init__(self, version: Version, account_sid: str, call_sid: str, sid: str):
        ...
        self._uri = '/Accounts/{account_sid}/Calls/{call_sid}/Transcriptions/{sid}.json'.format(**self._solution)
    ...
    async def _update_async(self, status: "TranscriptionInstance.UpdateStatus") -> tuple:
        """
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.TranscriptionContext {}>'.format(context)
...
class TranscriptionList(ListResource):
    ...
    def __init__(self, version: Version, account_sid: str, call_sid: str):
        ...
        self._uri = '/Accounts/{account_sid}/Calls/{call_sid}/Transcriptions.json'.format(**self._solution)
    ...
    def list(self, 
        ...
        return [TranscriptionInstance(self._version, item, account_sid=self._solution['account_sid'], call_sid=self._solution['call_sid']) for item in payload[""]]
    ...
    def _create(self, name: Union[str, object]=values.unset, track: Union["TranscriptionInstance.Track", object]=values.unset, status_callback_url: Union[str, object]=values.unset, status_callback_method: Union[str, object]=values.unset, inbound_track_label: Union[str, object]=values.unset, outbound_track_label: Union[str, object]=values.unset, partial_results: Union[bool, object]=values.unset, language_code: Union[str, object]=values.unset, transcription_engine: Union[str, object]=values.unset, profanity_filter: Union[bool, object]=values.unset, speech_model: Union[str, object]=values.unset, hints: Union[str, object]=values.unset, enable_automatic_punctuation: Union[bool, object]=values.unset, intelligence_service: Union[str, object]=values.unset, conversation_configuration: Union[str, object]=values.unset, conversation_id: Union[str, object]=values.unset, transcription_configuration_id: Union[str, object]=values.unset, enable_provider_data: Union[bool, object]=values.unset) -> tuple:
        """
        ...
        data = values.of({ 
            ...
            'Hints': hints,
            'EnableAutomaticPunctuation': serialize.boolean_to_string(enable_automatic_punctuation),
    ...
    def create(self, name: Union[str, object]=values.unset, track: Union["TranscriptionInstance.Track", object]=values.unset, status_callback_url: Union[str, object]=values.unset, status_callback_method: Union[str, object]=values.unset, inbound_track_label: Union[str, object]=values.unset, outbound_track_label: Union[str, object]=values.unset, partial_results: Union[bool, object]=values.unset, language_code: Union[str, object]=values.unset, transcription_engine: Union[str, object]=values.unset, profanity_filter: Union[bool, object]=values.unset, speech_model: Union[str, object]=values.unset, hints: Union[str, object]=values.unset, enable_automatic_punctuation: Union[bool, object]=values.unset, intelligence_service: Union[str, object]=values.unset, conversation_configuration: Union[str, object]=values.unset, conversation_id: Union[str, object]=values.unset, transcription_configuration_id: Union[str, object]=values.unset, enable_provider_data: Union[bool, object]=values.unset) -> TranscriptionInstance:
        ...
        """
        payload, _, _ = self._create(name=name, track=track, status_callback_url=status_callback_url, status_callback_method=status_callback_method, inbound_track_label=inbound_track_label, outbound_track_label=outbound_track_label, partial_results=partial_results, language_code=language_code, transcription_engine=transcription_engine, profanity_filter=profanity_filter, speech_model=speech_model, hints=hints, enable_automatic_punctuation=enable_automatic_punctuation, intelligence_service=intelligence_service, conversation_configuration=conversation_configuration, conversation_id=conversation_id, transcription_configuration_id=transcription_configuration_id, enable_provider_data=enable_provider_data)
        return TranscriptionInstance(self._version, payload, account_sid=self._solution['account_sid'], call_sid=self._solution['call_sid'])

    def create_with_http_info(self, name: Union[str, object]=values.unset, track: Union["TranscriptionInstance.Track", object]=values.unset, status_callback_url: Union[str, object]=values.unset, status_callback_method: Union[str, object]=values.unset, inbound_track_label: Union[str, object]=values.unset, outbound_track_label: Union[str, object]=values.unset, partial_results: Union[bool, object]=values.unset, language_code: Union[str, object]=values.unset, transcription_engine: Union[str, object]=values.unset, profanity_filter: Union[bool, object]=values.unset, speech_model: Union[str, object]=values.unset, hints: Union[str, object]=values.unset, enable_automatic_punctuation: Union[bool, object]=values.unset, intelligence_service: Union[str, object]=values.unset, conversation_configuration: Union[str, object]=values.unset, conversation_id: Union[str, object]=values.unset, transcription_configuration_id: Union[str, object]=values.unset, enable_provider_data: Union[bool, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(name=name, track=track, status_callback_url=status_callback_url, status_callback_method=status_callback_method, inbound_track_label=inbound_track_label, outbound_track_label=outbound_track_label, partial_results=partial_results, language_code=language_code, transcription_engine=transcription_engine, profanity_filter=profanity_filter, speech_model=speech_model, hints=hints, enable_automatic_punctuation=enable_automatic_punctuation, intelligence_service=intelligence_service, conversation_configuration=conversation_configuration, conversation_id=conversation_id, transcription_configuration_id=transcription_configuration_id, enable_provider_data=enable_provider_data)
        instance = TranscriptionInstance(self._version, payload, account_sid=self._solution['account_sid'], call_sid=self._solution['call_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    async def create_async(self, name: Union[str, object]=values.unset, track: Union["TranscriptionInstance.Track", object]=values.unset, status_callback_url: Union[str, object]=values.unset, status_callback_method: Union[str, object]=values.unset, inbound_track_label: Union[str, object]=values.unset, outbound_track_label: Union[str, object]=values.unset, partial_results: Union[bool, object]=values.unset, language_code: Union[str, object]=values.unset, transcription_engine: Union[str, object]=values.unset, profanity_filter: Union[bool, object]=values.unset, speech_model: Union[str, object]=values.unset, hints: Union[str, object]=values.unset, enable_automatic_punctuation: Union[bool, object]=values.unset, intelligence_service: Union[str, object]=values.unset, conversation_configuration: Union[str, object]=values.unset, conversation_id: Union[str, object]=values.unset, transcription_configuration_id: Union[str, object]=values.unset, enable_provider_data: Union[bool, object]=values.unset) -> TranscriptionInstance:
        ...
        :returns: The created TranscriptionInstance
        """
        payload, _, _ = await self._create_async(name=name, track=track, status_callback_url=status_callback_url, status_callback_method=status_callback_method, inbound_track_label=inbound_track_label, outbound_track_label=outbound_track_label, partial_results=partial_results, language_code=language_code, transcription_engine=transcription_engine, profanity_filter=profanity_filter, speech_model=speech_model, hints=hints, enable_automatic_punctuation=enable_automatic_punctuation, intelligence_service=intelligence_service, conversation_configuration=conversation_configuration, conversation_id=conversation_id, transcription_configuration_id=transcription_configuration_id, enable_provider_data=enable_provider_data)
        return TranscriptionInstance(self._version, payload, account_sid=self._solution['account_sid'], call_sid=self._solution['call_sid'])
    ...
    async def create_with_http_info_async(self, name: Union[str, object]=values.unset, track: Union["TranscriptionInstance.Track", object]=values.unset, status_callback_url: Union[str, object]=values.unset, status_callback_method: Union[str, object]=values.unset, inbound_track_label: Union[str, object]=values.unset, outbound_track_label: Union[str, object]=values.unset, partial_results: Union[bool, object]=values.unset, language_code: Union[str, object]=values.unset, transcription_engine: Union[str, object]=values.unset, profanity_filter: Union[bool, object]=values.unset, speech_model: Union[str, object]=values.unset, hints: Union[str, object]=values.unset, enable_automatic_punctuation: Union[bool, object]=values.unset, intelligence_service: Union[str, object]=values.unset, conversation_configuration: Union[str, object]=values.unset, conversation_id: Union[str, object]=values.unset, transcription_configuration_id: Union[str, object]=values.unset, enable_provider_data: Union[bool, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(name=name, track=track, status_callback_url=status_callback_url, status_callback_method=status_callback_method, inbound_track_label=inbound_track_label, outbound_track_label=outbound_track_label, partial_results=partial_results, language_code=language_code, transcription_engine=transcription_engine, profanity_filter=profanity_filter, speech_model=speech_model, hints=hints, enable_automatic_punctuation=enable_automatic_punctuation, intelligence_service=intelligence_service, conversation_configuration=conversation_configuration, conversation_id=conversation_id, transcription_configuration_id=transcription_configuration_id, enable_provider_data=enable_provider_data)
        instance = TranscriptionInstance(self._version, payload, account_sid=self._solution['account_sid'], call_sid=self._solution['call_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def get(self, sid: str) -> TranscriptionContext:
        ...
        :param sid: The SID of the Transcription resource, or the `name` used when creating the resource
        """
        return TranscriptionContext(self._version, account_sid=self._solution['account_sid'], call_sid=self._solution['call_sid'], sid=sid)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.TranscriptionList>'
