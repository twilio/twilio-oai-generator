...
class UserDefinedMessageSubscriptionInstance(InstanceResource):
    ...
    def _proxy(self) -> "UserDefinedMessageSubscriptionContext":
        ...
        if self._context is None:
            self._context = UserDefinedMessageSubscriptionContext(self._version, account_sid=self._solution['account_sid'], call_sid=self._solution['call_sid'], sid=self._solution['sid'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.UserDefinedMessageSubscriptionInstance {}>'.format(context)
...
class UserDefinedMessageSubscriptionContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.UserDefinedMessageSubscriptionContext {}>'.format(context)
...
class UserDefinedMessageSubscriptionList(ListResource):
    ...
    def list(self, 
    ) -> List[UserDefinedMessageSubscriptionInstance]:
        """
        Lists UserDefinedMessageSubscriptionInstance records from the API as a list.
        ...
        return [UserDefinedMessageSubscriptionInstance(self._version, item, account_sid=self._solution['account_sid'], call_sid=self._solution['call_sid']) for item in payload[""]]
        

    async def list_async(self, 
    ) -> List[UserDefinedMessageSubscriptionInstance]:
        """
        Asynchronously lists UserDefinedMessageSubscriptionInstance records from the API as a list.
    ...
    def list_with_http_info(self, 
        ...
        """
        Lists UserDefinedMessageSubscriptionInstance and returns headers from first page
    ...
    async def list_with_http_info_async(self, 
        ...
        """
        Asynchronously lists UserDefinedMessageSubscriptionInstance and returns headers from first page
    ...
    def page(self, 
        ...
        """
        Retrieve a single page of UserDefinedMessageSubscriptionInstance records from the API.
        ...
        :returns: Page of UserDefinedMessageSubscriptionInstance
        """
        data = values.of({ 
        ...
        return UserDefinedMessageSubscriptionPage(self._version, response, solution=self._solution)
    ...
    async def page_async(self, 
        ...
        """
        Asynchronously retrieve a single page of UserDefinedMessageSubscriptionInstance records from the API.
        Request is executed immediately
    ...
    def page_with_http_info(self, 
        ...
        :returns: ApiResponse with UserDefinedMessageSubscriptionPage, status code, and headers
        """
        data = values.of({ 
            'PageToken': page_token,
            'Page': page_number,
        ...
        page = UserDefinedMessageSubscriptionPage(self._version, response, solution=self._solution)
    ...
    def get_page(self, target_url: str) -> UserDefinedMessageSubscriptionPage:
        """
        Retrieve a specific page of UserDefinedMessageSubscriptionInstance records from the API.
        Request is executed immediately
    ...
    async def get_page_async(self, target_url: str) -> UserDefinedMessageSubscriptionPage:
        """
        Asynchronously retrieve a specific page of UserDefinedMessageSubscriptionInstance records from the API.
        Request is executed immediately
    ...
    def _create(self, callback: str, idempotency_key: Union[str, object]=values.unset, method: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def create(self, callback: str, idempotency_key: Union[str, object]=values.unset, method: Union[str, object]=values.unset) -> UserDefinedMessageSubscriptionInstance:
        """
        ...
        """
        payload, _, _ = self._create(callback=callback, idempotency_key=idempotency_key, method=method)
    ...
    def create_with_http_info(self, callback: str, idempotency_key: Union[str, object]=values.unset, method: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        """
        payload, status_code, headers = self._create(callback=callback, idempotency_key=idempotency_key, method=method)
        instance = UserDefinedMessageSubscriptionInstance(self._version, payload, account_sid=self._solution['account_sid'], call_sid=self._solution['call_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, callback: str, idempotency_key: Union[str, object]=values.unset, method: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, callback: str, idempotency_key: Union[str, object]=values.unset, method: Union[str, object]=values.unset) -> UserDefinedMessageSubscriptionInstance:
        """
        ...
        :returns: The created UserDefinedMessageSubscriptionInstance
        """
        payload, _, _ = await self._create_async(callback=callback, idempotency_key=idempotency_key, method=method)
        return UserDefinedMessageSubscriptionInstance(self._version, payload, account_sid=self._solution['account_sid'], call_sid=self._solution['call_sid'])

    async def create_with_http_info_async(self, callback: str, idempotency_key: Union[str, object]=values.unset, method: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(callback=callback, idempotency_key=idempotency_key, method=method)
        instance = UserDefinedMessageSubscriptionInstance(self._version, payload, account_sid=self._solution['account_sid'], call_sid=self._solution['call_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.UserDefinedMessageSubscriptionList>'
