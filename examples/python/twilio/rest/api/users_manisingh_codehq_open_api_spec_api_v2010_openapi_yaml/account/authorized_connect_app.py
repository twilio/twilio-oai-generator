...
class AuthorizedConnectAppInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], account_sid: str, connect_app_sid: Optional[str] = None):
        ...
        self.connect_app_company_name: Optional[str] = payload.get("connect_app_company_name")
        self.connect_app_description: Optional[str] = payload.get("connect_app_description")
        self.connect_app_friendly_name: Optional[str] = payload.get("connect_app_friendly_name")
        self.connect_app_homepage_url: Optional[str] = payload.get("connect_app_homepage_url")
        self.connect_app_sid: Optional[str] = payload.get("connect_app_sid")
        self.permissions: Optional[List["AuthorizedConnectAppInstance.Permission"]] = payload.get("permissions")
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AuthorizedConnectAppInstance {}>'.format(context)
...
class AuthorizedConnectAppContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AuthorizedConnectAppContext {}>'.format(context)
...
class AuthorizedConnectAppPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AuthorizedConnectAppPage>"
...
class AuthorizedConnectAppList(ListResource):
    ...
    def list(self, 
        ...
        return [AuthorizedConnectAppInstance(self._version, item, account_sid=self._solution['account_sid']) for item in payload["authorized_connect_apps"]]
    ...
    def page(self, 
        ...
        return AuthorizedConnectAppPage(self._version, response, solution=self._solution)
    ...
    def page_with_http_info(self, 
        ...
        page = AuthorizedConnectAppPage(self._version, response, solution=self._solution)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.AuthorizedConnectAppList>'
