...
from twilio.rest.api.users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.account.message.feedback import FeedbackList
from twilio.rest.api.users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.account.message.media import MediaList
...
class MessageInstance(InstanceResource):
    ...
    def update_with_http_info(self, body: Union[str, object]=values.unset, status: Union["MessageInstance.UpdateStatus", object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(body=body, status=status, )

    async def update_with_http_info_async(self, body: Union[str, object]=values.unset, status: Union["MessageInstance.UpdateStatus", object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(body=body, status=status, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.MessageInstance {}>'.format(context)
...
class MessageContext(InstanceContext):
    ...
    def _update(self, body: Union[str, object]=values.unset, status: Union["MessageInstance.UpdateStatus", object]=values.unset) -> tuple:
        """
    ...
    async def _update_async(self, body: Union[str, object]=values.unset, status: Union["MessageInstance.UpdateStatus", object]=values.unset) -> tuple:
        """
    ...
    async def update_with_http_info_async(self, body: Union[str, object]=values.unset, status: Union["MessageInstance.UpdateStatus", object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._update_async(body=body, status=status)
        instance = MessageInstance(
            self._version,
            payload,
            account_sid=self._solution['account_sid'],
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.MessageContext {}>'.format(context)
...
class MessagePage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.MessagePage>"
...
class MessageList(ListResource):
    ...
    def list(self, 
        ...
        return [MessageInstance(self._version, item, account_sid=self._solution['account_sid']) for item in payload["messages"]]
    ...
    def _create(self, to: str, status_callback: Union[str, object]=values.unset, application_sid: Union[str, object]=values.unset, max_price: Union[float, object]=values.unset, provide_feedback: Union[bool, object]=values.unset, attempt: Union[int, object]=values.unset, validity_period: Union[int, object]=values.unset, max_rate: Union[str, object]=values.unset, force_delivery: Union[bool, object]=values.unset, provider_sid: Union[str, object]=values.unset, content_retention: Union["MessageInstance.ContentRetention", object]=values.unset, address_retention: Union["MessageInstance.AddressRetention", object]=values.unset, add_ons: Union[str, object]=values.unset, smart_encoded: Union[bool, object]=values.unset, persistent_action: Union[List[str], object]=values.unset, transient_action: Union[List[str], object]=values.unset, title: Union[str, object]=values.unset, interactive_data: Union[str, object]=values.unset, force_opt_in: Union[bool, object]=values.unset, rich_link_data: Union[str, object]=values.unset, traffic_type: Union["MessageInstance.TrafficType", object]=values.unset, shorten_urls: Union[bool, object]=values.unset, schedule_type: Union["MessageInstance.ScheduleType", object]=values.unset, send_at: Union[datetime, object]=values.unset, optimize_start_at: Union[datetime, object]=values.unset, optimize_end_at: Union[datetime, object]=values.unset, invoice_tag: Union[str, object]=values.unset, send_as_mms: Union[bool, object]=values.unset, content_variables: Union[str, object]=values.unset, message_intent: Union[str, object]=values.unset, dlt_pe_id: Union[str, object]=values.unset, dlt_template_id: Union[str, object]=values.unset, subject: Union[str, object]=values.unset, tags: Union[str, object]=values.unset, risk_check: Union["MessageInstance.RiskCheck", object]=values.unset, from_: Union[str, object]=values.unset, fallback_from: Union[str, object]=values.unset, messaging_service_sid: Union[str, object]=values.unset, body: Union[str, object]=values.unset, media_url: Union[List[str], object]=values.unset, content_sid: Union[str, object]=values.unset) -> tuple:
        ...
        data = values.of({ 
            ...
            'TransientAction': serialize.map(transient_action, lambda e: e),
            'Title': title,
    ...
    def create(self, to: str, status_callback: Union[str, object]=values.unset, application_sid: Union[str, object]=values.unset, max_price: Union[float, object]=values.unset, provide_feedback: Union[bool, object]=values.unset, attempt: Union[int, object]=values.unset, validity_period: Union[int, object]=values.unset, max_rate: Union[str, object]=values.unset, force_delivery: Union[bool, object]=values.unset, provider_sid: Union[str, object]=values.unset, content_retention: Union["MessageInstance.ContentRetention", object]=values.unset, address_retention: Union["MessageInstance.AddressRetention", object]=values.unset, add_ons: Union[str, object]=values.unset, smart_encoded: Union[bool, object]=values.unset, persistent_action: Union[List[str], object]=values.unset, transient_action: Union[List[str], object]=values.unset, title: Union[str, object]=values.unset, interactive_data: Union[str, object]=values.unset, force_opt_in: Union[bool, object]=values.unset, rich_link_data: Union[str, object]=values.unset, traffic_type: Union["MessageInstance.TrafficType", object]=values.unset, shorten_urls: Union[bool, object]=values.unset, schedule_type: Union["MessageInstance.ScheduleType", object]=values.unset, send_at: Union[datetime, object]=values.unset, optimize_start_at: Union[datetime, object]=values.unset, optimize_end_at: Union[datetime, object]=values.unset, invoice_tag: Union[str, object]=values.unset, send_as_mms: Union[bool, object]=values.unset, content_variables: Union[str, object]=values.unset, message_intent: Union[str, object]=values.unset, dlt_pe_id: Union[str, object]=values.unset, dlt_template_id: Union[str, object]=values.unset, subject: Union[str, object]=values.unset, tags: Union[str, object]=values.unset, risk_check: Union["MessageInstance.RiskCheck", object]=values.unset, from_: Union[str, object]=values.unset, fallback_from: Union[str, object]=values.unset, messaging_service_sid: Union[str, object]=values.unset, body: Union[str, object]=values.unset, media_url: Union[List[str], object]=values.unset, content_sid: Union[str, object]=values.unset) -> MessageInstance:
        ...
        :param transient_action: 
        :param title: 
        :param interactive_data: 
        :param force_opt_in: 
        :param rich_link_data: 
        :param traffic_type: 
        ...
        """
        payload, _, _ = self._create(to=to, status_callback=status_callback, application_sid=application_sid, max_price=max_price, provide_feedback=provide_feedback, attempt=attempt, validity_period=validity_period, max_rate=max_rate, force_delivery=force_delivery, provider_sid=provider_sid, content_retention=content_retention, address_retention=address_retention, add_ons=add_ons, smart_encoded=smart_encoded, persistent_action=persistent_action, transient_action=transient_action, title=title, interactive_data=interactive_data, force_opt_in=force_opt_in, rich_link_data=rich_link_data, traffic_type=traffic_type, shorten_urls=shorten_urls, schedule_type=schedule_type, send_at=send_at, optimize_start_at=optimize_start_at, optimize_end_at=optimize_end_at, invoice_tag=invoice_tag, send_as_mms=send_as_mms, content_variables=content_variables, message_intent=message_intent, dlt_pe_id=dlt_pe_id, dlt_template_id=dlt_template_id, subject=subject, tags=tags, risk_check=risk_check, from_=from_, fallback_from=fallback_from, messaging_service_sid=messaging_service_sid, body=body, media_url=media_url, content_sid=content_sid)
        return MessageInstance(self._version, payload, account_sid=self._solution['account_sid'])
    ...
    def create_with_http_info(self, to: str, status_callback: Union[str, object]=values.unset, application_sid: Union[str, object]=values.unset, max_price: Union[float, object]=values.unset, provide_feedback: Union[bool, object]=values.unset, attempt: Union[int, object]=values.unset, validity_period: Union[int, object]=values.unset, max_rate: Union[str, object]=values.unset, force_delivery: Union[bool, object]=values.unset, provider_sid: Union[str, object]=values.unset, content_retention: Union["MessageInstance.ContentRetention", object]=values.unset, address_retention: Union["MessageInstance.AddressRetention", object]=values.unset, add_ons: Union[str, object]=values.unset, smart_encoded: Union[bool, object]=values.unset, persistent_action: Union[List[str], object]=values.unset, transient_action: Union[List[str], object]=values.unset, title: Union[str, object]=values.unset, interactive_data: Union[str, object]=values.unset, force_opt_in: Union[bool, object]=values.unset, rich_link_data: Union[str, object]=values.unset, traffic_type: Union["MessageInstance.TrafficType", object]=values.unset, shorten_urls: Union[bool, object]=values.unset, schedule_type: Union["MessageInstance.ScheduleType", object]=values.unset, send_at: Union[datetime, object]=values.unset, optimize_start_at: Union[datetime, object]=values.unset, optimize_end_at: Union[datetime, object]=values.unset, invoice_tag: Union[str, object]=values.unset, send_as_mms: Union[bool, object]=values.unset, content_variables: Union[str, object]=values.unset, message_intent: Union[str, object]=values.unset, dlt_pe_id: Union[str, object]=values.unset, dlt_template_id: Union[str, object]=values.unset, subject: Union[str, object]=values.unset, tags: Union[str, object]=values.unset, risk_check: Union["MessageInstance.RiskCheck", object]=values.unset, from_: Union[str, object]=values.unset, fallback_from: Union[str, object]=values.unset, messaging_service_sid: Union[str, object]=values.unset, body: Union[str, object]=values.unset, media_url: Union[List[str], object]=values.unset, content_sid: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = self._create(to=to, status_callback=status_callback, application_sid=application_sid, max_price=max_price, provide_feedback=provide_feedback, attempt=attempt, validity_period=validity_period, max_rate=max_rate, force_delivery=force_delivery, provider_sid=provider_sid, content_retention=content_retention, address_retention=address_retention, add_ons=add_ons, smart_encoded=smart_encoded, persistent_action=persistent_action, transient_action=transient_action, title=title, interactive_data=interactive_data, force_opt_in=force_opt_in, rich_link_data=rich_link_data, traffic_type=traffic_type, shorten_urls=shorten_urls, schedule_type=schedule_type, send_at=send_at, optimize_start_at=optimize_start_at, optimize_end_at=optimize_end_at, invoice_tag=invoice_tag, send_as_mms=send_as_mms, content_variables=content_variables, message_intent=message_intent, dlt_pe_id=dlt_pe_id, dlt_template_id=dlt_template_id, subject=subject, tags=tags, risk_check=risk_check, from_=from_, fallback_from=fallback_from, messaging_service_sid=messaging_service_sid, body=body, media_url=media_url, content_sid=content_sid)
    ...
    async def create_async(self, to: str, status_callback: Union[str, object]=values.unset, application_sid: Union[str, object]=values.unset, max_price: Union[float, object]=values.unset, provide_feedback: Union[bool, object]=values.unset, attempt: Union[int, object]=values.unset, validity_period: Union[int, object]=values.unset, max_rate: Union[str, object]=values.unset, force_delivery: Union[bool, object]=values.unset, provider_sid: Union[str, object]=values.unset, content_retention: Union["MessageInstance.ContentRetention", object]=values.unset, address_retention: Union["MessageInstance.AddressRetention", object]=values.unset, add_ons: Union[str, object]=values.unset, smart_encoded: Union[bool, object]=values.unset, persistent_action: Union[List[str], object]=values.unset, transient_action: Union[List[str], object]=values.unset, title: Union[str, object]=values.unset, interactive_data: Union[str, object]=values.unset, force_opt_in: Union[bool, object]=values.unset, rich_link_data: Union[str, object]=values.unset, traffic_type: Union["MessageInstance.TrafficType", object]=values.unset, shorten_urls: Union[bool, object]=values.unset, schedule_type: Union["MessageInstance.ScheduleType", object]=values.unset, send_at: Union[datetime, object]=values.unset, optimize_start_at: Union[datetime, object]=values.unset, optimize_end_at: Union[datetime, object]=values.unset, invoice_tag: Union[str, object]=values.unset, send_as_mms: Union[bool, object]=values.unset, content_variables: Union[str, object]=values.unset, message_intent: Union[str, object]=values.unset, dlt_pe_id: Union[str, object]=values.unset, dlt_template_id: Union[str, object]=values.unset, subject: Union[str, object]=values.unset, tags: Union[str, object]=values.unset, risk_check: Union["MessageInstance.RiskCheck", object]=values.unset, from_: Union[str, object]=values.unset, fallback_from: Union[str, object]=values.unset, messaging_service_sid: Union[str, object]=values.unset, body: Union[str, object]=values.unset, media_url: Union[List[str], object]=values.unset, content_sid: Union[str, object]=values.unset) -> MessageInstance:
        ...
        :returns: The created MessageInstance
        """
        payload, _, _ = await self._create_async(to=to, status_callback=status_callback, application_sid=application_sid, max_price=max_price, provide_feedback=provide_feedback, attempt=attempt, validity_period=validity_period, max_rate=max_rate, force_delivery=force_delivery, provider_sid=provider_sid, content_retention=content_retention, address_retention=address_retention, add_ons=add_ons, smart_encoded=smart_encoded, persistent_action=persistent_action, transient_action=transient_action, title=title, interactive_data=interactive_data, force_opt_in=force_opt_in, rich_link_data=rich_link_data, traffic_type=traffic_type, shorten_urls=shorten_urls, schedule_type=schedule_type, send_at=send_at, optimize_start_at=optimize_start_at, optimize_end_at=optimize_end_at, invoice_tag=invoice_tag, send_as_mms=send_as_mms, content_variables=content_variables, message_intent=message_intent, dlt_pe_id=dlt_pe_id, dlt_template_id=dlt_template_id, subject=subject, tags=tags, risk_check=risk_check, from_=from_, fallback_from=fallback_from, messaging_service_sid=messaging_service_sid, body=body, media_url=media_url, content_sid=content_sid)
        return MessageInstance(self._version, payload, account_sid=self._solution['account_sid'])
    ...
    async def create_with_http_info_async(self, to: str, status_callback: Union[str, object]=values.unset, application_sid: Union[str, object]=values.unset, max_price: Union[float, object]=values.unset, provide_feedback: Union[bool, object]=values.unset, attempt: Union[int, object]=values.unset, validity_period: Union[int, object]=values.unset, max_rate: Union[str, object]=values.unset, force_delivery: Union[bool, object]=values.unset, provider_sid: Union[str, object]=values.unset, content_retention: Union["MessageInstance.ContentRetention", object]=values.unset, address_retention: Union["MessageInstance.AddressRetention", object]=values.unset, add_ons: Union[str, object]=values.unset, smart_encoded: Union[bool, object]=values.unset, persistent_action: Union[List[str], object]=values.unset, transient_action: Union[List[str], object]=values.unset, title: Union[str, object]=values.unset, interactive_data: Union[str, object]=values.unset, force_opt_in: Union[bool, object]=values.unset, rich_link_data: Union[str, object]=values.unset, traffic_type: Union["MessageInstance.TrafficType", object]=values.unset, shorten_urls: Union[bool, object]=values.unset, schedule_type: Union["MessageInstance.ScheduleType", object]=values.unset, send_at: Union[datetime, object]=values.unset, optimize_start_at: Union[datetime, object]=values.unset, optimize_end_at: Union[datetime, object]=values.unset, invoice_tag: Union[str, object]=values.unset, send_as_mms: Union[bool, object]=values.unset, content_variables: Union[str, object]=values.unset, message_intent: Union[str, object]=values.unset, dlt_pe_id: Union[str, object]=values.unset, dlt_template_id: Union[str, object]=values.unset, subject: Union[str, object]=values.unset, tags: Union[str, object]=values.unset, risk_check: Union["MessageInstance.RiskCheck", object]=values.unset, from_: Union[str, object]=values.unset, fallback_from: Union[str, object]=values.unset, messaging_service_sid: Union[str, object]=values.unset, body: Union[str, object]=values.unset, media_url: Union[List[str], object]=values.unset, content_sid: Union[str, object]=values.unset) -> ApiResponse:
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(to=to, status_callback=status_callback, application_sid=application_sid, max_price=max_price, provide_feedback=provide_feedback, attempt=attempt, validity_period=validity_period, max_rate=max_rate, force_delivery=force_delivery, provider_sid=provider_sid, content_retention=content_retention, address_retention=address_retention, add_ons=add_ons, smart_encoded=smart_encoded, persistent_action=persistent_action, transient_action=transient_action, title=title, interactive_data=interactive_data, force_opt_in=force_opt_in, rich_link_data=rich_link_data, traffic_type=traffic_type, shorten_urls=shorten_urls, schedule_type=schedule_type, send_at=send_at, optimize_start_at=optimize_start_at, optimize_end_at=optimize_end_at, invoice_tag=invoice_tag, send_as_mms=send_as_mms, content_variables=content_variables, message_intent=message_intent, dlt_pe_id=dlt_pe_id, dlt_template_id=dlt_template_id, subject=subject, tags=tags, risk_check=risk_check, from_=from_, fallback_from=fallback_from, messaging_service_sid=messaging_service_sid, body=body, media_url=media_url, content_sid=content_sid)
        instance = MessageInstance(self._version, payload, account_sid=self._solution['account_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.MessageList>'
