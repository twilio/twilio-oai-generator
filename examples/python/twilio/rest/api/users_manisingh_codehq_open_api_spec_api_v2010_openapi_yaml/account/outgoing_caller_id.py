...
class OutgoingCallerIdInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.OutgoingCallerIdInstance {}>'.format(context)
...
class OutgoingCallerIdContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.OutgoingCallerIdContext {}>'.format(context)
...
class OutgoingCallerIdPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.OutgoingCallerIdPage>"
...
class OutgoingCallerIdList(ListResource):
    ...
    def list(self, 
        ...
        return [OutgoingCallerIdInstance(self._version, item, account_sid=self._solution['account_sid']) for item in payload["outgoing_caller_ids"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.OutgoingCallerIdList>'
