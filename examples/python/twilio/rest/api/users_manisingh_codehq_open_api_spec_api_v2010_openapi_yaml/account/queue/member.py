...
class MemberInstance(InstanceResource):
    ...
    def update_with_http_info(self, url: str, method: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return self._proxy.update_with_http_info(url=url, method=method, )

    async def update_with_http_info_async(self, url: str, method: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        return await self._proxy.update_with_http_info_async(url=url, method=method, )
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.MemberInstance {}>'.format(context)
...
class MemberContext(InstanceContext):
    ...
    async def _update_async(self, url: str, method: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.MemberContext {}>'.format(context)
...
class MemberPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.MemberPage>"
...
class MemberList(ListResource):
    ...
    def list(self, 
        ...
        return [MemberInstance(self._version, item, account_sid=self._solution['account_sid'], queue_sid=self._solution['queue_sid']) for item in payload["queue_members"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.MemberList>'
