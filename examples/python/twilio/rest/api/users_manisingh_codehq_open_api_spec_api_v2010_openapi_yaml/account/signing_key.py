...
class SigningKeyInstance(InstanceResource):
    ...
    async def update_async(self, friendly_name: Union[str, object]=values.unset) -> "SigningKeyInstance":
        """
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.SigningKeyInstance {}>'.format(context)
...
class SigningKeyContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.SigningKeyContext {}>'.format(context)
...
class SigningKeyPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.SigningKeyPage>"
...
class SigningKeyList(ListResource):
    ...
    def list(self, 
        ...
        return [SigningKeyInstance(self._version, item, account_sid=self._solution['account_sid']) for item in payload["signing_keys"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.SigningKeyList>'
