...
class ValidationRequestInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.ValidationRequestInstance {}>'.format(context)
...
class ValidationRequestList(ListResource):
    ...
    def _create(self, phone_number: str, friendly_name: Union[str, object]=values.unset, call_delay: Union[int, object]=values.unset, extension: Union[str, object]=values.unset, status_callback: Union[str, object]=values.unset, status_callback_method: Union[str, object]=values.unset) -> tuple:
        """
    ...
    def create(self, phone_number: str, friendly_name: Union[str, object]=values.unset, call_delay: Union[int, object]=values.unset, extension: Union[str, object]=values.unset, status_callback: Union[str, object]=values.unset, status_callback_method: Union[str, object]=values.unset) -> ValidationRequestInstance:
        ...
        """
        payload, _, _ = self._create(phone_number=phone_number, friendly_name=friendly_name, call_delay=call_delay, extension=extension, status_callback=status_callback, status_callback_method=status_callback_method)
        return ValidationRequestInstance(self._version, payload, account_sid=self._solution['account_sid'])

    def create_with_http_info(self, phone_number: str, friendly_name: Union[str, object]=values.unset, call_delay: Union[int, object]=values.unset, extension: Union[str, object]=values.unset, status_callback: Union[str, object]=values.unset, status_callback_method: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        """
        payload, status_code, headers = self._create(phone_number=phone_number, friendly_name=friendly_name, call_delay=call_delay, extension=extension, status_callback=status_callback, status_callback_method=status_callback_method)
        instance = ValidationRequestInstance(self._version, payload, account_sid=self._solution['account_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)

    async def _create_async(self, phone_number: str, friendly_name: Union[str, object]=values.unset, call_delay: Union[int, object]=values.unset, extension: Union[str, object]=values.unset, status_callback: Union[str, object]=values.unset, status_callback_method: Union[str, object]=values.unset) -> tuple:
        """
    ...
    async def create_async(self, phone_number: str, friendly_name: Union[str, object]=values.unset, call_delay: Union[int, object]=values.unset, extension: Union[str, object]=values.unset, status_callback: Union[str, object]=values.unset, status_callback_method: Union[str, object]=values.unset) -> ValidationRequestInstance:
        ...
        :returns: The created ValidationRequestInstance
        """
        payload, _, _ = await self._create_async(phone_number=phone_number, friendly_name=friendly_name, call_delay=call_delay, extension=extension, status_callback=status_callback, status_callback_method=status_callback_method)
        return ValidationRequestInstance(self._version, payload, account_sid=self._solution['account_sid'])

    async def create_with_http_info_async(self, phone_number: str, friendly_name: Union[str, object]=values.unset, call_delay: Union[int, object]=values.unset, extension: Union[str, object]=values.unset, status_callback: Union[str, object]=values.unset, status_callback_method: Union[str, object]=values.unset) -> ApiResponse:
        """
        ...
        :returns: ApiResponse with instance, status code, and headers
        """
        payload, status_code, headers = await self._create_async(phone_number=phone_number, friendly_name=friendly_name, call_delay=call_delay, extension=extension, status_callback=status_callback, status_callback_method=status_callback_method)
        instance = ValidationRequestInstance(self._version, payload, account_sid=self._solution['account_sid'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_v2010_openapi_yaml.ValidationRequestList>'
