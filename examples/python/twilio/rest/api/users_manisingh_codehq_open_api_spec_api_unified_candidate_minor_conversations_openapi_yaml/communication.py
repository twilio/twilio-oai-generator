...
class CommunicationInstance(InstanceResource):
    ...
    :ivar occurred_at: ISO 8601 timestamp when the communication occurred.
    """
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], conversation_id: str, id: Optional[str] = None):
        ...
        self.resource_id: Optional[str] = payload.get("resourceId")
    ...
    def _proxy(self) -> "CommunicationContext":
        ...
        if self._context is None:
            self._context = CommunicationContext(self._version, conversation_id=self._solution['conversation_id'], id=self._solution['id'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_unified_candidate_minor_conversations_openapi_yaml.CommunicationInstance {}>'.format(context)
...
class CommunicationContext(InstanceContext):
    ...
    def __init__(self, version: Version, conversation_id: str, id: str):
        ...
        self._uri = '/{conversation_id}/Communications/{id}'.format(**self._solution)
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_unified_candidate_minor_conversations_openapi_yaml.CommunicationContext {}>'.format(context)
...
class CommunicationPage(TokenPagination):
    ...
    def get_instance(self, payload: Dict[str, Any]) -> CommunicationInstance:
        ...
        return CommunicationInstance(self._version, payload, conversation_id=self._solution["conversation_id"])
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_unified_candidate_minor_conversations_openapi_yaml.CommunicationPage>"
...
class CommunicationList(ListResource):
    ...
    class ConversationsV2ContentTranscriptionTranscriptionWords(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.start_time: Optional[datetime] = payload.get("startTime")
            self.end_time: Optional[datetime] = payload.get("endTime")
    ...
    def __init__(self, version: Version, conversation_id: str):
        ...
        self._uri = '/{conversation_id}/Communications'.format(**self._solution)
    ...
    def create_with_http_info(self, create_communication_in_conversation_request: Union[CreateCommunicationInConversationRequest, object]=values.unset) -> ApiResponse:
        ...
        instance = CommunicationInstance(self._version, payload, conversation_id=self._solution['conversation_id'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def page(self, 
      ...
      page_token: Union[str, object] = values.unset,
        ...
        return CommunicationPage(self._version, response, uri=self._uri, params=data, solution=self._solution)
    ...
    def page_with_http_info(self, 
        ...
        page = CommunicationPage(self._version, response, uri=self._uri, solution=self._solution)
    ...
    async def page_with_http_info_async(self, 
        ...
        page = CommunicationPage(self._version, response, solution=self._solution)
        return ApiResponse(data=page, status_code=status_code, headers=response_headers)
    ...
    def get(self, id: str) -> CommunicationContext:
        ...
        :param id: 
        """
        return CommunicationContext(self._version, conversation_id=self._solution['conversation_id'], id=id)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_unified_candidate_minor_conversations_openapi_yaml.CommunicationList>'
