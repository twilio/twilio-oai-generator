...
class Users_manisingh_codehq_open_api_spec_api_unified_candidate_major_intelligence_openapi_yaml(Version):

    def __init__(self, domain: Domain):
        """
        Initialize the Users_manisingh_codehq_open_api_spec_api_unified_candidate_major_intelligence_openapi_yaml version of Api
    ...
    def __repr__(self) -> str:
        ...
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_unified_candidate_major_intelligence_openapi_yaml>"
