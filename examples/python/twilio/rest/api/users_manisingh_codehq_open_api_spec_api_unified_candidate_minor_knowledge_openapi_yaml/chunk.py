...
class ChunkInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload:Dict[str, Any], kb_id: str, knowledge_id: str):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_unified_candidate_minor_knowledge_openapi_yaml.ChunkInstance {}>'.format(context)
...
class ChunkPage(TokenPagination):
    ...
    def get_instance(self, payload: Dict[str, Any]) -> ChunkInstance:
        ...
        return ChunkInstance(self._version, payload, kb_id=self._solution["kb_id"], knowledge_id=self._solution["knowledge_id"])
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_unified_candidate_minor_knowledge_openapi_yaml.ChunkPage>"
...
class ChunkList(ListResource):
    ...
    def __init__(self, version: Version, kb_id: str, knowledge_id: str):
        ...
        self._uri = '/{kb_id}/KnowledgeSources/{knowledge_id}/Chunks'.format(**self._solution)
    ...
    def page(self, 
      ...
      page_token: Union[str, object] = values.unset,
        ...
        return ChunkPage(self._version, response, uri=self._uri, params=data, solution=self._solution)
    ...
    def page_with_http_info(self, 
        ...
        page = ChunkPage(self._version, response, uri=self._uri, solution=self._solution)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_unified_candidate_minor_knowledge_openapi_yaml.ChunkList>'
