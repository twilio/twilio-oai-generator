...
class SearchInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_unified_candidate_minor_knowledge_openapi_yaml.SearchInstance {}>'.format(context)
...
class SearchList(ListResource):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Api.Users_manisingh_codehq_open_api_spec_api_unified_candidate_minor_knowledge_openapi_yaml.SearchList>'
