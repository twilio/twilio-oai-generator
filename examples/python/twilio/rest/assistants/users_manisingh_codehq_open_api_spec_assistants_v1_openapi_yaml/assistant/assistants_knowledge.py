...
class AssistantsKnowledgeInstance(InstanceResource):
    ...
    def _proxy(self) -> "AssistantsKnowledgeContext":
        ...
        if self._context is None:
            self._context = AssistantsKnowledgeContext(self._version, assistant_id=self._solution['assistant_id'], id=self._solution['id'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Assistants.Users_manisingh_codehq_open_api_spec_assistants_v1_openapi_yaml.AssistantsKnowledgeInstance {}>'.format(context)
...
class AssistantsKnowledgeContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Assistants.Users_manisingh_codehq_open_api_spec_assistants_v1_openapi_yaml.AssistantsKnowledgeContext {}>'.format(context)
...
class AssistantsKnowledgePage(Page):
    ...
    def get_instance(self, payload: Dict[str, Any]) -> AssistantsKnowledgeInstance:
        ...
        return AssistantsKnowledgeInstance(self._version, payload, assistant_id=self._solution["assistant_id"])
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Assistants.Users_manisingh_codehq_open_api_spec_assistants_v1_openapi_yaml.AssistantsKnowledgePage>"
...
class AssistantsKnowledgeList(ListResource):
    ...
    def __init__(self, version: Version, assistant_id: str):
        ...
        # Path Solution
        self._solution = { 'assistant_id': assistant_id,  }
    ...
    def create_with_http_info(self) -> ApiResponse:
        ...
        """
        payload, status_code, headers = self._create()
        instance = AssistantsKnowledgeInstance(self._version, payload, assistant_id=self._solution['assistant_id'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def list(self, 
        ...
        return [AssistantsKnowledgeInstance(self._version, item, assistant_id=self._solution['assistant_id']) for item in payload["knowledge"]]
    ...
    def get(self, id: str) -> AssistantsKnowledgeContext:
        ...
        :param id: knowledge id
        """
        return AssistantsKnowledgeContext(self._version, assistant_id=self._solution['assistant_id'], id=id)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Assistants.Users_manisingh_codehq_open_api_spec_assistants_v1_openapi_yaml.AssistantsKnowledgeList>'
