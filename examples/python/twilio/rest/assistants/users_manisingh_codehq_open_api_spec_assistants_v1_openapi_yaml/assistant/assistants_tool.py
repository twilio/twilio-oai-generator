...
class AssistantsToolInstance(InstanceResource):
    ...
    def _proxy(self) -> "AssistantsToolContext":
        ...
        if self._context is None:
            self._context = AssistantsToolContext(self._version, assistant_id=self._solution['assistant_id'], id=self._solution['id'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Assistants.Users_manisingh_codehq_open_api_spec_assistants_v1_openapi_yaml.AssistantsToolInstance {}>'.format(context)
...
class AssistantsToolContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Assistants.Users_manisingh_codehq_open_api_spec_assistants_v1_openapi_yaml.AssistantsToolContext {}>'.format(context)
...
class AssistantsToolPage(Page):
    ...
    def get_instance(self, payload: Dict[str, Any]) -> AssistantsToolInstance:
        ...
        return AssistantsToolInstance(self._version, payload, assistant_id=self._solution["assistant_id"])
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Assistants.Users_manisingh_codehq_open_api_spec_assistants_v1_openapi_yaml.AssistantsToolPage>"
...
class AssistantsToolList(ListResource):
    ...
    def create_with_http_info(self) -> ApiResponse:
        ...
        """
        payload, status_code, headers = self._create()
        instance = AssistantsToolInstance(self._version, payload, assistant_id=self._solution['assistant_id'])
        return ApiResponse(data=instance, status_code=status_code, headers=headers)
    ...
    def list(self, 
        ...
        return [AssistantsToolInstance(self._version, item, assistant_id=self._solution['assistant_id']) for item in payload["tools"]]
    ...
    def get(self, id: str) -> AssistantsToolContext:
        ...
        :param id: tool id
        """
        return AssistantsToolContext(self._version, assistant_id=self._solution['assistant_id'], id=id)
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Assistants.Users_manisingh_codehq_open_api_spec_assistants_v1_openapi_yaml.AssistantsToolList>'
