...
class ChunkInstance(InstanceResource):
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Assistants.Users_manisingh_codehq_open_api_spec_assistants_v1_openapi_yaml.ChunkInstance {}>'.format(context)
...
class ChunkPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Assistants.Users_manisingh_codehq_open_api_spec_assistants_v1_openapi_yaml.ChunkPage>"
...
class ChunkList(ListResource):
    ...
    def list(self, 
        ...
        return [ChunkInstance(self._version, item, id=self._solution['id']) for item in payload["chunks"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Assistants.Users_manisingh_codehq_open_api_spec_assistants_v1_openapi_yaml.ChunkList>'
