...
class MessagePage(Page):
    ...
    def get_instance(self, payload: Dict[str, Any]) -> MessageInstance:
        ...
        return MessageInstance(self._version, payload, session_id=self._solution["session_id"])
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Assistants.Users_manisingh_codehq_open_api_spec_assistants_v1_openapi_yaml.MessagePage>"
...
class MessageList(ListResource):
    ...
    def __init__(self, version: Version, session_id: str):
        ...
        # Path Solution
        self._solution = { 'session_id': session_id,  }
    ...
    def list(self, 
        ...
        return [MessageInstance(self._version, item, session_id=self._solution['session_id']) for item in payload["messages"]]
