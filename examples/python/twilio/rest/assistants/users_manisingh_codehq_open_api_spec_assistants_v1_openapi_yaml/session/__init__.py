...
from twilio.rest.assistants.users_manisingh_codehq_open_api_spec_assistants_v1_openapi_yaml.session.message import MessageList
...
class SessionInstance(InstanceResource):
    ...
    def _proxy(self) -> "SessionContext":
        ...
        if self._context is None:
            self._context = SessionContext(self._version, id=self._solution['id'],)
    ...
    def __repr__(self) -> str:
        ...
        return '<Twilio.Assistants.Users_manisingh_codehq_open_api_spec_assistants_v1_openapi_yaml.SessionInstance {}>'.format(context)
...
class SessionContext(InstanceContext):
    ...
    def __repr__(self) -> str:
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.Assistants.Users_manisingh_codehq_open_api_spec_assistants_v1_openapi_yaml.SessionContext {}>'.format(context)
...
class SessionPage(Page):
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return "<Twilio.Assistants.Users_manisingh_codehq_open_api_spec_assistants_v1_openapi_yaml.SessionPage>"
...
class SessionList(ListResource):
    ...
    def list(self, 
        ...
        return [SessionInstance(self._version, item) for item in payload["sessions"]]
    ...
    def __repr__(self) -> str:
        ...
        :returns: Machine friendly representation
        """
        return '<Twilio.Assistants.Users_manisingh_codehq_open_api_spec_assistants_v1_openapi_yaml.SessionList>'
