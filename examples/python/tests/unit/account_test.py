...
class AccountTests(unittest.TestCase):
    ...
    def test_create_account(self, mock_request):
        ...
        mock_request.assert_called_once_with(
            "POST", "http://api.twilio.com/2010-04-01/Accounts.json", **request_args
        )

    def test_account_shortcut(self, mock_request):
        mock_request.return_value = Response(201, '{"sid": "123"}')

        self.client.api.v2010.account.calls.create(
            required_string_property="phone home", test_method="post"
        )
        request_args = self.generic_request_args
        request_args["data"] = {
        ...
        mock_request.assert_called_once_with(
            "POST",
            f"http://api.twilio.com/2010-04-01/Accounts/{self.sid}/Calls.json",
            **request_args,
        )
    ...
    def test_fetch_account(self, mock_request):
        ...
        mock_request.assert_called_once_with(
            "GET", "http://api.twilio.com/2010-04-01/Accounts/123.json", **request_args
        )

    def test_update_account(self, mock_request):
        mock_request.return_value = Response(
            200, '{"account_sid": "123", "status": "stopped"}'
        )
        ...
        mock_request.assert_called_once_with(
            "POST", "http://api.twilio.com/2010-04-01/Accounts/123.json", **request_args
        )
    ...
    def test_remove_account(self, mock_request):
        ...
        mock_request.assert_called_once_with(
            "DELETE",
            "http://api.twilio.com/2010-04-01/Accounts/123.json",
            **request_args,
        )
    ...
    def test_get_account_page_in_between_dates(self, mock_request):
        ...
        result = self.client.api.v2010.accounts.page(
            date_test=datetime.date(2022, 6, 1),
        ...
        mock_request.assert_called_once_with(
            "GET", "http://api.twilio.com/2010-04-01/Accounts.json", **request_args
        )
...
class AsyncAccountTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_async_account_shortcut(self, mock_request):
        ...
        await self.client.api.v2010.account.calls.create_async(
            required_string_property="phone home", test_method="post"
        )
        request_args = self.generic_request_args
        request_args["data"] = {
