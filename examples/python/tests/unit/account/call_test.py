...
class AccountCallTests(unittest.TestCase):
    ...
    def test_create_call(self, mock_request):
        ...
        self.client.api.v2010.accounts("123").calls.create(
        ...
        mock_request.assert_called_once_with(
            "POST",
            "http://api.twilio.com/2010-04-01/Accounts/123/Calls.json",
            **request_args
        )
    ...
    def test_fetch_call(self, mock_request):
        ...
        mock_request.assert_called_once_with(
            "GET",
            "http://api.twilio.com/2010-04-01/Accounts/123/Calls/1.json",
            **request_args
        )
    ...
    def test_create_feedback_summary(self, mock_request):
        mock_request.return_value = Response(
            201, '{"account_sid": "123", "test_array": [{"count": "4"}]}'
        )

        self.client.api.v2010.accounts("123").calls.feedback_call_summary("456").update(
            account_sid="other_account", start_date="2023-02-10", end_date="2023-02-10"
        )
        request_args = self.generic_request_args
        request_args["data"] = {
...
class AsyncAccountCallTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_async_create_call(self, mock_request):
        ...
        await self.client.api.v2010.accounts("123").calls.create_async(
            required_string_property="phone home", test_method="post"
        )
        request_args = self.generic_request_args
        request_args["data"] = {
    ...
    async def test_async_create_feedback_summary(self, mock_request):
        ...
        await self.client.api.v2010.accounts("123").calls.feedback_call_summary(
            "456"
        ).update_async(
            account_sid="other_account", start_date="2023-02-10", end_date="2023-02-10"
        )
