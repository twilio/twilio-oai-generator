...
export interface NewCredentialsListInstance {
   ...
   */
  createWithHttpInfo(params: NewCredentialsListInstanceCreateOptions, callback?: (error: Error | null, item?: ApiResponse<NewCredentialsInstance>) => any): Promise<ApiResponse<NewCredentialsInstance>>;
...
export function NewCredentialsListInstance(version: V1): NewCredentialsListInstance {
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(params: NewCredentialsListInstanceCreateOptions, callback?: (error: Error | null, items: ApiResponse<NewCredentialsInstance>) => any): Promise<ApiResponse<NewCredentialsInstance>> {
    if (params === null || params === undefined) {
      throw new Error('Required parameter "params" missing.');
    }
    ...
    let operationPromise = operationVersion.createWithResponseInfo<NewCredentialsResource>({ uri: instance._uri, method: "post", data, headers}).then((response) : ApiResponse<NewCredentialsInstance> => ({
      ...response,
