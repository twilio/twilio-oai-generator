...
export interface AwsContext {
   ...
   * @returns Resolves to processed AwsInstance
   */
  patch(callback?: (error: Error | null, item?: AwsInstance) => any): Promise<AwsInstance>;
  /**
   * Patch a AwsInstance
   *
   ...
   * @returns Resolves to processed AwsInstance
   */
  patch(params: AwsContextPatchOptions, callback?: (error: Error | null, item?: AwsInstance) => any): Promise<AwsInstance>;
   ...
   * @returns Resolves to processed AwsInstance with HTTP metadata
   */
  patchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<AwsInstance>) => any): Promise<ApiResponse<AwsInstance>>;
  /**
   * Patch a AwsInstance and return HTTP info
   *
   * @param params - Parameter for request
   ...
   * @returns Resolves to processed AwsInstance with HTTP metadata
   */
  patchWithHttpInfo(params: AwsContextPatchOptions, callback?: (error: Error | null, item?: ApiResponse<AwsInstance>) => any): Promise<ApiResponse<AwsInstance>>;
...
export class AwsContextImpl implements AwsContext {
  ...
  get history(): HistoryListInstance {
    this._history = this._history || HistoryListInstance(this._version, this._solution.sid);
  ...
  patch(params?: AwsContextPatchOptions | ((error: Error | null, item?: AwsInstance) => any),callback?: (error: Error | null, item?: AwsInstance) => any): Promise<AwsInstance> {
  ...
  patchWithHttpInfo(params?: AwsContextPatchOptions | ((error: Error | null, item?: ApiResponse<AwsInstance>) => any),callback?: (error: Error | null, item?: ApiResponse<AwsInstance>) => any): Promise<ApiResponse<AwsInstance>> {
      if (params instanceof Function) {
      callback = params;
      params = {} as any;
    } else {
    ...
    let operationVersion = instance._version;
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion.patchWithResponseInfo<AwsResource>({ uri: instance._uri, method: "patch", data, headers}).then((response) : ApiResponse<AwsInstance> => ({
      ...response,
      body: new AwsInstance(operationVersion, response.body, instance._solution.sid)
    }));
...
export class AwsInstance {
  ...
  patch(params: AwsContextPatchOptions, callback?: (error: Error | null, item?: AwsInstance) => any): Promise<AwsInstance>;
    ...
    patch(params?: any, callback?: (error: Error | null, item?: AwsInstance) => any): Promise<AwsInstance>
    {
  ...
  patchWithHttpInfo(params: AwsContextPatchOptions, callback?: (error: Error | null, item?: ApiResponse<AwsInstance>) => any): Promise<ApiResponse<AwsInstance>>;
    ...
    patchWithHttpInfo(params?: any, callback?: (error: Error | null, item?: ApiResponse<AwsInstance>) => any): Promise<ApiResponse<AwsInstance>>
    {
