...
describe('account', () => {
    ...
    it('should create an account', () => {
        ...
        return twilio.api.v2010.account.create({sid: '123'}).then(() => scope.done());
    });
    ...
    it('should fetch an account', () => {
        ...
        return twilio.api.v2010.account('123').fetch().then(() => scope.done());
    });
    ...
    it('should update an account', () => {
        ...
        return twilio.api.v2010.account('123').update({status: 'closed'}).then(() => scope.done());
    });
    ...
    it('should remove an account', () => {
        ...
        return twilio.api.v2010.account('123').remove().then(() => scope.done());
    });
    ...
    it('should get account pages in between dates', () => {
        ...
        return twilio.api.v2010.account.page(params).then(() => scope.done());
    })
});
...
describe('call', () => {
    ...
    it('should create a call', () => {
        ...
        return twilio.api.v2010.account('123').call.create({requiredStringProperty: 'radda radda',
    ...
    it('should fetch a call', () => {
        ...
        return twilio.api.v2010.account('123').call('123', 1).fetch()
            .then(() => scope.done());
    });
    ...
    it('should remove a call', () => {
        ...
        return twilio.api.v2010.account('123').call('123', 1).remove()
            .then(() => scope.done());
    });
    ...
    it('should create a feedback summary', () => {
        ...
        return twilio.api.v2010.account('123').call.feedback_call_summary
