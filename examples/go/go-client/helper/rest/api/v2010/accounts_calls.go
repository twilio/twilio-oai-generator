...
type UpdateCallParams struct {
	...
	// The HTTP method that we should use to request the `TestUri`.
...
func (params *UpdateCallParams) SetRequiredStringProperty(RequiredStringProperty string) *UpdateCallParams {
	params.RequiredStringProperty = &RequiredStringProperty
	return params
}
func (params *UpdateCallParams) SetTestUri(TestUri string) *UpdateCallParams {
	params.TestUri = &TestUri
	return params
}
func (params *UpdateCallParams) SetTestMethod(TestMethod string) *UpdateCallParams {
	params.TestMethod = &TestMethod
	return params
}

func (c *ApiService) UpdateCall(TestInteger int, params *UpdateCallParams) (*TestResponseObject, error) {
	path := "/2010-04-01/Accounts/{AccountSid}/Calls/{TestInteger}.json"
	if params != nil && params.PathAccountSid != nil {
		path = strings.Replace(path, "{"+"AccountSid"+"}", *params.PathAccountSid, -1)
	} else {
	...
	if params != nil && params.TestUri != nil {
		data.Set("TestUri", *params.TestUri)
	}
