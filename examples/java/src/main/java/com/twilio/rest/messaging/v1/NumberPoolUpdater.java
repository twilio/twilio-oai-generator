...
public class NumberPoolUpdater extends Updater<NumberPool>{
    ...
    public NumberPoolUpdater setNumberPoolRequest(final NumberPoolModel.NumberPoolRequest numberPoolRequest){
        this.numberPoolRequest = numberPoolRequest;
        return this;
    }
    ...
    public NumberPool update(final TwilioRestClient client){
        ...
        if (response == null) {
            throw new ApiConnectionException("NumberPool update failed: Unable to connect to server");
