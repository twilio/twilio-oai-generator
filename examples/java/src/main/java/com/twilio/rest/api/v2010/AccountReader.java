...
public AccountReader setPageSize(final Integer pageSize){
    ...
    private void addQueryParams(final Request request) {
        ...
        Serializer.toString(request, "DateCreated", dateCreated, dateCreatedBefore, dateCreatedAfter);
    ...
    if (dateTest != null) {
        Serializer.toString(request, "Date.Test", dateTest, ParameterType.QUERY);
    }
