...
public class Call extends Resource {
    ...
    public static CallUpdater updater(final Integer pathTestInteger, final URI testUri, final Call.TestMethod testMethod){
        return new CallUpdater(pathTestInteger, testUri, testMethod);
    }
    public static CallUpdater updater(final String pathAccountSid, final Integer pathTestInteger, final URI testUri, final Call.TestMethod testMethod){
        return new CallUpdater(pathAccountSid, pathTestInteger, testUri, testMethod);
    }
