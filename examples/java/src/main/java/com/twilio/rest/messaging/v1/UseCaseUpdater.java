...
public class UseCaseUpdater extends Updater<UseCase>{
    private String pathUseCaseSID;
    private UseCaseModel.UseCaseRequest useCaseRequest;

    public UseCaseUpdater(final String pathUseCaseSID, final UseCaseModel.UseCaseRequest useCaseRequest){
        this.pathUseCaseSID = pathUseCaseSID;
        this.useCaseRequest = useCaseRequest;
    }

    public UseCaseUpdater setUseCaseRequest(final UseCaseModel.UseCaseRequest useCaseRequest){
        this.useCaseRequest = useCaseRequest;
        return this;
    }
    ...
    public UseCase update(final TwilioRestClient client){
        ...
        if (response == null) {
            throw new ApiConnectionException("UseCase update failed: Unable to connect to server");
