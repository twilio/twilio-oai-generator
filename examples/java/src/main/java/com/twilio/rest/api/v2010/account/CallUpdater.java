...
public class CallUpdater extends Updater<Call>{
    ...
    public CallUpdater(final Integer pathTestInteger, final URI testUri, final Call.TestMethod testMethod){
        this.pathTestInteger = pathTestInteger;
        this.testUri = testUri;
        this.testMethod = testMethod;
    }
    public CallUpdater(final String pathAccountSid, final Integer pathTestInteger, final URI testUri, final Call.TestMethod testMethod){
