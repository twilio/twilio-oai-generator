...
public class FlexFlow extends Resource {
    ...
    public static FlexFlowCreator creator(final String channelType, final String chatServiceSid, final String friendlyName){
        return new FlexFlowCreator(channelType, chatServiceSid, friendlyName);
    }
