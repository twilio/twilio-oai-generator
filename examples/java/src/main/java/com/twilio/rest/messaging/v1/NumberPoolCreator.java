...
public class NumberPoolCreator extends Creator<NumberPool>{
    ...
    public NumberPoolCreator setNumberPoolRequest(final NumberPoolModel.NumberPoolRequest numberPoolRequest){
        this.numberPoolRequest = numberPoolRequest;
        return this;
    }
    ...
    public NumberPool create(final TwilioRestClient client){
        ...
        if (response == null) {
            throw new ApiConnectionException("NumberPool creation failed: Unable to connect to server");
        ...
        return NumberPool.fromJson(response.getStream(), client.getObjectMapper());
    }
}
