...
public class FeedbackSummaryCreator extends Creator<FeedbackSummary>{
    ...
    public FeedbackSummaryCreator(final String AccountSid, final LocalDate EndDate, final LocalDate StartDate) {
    ...
    public FeedbackSummaryCreator setAccountSid(final String AccountSid){
        this.AccountSid = AccountSid;
        return this;
    }
