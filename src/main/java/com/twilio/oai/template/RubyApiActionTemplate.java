...
public class RubyApiActionTemplate extends AbstractApiActionTemplate {
    ...
    protected Map<String, List<String>> mapping() {
        return Map.of(
                API_TEMPLATE, Arrays.asList("api.mustache", ".rb"),
                VERSION_TEMPLATE, Arrays.asList("version.mustache", ".rb"));
    }
...
//    public void addVersionlessFile(final String version){
//        final List<String> templateStrings = mapping().get(VERSION_TEMPLATE);
//        codegen
//                .supportingFiles()
//                .add(new SupportingFile(templateStrings.get(0),
//                        ".." + File.separator + getVersionFilename(version) +
