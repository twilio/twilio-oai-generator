...
public class PathUtilsTest {
    ...
    @Test
    public void testgetDependentsTwilioExtension() {
        final String extensionKey = "dummyDependents";
        final PathItem pathItem = new PathItem();
        ...
        pathItem.addExtension("x-twilio", Map.of("foo-key", "foo-value"));
        assertFalse(PathUtils.getTwilioExtension(pathItem, extensionKey).isPresent());

        pathItem.addExtension("x-twilio", Map.of("dummyDependents", "dummy-value"));
        assertTrue(PathUtils.getTwilioExtension(pathItem, extensionKey).isPresent());
        assertEquals("dummy-value", PathUtils.getTwilioExtension(pathItem, extensionKey).orElseThrow());
    }
}
